...
float4 main(
  ...
  if (_2378) {
    ...
    float3 _rndx_tonemapped_color = TonemapReplacer(float3(_2359, _2360, _2361));
    _2638 = _rndx_tonemapped_color.x;
    _2639 = _rndx_tonemapped_color.y;
    _2640 = _rndx_tonemapped_color.z;
