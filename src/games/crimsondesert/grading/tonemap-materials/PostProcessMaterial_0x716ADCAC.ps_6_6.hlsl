...
float4 main(
  ...
  if (_1289) {
    _1295 = _userImageAdjust.z * _exposure0.x;
    _1344 = exp2(log2(max(0.0f, (((_1295 * max(0.0f, (((_1270 * 1.70505f) - (_1271 * 0.62179f)) - (_1272 * 0.08326f)))) * _slopeParams.x) + _offsetParams.x))) * _powerParams.x);
    _1345 = exp2(log2(max(0.0f, (((max(0.0f, (((_1271 * 1.1408f) - (_1270 * 0.13026f)) - (_1272 * 0.01055f))) * _1295) * _slopeParams.y) + _offsetParams.y))) * _powerParams.y);
    _1346 = exp2(log2(max(0.0f, (((max(0.0f, (((_1270 * -0.024f) - (_1271 * 0.12897f)) + (_1272 * 1.15297f))) * _1295) * _slopeParams.z) + _offsetParams.z))) * _powerParams.z);
    _1348 = dot(float3(_1344, _1345, _1346), float3(0.212671f, 0.71516f, 0.072169f));
    _1355 = ((_1344 - _1348) * _powerParams.w) + _1348;
    _1356 = ((_1345 - _1348) * _powerParams.w) + _1348;
    _1357 = ((_1346 - _1348) * _powerParams.w) + _1348;
    _1376 = min(max(log2(mad(_1357, 0.079223745f, mad(_1356, 0.0784336f, (_1355 * 0.84247905f)))), -12.47393f), 4.026069f) + 12.47393f;
    _1377 = min(max(log2(mad(_1357, 0.07916613f, mad(_1356, 0.87846863f, (_1355 * 0.042328242f)))), -12.47393f), 4.026069f) + 12.47393f;
    _1378 = min(max(log2(mad(_1357, 0.879143f, mad(_1356, 0.0784336f, (_1355 * 0.042375654f)))), -12.47393f), 4.026069f) + 12.47393f;
    _1379 = _1376 * 0.060606062f;
    _1380 = _1377 * 0.060606062f;
    _1381 = _1378 * 0.060606062f;
    _1382 = _1379 * _1379;
    _1383 = _1380 * _1380;
    _1384 = _1381 * _1381;
    _1430 = min(0.0f, (-0.0f - (((_1376 * 0.0072181816f) + ((_1382 * 0.4298f) + (((_1382 * _1382) * ((31.96f - (_1376 * 2.4327273f)) + (_1382 * 15.5f))) - ((_1376 * 0.41624245f) * _1382)))) + -0.00232f)));
    _1431 = min(0.0f, (-0.0f - (((_1377 * 0.0072181816f) + ((_1383 * 0.4298f) + (((_1383 * _1383) * ((31.96f - (_1377 * 2.4327273f)) + (_1383 * 15.5f))) - ((_1377 * 0.41624245f) * _1383)))) + -0.00232f)));
    ...
    if (_nightToneParm == 1) {
      ...
      _1462 = saturate((_exposure2.x + -0.6f) * 0.10638298f);  // [sem: expr_sat]
      _1465 = saturate((_exposure2.x + -0.1f) * 2.0f);  // [sem: expr_sat]
      _1472 = (_1454 + 1.4f) + (_1465 * (-0.39999998f - _1454));
      _1473 = (_1455 + 1.6f) + (_1465 * (-0.6f - _1455));
      _1474 = (_1456 + 0.9f) + (_1465 * (0.5f - _1456));
      _1491 = (lerp(_1473, 1.2f, _1462));  // [sem: blended]
      _1492 = (lerp(_1472, 1.0f, _1462));  // [sem: blended]
      _1493 = (lerp(_1474, 1.4f, _1462));  // [sem: blended]
    } else {
      _1491 = ((saturate((_exposure2.x + -3.0f) * 0.14285715f) * 0.20000005f) + 1.0f);  // [sem: blended]
      _1492 = 1.0f;  // [sem: blended]
      _1493 = 1.4f;  // [sem: blended]
    }
    _1503 = 1.0f - _1491;
    _1528 = ((exp2(log2(((saturate((_1430 * _1430) * _1433) * _1503) + _1491) * _1433) * _1492) - _1436) * _1493) + _1436;
    _1529 = ((exp2(log2(((saturate((_1431 * _1431) * _1434) * _1503) + _1491) * _1434) * _1492) - _1436) * _1493) + _1436;
    _1530 = ((exp2(log2(((saturate((_1432 * _1432) * _1435) * _1503) + _1491) * _1435) * _1492) - _1436) * _1493) + _1436;
    _1549 = saturate(exp2(log2(mad(_1530, -0.09902974f, mad(_1529, -0.09802088f, (_1528 * 1.196879f)))) * 2.2f));  // [sem: expr_sat]
    _1550 = saturate(exp2(log2(mad(_1530, -0.098961174f, mad(_1529, 1.1519032f, (_1528 * -0.052896854f)))) * 2.2f));  // [sem: expr_sat]
    _1551 = saturate(exp2(log2(mad(_1530, 1.1510737f, mad(_1529, -0.09804345f, (_1528 * -0.052971635f)))) * 2.2f));  // [sem: expr_sat]
