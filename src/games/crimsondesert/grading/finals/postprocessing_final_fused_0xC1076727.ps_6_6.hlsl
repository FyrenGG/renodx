...
float4 main(
  ...
  _639 = 2.200000047683716f / ((min(max(_userImageAdjust.w, -1.0f), 1.0f) * 0.800000011920929f) + 2.200000047683716f);
  _650 = (TEXCOORD.x * 2.0f) + -1.0f;
  _651 = TEXCOORD.y * 2.0f;
  _652 = 1.0f - _651;
  _680 = mad((_projToPrevProj[2].w), 1.0000000116860974e-07f, mad((_projToPrevProj[1].w), _652, ((_projToPrevProj[0].w) * _650))) + (_projToPrevProj[3].w);
  _683 = ((mad((_projToPrevProj[2].x), 1.0000000116860974e-07f, mad((_projToPrevProj[1].x), _652, ((_projToPrevProj[0].x) * _650))) + (_projToPrevProj[3].x)) / _680) - _650;
  _684 = ((mad((_projToPrevProj[2].y), 1.0000000116860974e-07f, mad((_projToPrevProj[1].y), _652, ((_projToPrevProj[0].y) * _650))) + (_projToPrevProj[3].y)) / _680) - _652;
