...
float4 main(
  ...
  if (_145) {
    ...
    float3 _rndx_tonemapped_color = TonemapReplacer(float3(_112, _120, _128));
    _393 = _rndx_tonemapped_color.x;
    _400 = _rndx_tonemapped_color.y;
    _407 = _rndx_tonemapped_color.z;
