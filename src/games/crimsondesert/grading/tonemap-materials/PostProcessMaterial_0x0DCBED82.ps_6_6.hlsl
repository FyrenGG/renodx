...
float4 main(
  ...
  if (_3538) {
    ...
    float3 _rndx_tonemapped_color = TonemapReplacer(float3(_3521, _3520, _3519));
    _3786 = _rndx_tonemapped_color.x;
    _3793 = _rndx_tonemapped_color.y;
    _3800 = _rndx_tonemapped_color.z;
  ...
  _3966 = exp2(log2(_3962 * 0.0001f) * 0.15930176f);
  _3970 = exp2(log2(_3961 * 0.0001f) * 0.15930176f);
  _3974 = exp2(log2(_3960 * 0.0001f) * 0.15930176f);
  SV_Target.x = exp2(log2((1.0f / ((_3966 * 18.6875f) + 1.0f)) * ((_3966 * 18.851562f) + 0.8359375f)) * 78.84375f);
  SV_Target.y = exp2(log2((1.0f / ((_3970 * 18.6875f) + 1.0f)) * ((_3970 * 18.851562f) + 0.8359375f)) * 78.84375f);
  SV_Target.z = exp2(log2((1.0f / ((_3974 * 18.6875f) + 1.0f)) * ((_3974 * 18.851562f) + 0.8359375f)) * 78.84375f);
  SV_Target.w = _3535;
  return SV_Target;
}
