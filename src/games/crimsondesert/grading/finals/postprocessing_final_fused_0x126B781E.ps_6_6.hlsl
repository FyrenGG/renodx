...
float4 main(
  ...
  _387 = saturate(_etcParams.w);
  _408 = (_386 * saturate(_rndx_tonemapped_color.x)) + _387;
  _401 = (_386 * saturate(_rndx_tonemapped_color.y)) + _387;
  _394 = (_386 * saturate(_rndx_tonemapped_color.z)) + _387;
  ...
  _508 = saturate(1.0f - ((_499 * _postProcessParams.x * CUSTOM_VIGNETTE) * dot(float2(_500, _502), float2(_500, _502))));  // [sem: expr_sat]
