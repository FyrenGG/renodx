...
float4 main(
  ...
  while(true) {
    ...
    while(true) {
      ...
      if (_205) {
        _211 = _exposure0.x * _userImageAdjust.z;
        _230 = exp2(_powerParams.x * log2(max(0.0f, (((_211 * max(0.0f, (((_186 * 0.511515f) - (_187 * 0.186537f)) - (_188 * 0.024978f)))) * _slopeParams.x) + _offsetParams.x))));
        _246 = exp2(log2(max(0.0f, (((_slopeParams.y * _211) * max(0.0f, (((_187 * 0.34224f) - (_186 * 0.039078005f)) - (_188 * 0.0031650001f)))) + _offsetParams.y))) * _powerParams.y);
        _262 = exp2(log2(max(0.0f, (((_slopeParams.z * _211) * max(0.0f, (((_186 * -0.0072000003f) - (_187 * 0.038691f)) + (_188 * 0.345891f)))) + _offsetParams.z))) * _powerParams.z);
        _263 = dot(float3(_230, _246, _262), float3(0.212671f, 0.71516f, 0.072169f));
        _267 = ((_230 - _263) * _powerParams.w) + _263;
        _270 = ((_246 - _263) * _powerParams.w) + _263;
        _273 = ((_262 - _263) * _powerParams.w) + _263;
        _280 = min(max(log2(mad(_273, 0.079223745f, mad(_270, 0.0784336f, (_267 * 0.84247905f)))), -12.47393f), 4.026069f) + 12.47393f;
        _287 = min(max(log2(mad(_273, 0.07916613f, mad(_270, 0.87846863f, (_267 * 0.042328242f)))), -12.47393f), 4.026069f) + 12.47393f;
        _294 = min(max(log2(mad(_273, 0.879143f, mad(_270, 0.0784336f, (_267 * 0.042375654f)))), -12.47393f), 4.026069f) + 12.47393f;
        _295 = _280 * 0.060606062f;
        _296 = _287 * 0.060606062f;
        _297 = _294 * 0.060606062f;
        _298 = _295 * _295;
        _299 = _296 * _296;
        _300 = _297 * _297;
        _316 = min(0.0f, (-0.0f - (((_280 * 0.0072181816f) + ((_298 * 0.4298f) + (((_298 * _298) * ((31.96f - (_280 * 2.4327273f)) + (_298 * 15.5f))) - ((_280 * 0.41624245f) * _298)))) + -0.00232f)));
        _332 = min(0.0f, (-0.0f - (((_287 * 0.0072181816f) + ((_299 * 0.4298f) + (((_299 * _299) * ((31.96f - (_287 * 2.4327273f)) + (_299 * 15.5f))) - ((_287 * 0.41624245f) * _299)))) + -0.00232f)));
        ...
        if (_nightToneParm == 1) {
          ...
          _375 = saturate((_exposure2.x + -0.6f) * 0.10638298f);  // [sem: expr_sat]
          _378 = saturate((_exposure2.x + -0.1f) * 2.0f);  // [sem: expr_sat]
          _382 = (_370 + 1.4f) + (_378 * (-0.39999998f - _370));
          _386 = (_371 + 1.6f) + (_378 * (-0.6f - _371));
          _390 = (_372 + 0.9f) + (_378 * (0.5f - _372));
          _407 = (lerp(_390, 1.4f, _375));  // [sem: blended]
          _408 = (lerp(_382, 1.0f, _375));  // [sem: blended]
          _409 = (lerp(_386, 1.2f, _375));  // [sem: blended]
        } else {
          _407 = 1.4f;  // [sem: blended]
          _408 = 1.0f;  // [sem: blended]
          _409 = ((saturate((_exposure2.x + -3.0f) * 0.14285715f) * 0.20000005f) + 1.0f);  // [sem: blended]
        }
        _410 = 1.0f - _409;
        _422 = ((exp2(log2(((saturate((_316 * _316) * _349) * _410) + _409) * _349) * _408) - _352) * _407) + _352;
        _434 = ((exp2(log2(((saturate((_332 * _332) * _350) * _410) + _409) * _350) * _408) - _352) * _407) + _352;
        _446 = ((exp2(log2(((saturate((_348 * _348) * _351) * _410) + _409) * _351) * _408) - _352) * _407) + _352;
        _453 = saturate(exp2(log2(mad(_446, -0.09902974f, mad(_434, -0.09802088f, (_422 * 1.196879f)))) * 2.2f));  // [sem: expr_sat]
        _460 = saturate(exp2(log2(mad(_446, -0.098961174f, mad(_434, 1.1519032f, (_422 * -0.052896854f)))) * 2.2f));  // [sem: expr_sat]
        _467 = saturate(exp2(log2(mad(_446, 1.1510737f, mad(_434, -0.09804345f, (_422 * -0.052971635f)))) * 2.2f));  // [sem: expr_sat]
