...
float4 main(
  ...
  while(true) {
    ...
    if (_2542) {
      ...
      float3 _rndx_tonemapped_color = TonemapReplacer(float3(_2519, _2522, _2525));
      _2790 = _rndx_tonemapped_color.x;
      _2797 = _rndx_tonemapped_color.y;
      _2804 = _rndx_tonemapped_color.z;
