...
float4 main(
  ...
  _675 = saturate(_etcParams.w);
  _677 = (_674 * saturate(_rndx_tonemapped_color.x)) + _675;
  _679 = (_674 * saturate(_rndx_tonemapped_color.y)) + _675;
  _681 = (_674 * saturate(_rndx_tonemapped_color.z)) + _675;
  ...
  _773 = saturate(1.0f - ((_postProcessParams.x * CUSTOM_VIGNETTE * _763) * dot(float2(_764, _766), float2(_764, _766))));  // [sem: expr_sat]
