...
void main(
  ...
  if (!(((_130 && _132) && _134) && _136)) {
    ...
    _4392 = (((_4178 * 0.61312f) + (_4179 * 0.33951f)) + (_4180 * 0.04737f)) * _4391;
    _4393 = (((_4178 * 0.0702f) + (_4179 * 0.91636f)) + (_4180 * 0.01345f)) * _4391;
    _4394 = (((_4178 * 0.02062f) + (_4179 * 0.10958f)) + (_4180 * 0.8698f)) * _4391;
    _4395 = _4388 - _1051;
    _4396 = _4389 - _1052;
    _4397 = _4390 - _1053;
