      ...
      while(true) {
        ...
        while(true) {
          ...
          while(true) {
            ...
            if (_269) {
              _275 = _userImageAdjust.z * _exposure0.x;
              _324 = exp2(log2(max(0.0f, (((_275 * max(0.0f, (((_250 * 1.70505f) - (_251 * 0.62179f)) - (_252 * 0.08326f)))) * _slopeParams.x) + _offsetParams.x))) * _powerParams.x);
              _325 = exp2(log2(max(0.0f, (((max(0.0f, (((_251 * 1.1408f) - (_250 * 0.13026f)) - (_252 * 0.01055f))) * _275) * _slopeParams.y) + _offsetParams.y))) * _powerParams.y);
              _326 = exp2(log2(max(0.0f, (((max(0.0f, (((_250 * -0.024f) - (_251 * 0.12897f)) + (_252 * 1.15297f))) * _275) * _slopeParams.z) + _offsetParams.z))) * _powerParams.z);
              _328 = dot(float3(_324, _325, _326), float3(0.212671f, 0.71516f, 0.072169f));
              _335 = ((_324 - _328) * _powerParams.w) + _328;
              _336 = ((_325 - _328) * _powerParams.w) + _328;
              _337 = ((_326 - _328) * _powerParams.w) + _328;
              _356 = min(max(log2(mad(_337, 0.079223745f, mad(_336, 0.0784336f, (_335 * 0.84247905f)))), -12.47393f), 4.026069f) + 12.47393f;
              _357 = min(max(log2(mad(_337, 0.07916613f, mad(_336, 0.87846863f, (_335 * 0.042328242f)))), -12.47393f), 4.026069f) + 12.47393f;
              _358 = min(max(log2(mad(_337, 0.879143f, mad(_336, 0.0784336f, (_335 * 0.042375654f)))), -12.47393f), 4.026069f) + 12.47393f;
              _359 = _356 * 0.060606062f;
              _360 = _357 * 0.060606062f;
              _361 = _358 * 0.060606062f;
              _362 = _359 * _359;
              _363 = _360 * _360;
              _364 = _361 * _361;
              _410 = min(0.0f, (-0.0f - (((_356 * 0.0072181816f) + ((_362 * 0.4298f) + (((_362 * _362) * ((31.96f - (_356 * 2.4327273f)) + (_362 * 15.5f))) - ((_356 * 0.41624245f) * _362)))) + -0.00232f)));
              _411 = min(0.0f, (-0.0f - (((_357 * 0.0072181816f) + ((_363 * 0.4298f) + (((_363 * _363) * ((31.96f - (_357 * 2.4327273f)) + (_363 * 15.5f))) - ((_357 * 0.41624245f) * _363)))) + -0.00232f)));
              _412 = min(0.0f, (-0.0f - (((_358 * 0.0072181816f) + ((_364 * 0.4298f) + (((_364 * _364) * ((31.96f - (_358 * 2.4327273f)) + (_364 * 15.5f))) - ((_358 * 0.41624245f) * _364)))) + -0.00232f)));
              _413 = -0.0f - _410;
              _414 = -0.0f - _411;
              _415 = -0.0f - _412;
              _416 = dot(float3(_413, _414, _415), float3(0.2126f, 0.7152f, 0.0722f));
              if (_nightToneParm == 1) {
                _433 = exp2(exp2(log2(abs((_time.w * 0.11666667f) + -1.4f)) * 8.0f) * -1.442695f) + 1.0f;
                _434 = -0.79999995f / _433;
                _435 = -1.2f / _433;
                _436 = 0.20000005f / _433;
                _442 = saturate((_exposure2.x + -0.6f) * 0.10638298f);  // [sem: expr_sat]
                _445 = saturate((_exposure2.x + -0.1f) * 2.0f);  // [sem: expr_sat]
                _452 = (_434 + 1.4f) + (_445 * (-0.39999998f - _434));
                _453 = (_435 + 1.6f) + (_445 * (-0.6f - _435));
                _454 = (_436 + 0.9f) + (_445 * (0.5f - _436));
                _471 = (lerp(_453, 1.2f, _442));  // [sem: blended]
                _472 = (lerp(_452, 1.0f, _442));  // [sem: blended]
                _473 = (lerp(_454, 1.4f, _442));  // [sem: blended]
              } else {
                _471 = ((saturate((_exposure2.x + -3.0f) * 0.14285715f) * 0.20000005f) + 1.0f);  // [sem: blended]
                _472 = 1.0f;  // [sem: blended]
                _473 = 1.4f;  // [sem: blended]
              }
              _483 = 1.0f - _471;
              _508 = ((exp2(log2(((saturate((_410 * _410) * _413) * _483) + _471) * _413) * _472) - _416) * _473) + _416;
              _509 = ((exp2(log2(((saturate((_411 * _411) * _414) * _483) + _471) * _414) * _472) - _416) * _473) + _416;
              _510 = ((exp2(log2(((saturate((_412 * _412) * _415) * _483) + _471) * _415) * _472) - _416) * _473) + _416;
              _529 = saturate(exp2(log2(mad(_510, -0.09902974f, mad(_509, -0.09802088f, (_508 * 1.196879f)))) * 2.2f));  // [sem: expr_sat]
              // [sem: expr_sat]
              _530 = saturate(exp2(log2(mad(_510, -0.098961174f, mad(_509, 1.1519032f, (_508 * -0.052896854f)))) * 2.2f));
              // [sem: expr_sat]
              _531 = saturate(exp2(log2(mad(_510, 1.1510737f, mad(_509, -0.09804345f, (_508 * -0.052971635f)))) * 2.2f));
            ...
            if (_etcParams.y > 1.0f) {
              _630 = abs(_32);
              _631 = abs(_33 + -1.0f);
              _635 = saturate(1.0f - (dot(float2(_630, _631), float2(_630, _631)) * saturate(_etcParams.y + -1.0f)));  // [sem: expr_sat]
              _640 = (_635 * _622);
              _641 = (_635 * _623);
              _642 = (_635 * _624);
            } else {
