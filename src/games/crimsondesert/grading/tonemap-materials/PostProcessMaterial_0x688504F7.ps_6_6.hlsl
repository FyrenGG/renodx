...
float4 main(
  ...
  _102 = WaveReadLaneFirst(BindlessParameters_PostProcessMemoryRead_CD[((int)((uint)(select(((uint)_94 < (uint)170000), _94, 0)) + 0u))].BindlessParameters_PostProcessMemoryRead_CD._radius);
  _103 = WaveReadLaneFirst(_materialIndex);
  _111 = WaveReadLaneFirst(BindlessParameters_PostProcessMemoryRead_CD[((int)((uint)(select(((uint)_103 < (uint)170000), _103, 0)) + 0u))].BindlessParameters_PostProcessMemoryRead_CD._memoryReadProgress);
  _114 = saturate(1.0f - _111) * _102;
  if (!(!(_114 >= 0.0010000000474974513f))) {
    _144 = WaveReadLaneFirst(_materialIndex);
    _152 = WaveReadLaneFirst(BindlessParameters_PostProcessMemoryRead_CD[((int)((uint)(select(((uint)_144 < (uint)170000), _144, 0)) + 0u))].BindlessParameters_PostProcessMemoryRead_CD._squareSize);
  ...
  _279 = WaveReadLaneFirst(BindlessParameters_PostProcessMemoryRead_CD[((int)((uint)(select(((uint)_271 < (uint)170000), _271, 0)) + 0u))].BindlessParameters_PostProcessMemoryRead_CD._noiseTex);
  _289 = WaveReadLaneFirst(_materialIndex);
  _297 = WaveReadLaneFirst(BindlessParameters_PostProcessMemoryRead_CD[((int)((uint)(select(((uint)_289 < (uint)170000), _289, 0)) + 0u))].BindlessParameters_PostProcessMemoryRead_CD._memoryReadProgress);
  ...
  _329 = (((float)((uint)((uint)((uint)((uint)(_319.x)) >> 20)))) * 0.0004884005174972117f) + -1.0f;  // [sem: _3__36__0__0__g_CustomRenderPassValue_load_derived]
  _330 = (((float)((uint)((uint)(((uint)((uint)(_319.x)) >> 8) & 4095)))) * 0.0004884005174972117f) + -1.0f;  // [sem: _3__36__0__0__g_CustomRenderPassValue_load_derived]
  _332 = 1.0f - abs(_329);
  _333 = abs(_330);
  _334 = _332 - _333;
  if (!(_334 >= 0.0f)) {
  ...
  _355 = _353 * _350;
  _356 = _353 * _351;
  _359 = (_298 * 0.0005000000237487257f) + TEXCOORD.x;
  _360 = (_298 * 0.004999999888241291f) + TEXCOORD.y;
  // [sem: expr_sat]
  _395 = saturate(ceil(((_nearFarProj.x / max(1.0000000116860974e-07f, (((float)((uint)((uint)((((uint)(__3__36__0__0__g_depthOpaque.Load(int3((int)(uint((_bufferSizeAndInvSize.x * _359) + -0.5f)), (int)(uint((_bufferSizeAndInvSize.y * _360) + -0.5f)), 0)))).x) & 16777215)))) * 5.960465188081798e-08f))) + 0.10000000149011612f) - (_nearFarProj.x / max(1.0000000116860974e-07f, (((float4)(__3__36__0__0__g_CustomRenderPassDepth.Load(int3(int(_customRenderPassSizeInvSize.x * _359), int(_customRenderPassSizeInvSize.y * _360), 0)))).x)))));
  _404 = uint((_bufferSizeAndInvSize.x * ((_298 * 0.0002500000118743628f) + TEXCOORD.x)) + -0.5f);
  _405 = uint((_bufferSizeAndInvSize.y * ((_298 * 0.0024999999441206455f) + TEXCOORD.y)) + -0.5f);
  ...
  _428 = (saturate(_410.x * 1.0009784698486328f) * 2.0f) + -1.0f;  // [sem: _3__36__0__0__g_gbufferNormal_load_derived]
  _429 = (saturate(_410.y * 1.0009784698486328f) * 2.0f) + -1.0f;  // [sem: _3__36__0__0__g_gbufferNormal_load_derived]
  _430 = (saturate(_410.z * 1.0009784698486328f) * 2.0f) + -1.0f;  // [sem: _3__36__0__0__g_gbufferNormal_load_derived]
  _432 = rsqrt(dot(float3(_428, _429, _430), float3(_428, _429, _430)));  // [sem: invLength]
  _433 = _432 * _428;
  _434 = _432 * _429;
  _435 = _430 * _432;
  _438 = (((float)((uint)((uint)(((uint)((uint)(_407.w)) >> 8) & 255)))) * 0.007843137718737125f) + -1.0f;  // [sem: _3__36__0__0__g_gbufferBaseColor_load_derived]
  _439 = (((float)((uint)((uint)(_407.w & 255)))) * 0.007843137718737125f) + -1.0f;  // [sem: _3__36__0__0__g_gbufferBaseColor_load_derived]
  _442 = (_438 + _439) * 0.5f;
  _443 = (_438 - _439) * 0.5f;
  ...
  if (_321 == _renderPassMemory) {
    ...
    _504 = WaveReadLaneFirst(BindlessParameters_PostProcessMemoryRead_CD[((int)((uint)(select(((uint)_496 < (uint)170000), _496, 0)) + 0u))].BindlessParameters_PostProcessMemoryRead_CD._memoryOpacity);
    _519 = _504;
  } else {
    if (_321 == _renderPassEnemyBoss) {
      _509 = WaveReadLaneFirst(_materialIndex);
      _517 = WaveReadLaneFirst(BindlessParameters_PostProcessMemoryRead_CD[((int)((uint)(select(((uint)_509 < (uint)170000), _509, 0)) + 0u))].BindlessParameters_PostProcessMemoryRead_CD._enemyBossOpacity);
      _519 = _517;
    } else {
      _519 = 1.0f;
    }
  ...
  _528 = WaveReadLaneFirst(BindlessParameters_PostProcessMemoryRead_CD[((int)((uint)(select(((uint)_520 < (uint)170000), _520, 0)) + 0u))].BindlessParameters_PostProcessMemoryRead_CD._memoryReadProgress);
  ...
  _547 = select((!(_395 == 0.0f)), _543, ((_543 * 0.05999999865889549f) + 0.007000000216066837f));
  ...
  if (_573) {
    ...
    if (_etcParams.z == 0.0f) {
      ...
      _915 = 2.200000047683716f / ((min(max(_userImageAdjust.w, -1.0f), 1.0f) * 0.800000011920929f) + 2.200000047683716f);
  ...
  if (_573 && (_etcParams.z > 0.0f)) {
    _976 = select((_944 <= 0.0031308000907301903f), (_944 * 12.920000076293945f), (((pow(_944, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f));
  ...
  _1003 = exp2(log2(_991 * 9.999999747378752e-05f) * 0.1593017578125f);
  _1004 = exp2(log2(_992 * 9.999999747378752e-05f) * 0.1593017578125f);
  _1005 = exp2(log2(_993 * 9.999999747378752e-05f) * 0.1593017578125f);
  SV_Target.x = exp2(log2((1.0f / ((_1003 * 18.6875f) + 1.0f)) * ((_1003 * 18.8515625f) + 0.8359375f)) * 78.84375f);
  SV_Target.y = exp2(log2((1.0f / ((_1004 * 18.6875f) + 1.0f)) * ((_1004 * 18.8515625f) + 0.8359375f)) * 78.84375f);
  SV_Target.z = exp2(log2((1.0f / ((_1005 * 18.6875f) + 1.0f)) * ((_1005 * 18.8515625f) + 0.8359375f)) * 78.84375f);
  SV_Target.w = _570;
  return SV_Target;
}
