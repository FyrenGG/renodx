...
void main(
  ...
  if (!(((_131 && _133) && _135) && _137)) {
    ...
    _4448 = (((_4234 * 0.61312f) + (_4235 * 0.33951f)) + (_4236 * 0.04737f)) * _4447;
    _4449 = (((_4234 * 0.0702f) + (_4235 * 0.91636f)) + (_4236 * 0.01345f)) * _4447;
    _4450 = (((_4234 * 0.02062f) + (_4235 * 0.10958f)) + (_4236 * 0.8698f)) * _4447;
    _4451 = _4444 - _1052;
    _4452 = _4445 - _1053;
    _4453 = _4446 - _1054;
