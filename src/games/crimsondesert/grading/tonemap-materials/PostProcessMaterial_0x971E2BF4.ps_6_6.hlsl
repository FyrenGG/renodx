...
float4 main(
  ...
  _75 = WaveReadLaneFirst(BindlessParameters_PostProcessFlashback[((int)((uint)(select(((uint)_67 < (uint)170000), _67, 0)) + 0u))].BindlessParameters_PostProcessFlashback._blendingRatio);
  _76 = saturate(_75);  // [sem: _75_sat]
  [branch]
  if (!(_76 < 9.999999747378752e-05f)) {
    _83 = 1.0f / max(0.0010000000474974513f, abs(_exposure0.x));
    ...
    _112 = WaveReadLaneFirst(BindlessParameters_PostProcessFlashback[((int)((uint)(select(((uint)_104 < (uint)170000), _104, 0)) + 0u))].BindlessParameters_PostProcessFlashback._contrastRatio);
    _114 = (_76 >= 0.0010000000474974513f);
    if (_114 && (!(_112 == 1.0f))) {
    ...
    _141 = WaveReadLaneFirst(BindlessParameters_PostProcessFlashback[((int)((uint)(select(((uint)_133 < (uint)170000), _133, 0)) + 0u))].BindlessParameters_PostProcessFlashback._depthFadingContrast);
    if (_114 && (_141 < 1.0f)) {
      _145 = WaveReadLaneFirst(_materialIndex);
      _153 = WaveReadLaneFirst(BindlessParameters_PostProcessFlashback[((int)((uint)(select(((uint)_145 < (uint)170000), _145, 0)) + 0u))].BindlessParameters_PostProcessFlashback._depthFadingDistance);
      _154 = max(9.999999747378752e-05f, _153);
  // [sem: expr_sat]
      _170 = saturate((1.0f - saturate(_nearFarProj.x / (max(1.0000000116860974e-07f, ((__3__36__0__0__g_depth.Sample(__0__4__0__0__g_staticBilinearClamp, float2(TEXCOORD.x, TEXCOORD.y))).x)) * _154))) / (1.0f - saturate(1.5f / _154)));
      _174 = (_170 * _170) * (3.0f - (_170 * 2.0f));
      _180 = (((1.0f - saturate(_86)) * 0.30000001192092896f) * (1.0f - _174)) + _174;
      _191 = (1.0f - _141) * _76;
  ...
  // [sem: _3__36__0__0__g_postProcessSizeColor_sample]
    ...
    _214 = (pow(_204.x, 0.012683313339948654f));  // [sem: _3__36__0__0__g_postProcessSizeColor_sample_derived]
    _215 = (pow(_204.y, 0.012683313339948654f));  // [sem: _3__36__0__0__g_postProcessSizeColor_sample_derived]
    _216 = (pow(_204.z, 0.012683313339948654f));  // [sem: _3__36__0__0__g_postProcessSizeColor_sample_derived]
    _233 = exp2(log2(max(0.0f, (_216 + -0.8359375f)) / (18.8515625f - (_216 * 18.6875f))) * 6.277394771575928f) * 10000.0f;
    _234 = WaveReadLaneFirst(_materialIndex);
    _242 = WaveReadLaneFirst(BindlessParameters_PostProcessFlashback[((int)((uint)(select(((uint)_234 < (uint)170000), _234, 0)) + 0u))].BindlessParameters_PostProcessFlashback._flickeringIntensity);
    [branch]
    if (!(!(_242 >= 0.0010000000474974513f))) {
      _256 = 1.0f - (((_76 * 6000.0f) * _242) * exp2(log2(max(0.0f, (_214 + -0.8359375f)) / (18.8515625f - (_214 * 18.6875f))) * 6.277394771575928f));
      _261 = (_256 * _199);
      _262 = (_256 * _200);
      _263 = (_256 * _201);
    } else {
    ...
    _272 = WaveReadLaneFirst(BindlessParameters_PostProcessFlashback[((int)((uint)(select(((uint)_264 < (uint)170000), _264, 0)) + 0u))].BindlessParameters_PostProcessFlashback._lensDirtIntensity);
    [branch]
    if (!(!(_272 >= 9.999999747378752e-05f))) {
      _283 = saturate((_sunDirection.y + 0.10000000149011612f) * 5.0f);  // [sem: expr_sat]
  ...
  // [sem: invLength]
      ...
      _358 = ((_invViewProjRelative[3].w) + (_invViewProjRelative[2].w)) + mad((_invViewProjRelative[1].w), _322, ((_invViewProjRelative[0].w) * _319));
      _359 = ((mad((_invViewProjRelative[1].x), _322, ((_invViewProjRelative[0].x) * _319)) + (_invViewProjRelative[2].x)) + (_invViewProjRelative[3].x)) / _358;
      _360 = (((_invViewProjRelative[3].y) + (_invViewProjRelative[2].y)) + mad((_invViewProjRelative[1].y), _322, ((_invViewProjRelative[0].y) * _319))) / _358;
      _361 = (((_invViewProjRelative[3].z) + (_invViewProjRelative[2].z)) + mad((_invViewProjRelative[1].z), _322, ((_invViewProjRelative[0].z) * _319))) / _358;
  ...
  // [sem: expr_sat]
      ...
      _382 = (((_287 * 4.0f) + 3.0f) * _233) * saturate(exp2(log2((_370 * _370) * (3.0f - (_370 * 2.0f))) * 3.0f));
      _386 = WaveReadLaneFirst(_materialIndex);
      _394 = WaveReadLaneFirst(BindlessParameters_PostProcessFlashback[((int)((uint)(select(((uint)_386 < (uint)170000), _386, 0)) + 0u))].BindlessParameters_PostProcessFlashback._lensDirtTexScale);
      _399 = WaveReadLaneFirst(_materialIndex);
      _407 = WaveReadLaneFirst(BindlessParameters_PostProcessFlashback[((int)((uint)(select(((uint)_399 < (uint)170000), _399, 0)) + 0u))].BindlessParameters_PostProcessFlashback._lensDirtTex);
      _414 = __0__7__0__0__g_bindlessTextures[((int)((uint)(select(((uint)_407 < (uint)65000), _407, 0)) + 0u))].Sample(__0__4__0__0__g_staticBilinearWrap, float2(((((1.0f / _srcTargetSizeAndInv.y) * TEXCOORD.x) * _srcTargetSizeAndInv.x) * _394), (_394 * TEXCOORD.y)));
      _418 = dot(float3(0.30000001192092896f, 0.5899999737739563f, 0.10999999940395355f), float3(_414.x, _414.y, _414.z));
      _431 = (((_83 * _76) * _272) * (6.0f - (_287 * 2.0f))) * (_382 + _233);
    ...
    _450 = WaveReadLaneFirst(BindlessParameters_PostProcessFlashback[((int)((uint)(select(((uint)_442 < (uint)170000), _442, 0)) + 0u))].BindlessParameters_PostProcessFlashback._vignetteRatio);
    _451 = saturate(_450);  // [sem: _450_sat]
    [branch]
    if (!(!(_451 >= 0.0010000000474974513f))) {
      _456 = ((_76 * 10000.0f) * exp2(log2(max(0.0f, (_215 + -0.8359375f)) / (18.8515625f - (_215 * 18.6875f))) * 6.277394771575928f)) * _451;
      _464 = (_439 - (_456 * _439));
      _465 = (_440 - (_456 * _440));
      _466 = (_441 - (_456 * _441));
    } else {
  ...
  if (_483) {
    ...
    if (_etcParams.z == 0.0f) {
      ...
      _825 = 2.200000047683716f / ((min(max(_userImageAdjust.w, -1.0f), 1.0f) * 0.800000011920929f) + 2.200000047683716f);
  ...
  _917 = exp2(log2(_905 * 9.999999747378752e-05f) * 0.1593017578125f);
  _918 = exp2(log2(_906 * 9.999999747378752e-05f) * 0.1593017578125f);
  _919 = exp2(log2(_907 * 9.999999747378752e-05f) * 0.1593017578125f);
