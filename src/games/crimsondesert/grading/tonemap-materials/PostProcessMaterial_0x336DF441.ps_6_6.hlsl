...
float4 main(
  ...
  _77 = WaveReadLaneFirst(BindlessParameters_PostProcessAction[((int)((uint)(select(((uint)_69 < (uint)170000), _69, 0)) + 0u))].BindlessParameters_PostProcessAction._gaussianBlurIntensity);
  _78 = WaveReadLaneFirst(_materialIndex);
  _86 = WaveReadLaneFirst(BindlessParameters_PostProcessAction[((int)((uint)(select(((uint)_78 < (uint)170000), _78, 0)) + 0u))].BindlessParameters_PostProcessAction._gaussianBlurClampInnerRadius);
  _87 = WaveReadLaneFirst(_materialIndex);
  _95 = WaveReadLaneFirst(BindlessParameters_PostProcessAction[((int)((uint)(select(((uint)_87 < (uint)170000), _87, 0)) + 0u))].BindlessParameters_PostProcessAction._borderRatio);
  _96 = (_77 > 0.0f);
  _97 = (_95 > 0.0f);
  if (_96 || _97) {
  // [sem: _3__36__0__0__g_postProcessSizeColor_sample]
    ...
    _113 = (pow(_102.x, 0.012683313339948654f));  // [sem: _3__36__0__0__g_postProcessSizeColor_sample_derived]
    _114 = (pow(_102.y, 0.012683313339948654f));  // [sem: _3__36__0__0__g_postProcessSizeColor_sample_derived]
    _115 = (pow(_102.z, 0.012683313339948654f));  // [sem: _3__36__0__0__g_postProcessSizeColor_sample_derived]
  ...
  if (_96) {
    ...
    _157 = WaveReadLaneFirst(BindlessParameters_PostProcessAction[((int)((uint)(select(((uint)_149 < (uint)170000), _149, 0)) + 0u))].BindlessParameters_PostProcessAction._gaussianBlurClampHardness);
    _158 = WaveReadLaneFirst(_materialIndex);
    _167 = WaveReadLaneFirst(BindlessParameters_PostProcessAction[((int)((uint)(select(((uint)_158 < (uint)170000), _158, 0)) + 0u))].BindlessParameters_PostProcessAction._gaussianBlurPosition.x);
    _168 = WaveReadLaneFirst(BindlessParameters_PostProcessAction[((int)((uint)(select(((uint)_158 < (uint)170000), _158, 0)) + 0u))].BindlessParameters_PostProcessAction._gaussianBlurPosition.y);
    _170 = (TEXCOORD.x - _167) * _68;
    _171 = TEXCOORD.y - _168;
  // [sem: expr_sat]
    _182 = saturate((1.0f - ((1.0f / max(9.999999747378752e-06f, _86)) * sqrt(dot(float2(_170, _171), float2(_170, _171))))) * (1.0f / max((1.0f - _157), 9.999999747378752e-06f)));
  ...
  _209 = WaveReadLaneFirst(BindlessParameters_PostProcessAction[((int)((uint)(select(((uint)_201 < (uint)170000), _201, 0)) + 0u))].BindlessParameters_PostProcessAction._radialBlurIntensity);
  if (_209 > 0.0f) {
    _212 = WaveReadLaneFirst(_materialIndex);
    _221 = WaveReadLaneFirst(BindlessParameters_PostProcessAction[((int)((uint)(select(((uint)_212 < (uint)170000), _212, 0)) + 0u))].BindlessParameters_PostProcessAction._radialBlurPosition.x);
    _222 = WaveReadLaneFirst(BindlessParameters_PostProcessAction[((int)((uint)(select(((uint)_212 < (uint)170000), _212, 0)) + 0u))].BindlessParameters_PostProcessAction._radialBlurPosition.y);
    ...
    _240 = (pow(_230.x, 0.012683313339948654f));  // [sem: _3__36__0__0__g_postProcessSizeColor_sample_derived]
    _241 = (pow(_230.y, 0.012683313339948654f));  // [sem: _3__36__0__0__g_postProcessSizeColor_sample_derived]
    _242 = (pow(_230.z, 0.012683313339948654f));  // [sem: _3__36__0__0__g_postProcessSizeColor_sample_derived]
    _272 = 32.0f / _209;
    _323 = _226;
    _324 = _227;
    ...
    _329 = 0;
    while(true) {
      _330 = _323 + (((_221 - _226) / _272) * 0.10000000149011612f);
      _331 = _324 + (((_222 - _227) / _272) * 0.10000000149011612f);
      ...
      _371 = _328 * 9000.0f;
      _375 = (exp2(log2(max(0.0f, (_344 + -0.8359375f)) / (18.8515625f - (_344 * 18.6875f))) * 6.277394771575928f) * _371) + _325;
      _376 = (exp2(log2(max(0.0f, (_345 + -0.8359375f)) / (18.8515625f - (_345 * 18.6875f))) * 6.277394771575928f) * _371) + _326;
      _377 = (exp2(log2(max(0.0f, (_346 + -0.8359375f)) / (18.8515625f - (_346 * 18.6875f))) * 6.277394771575928f) * _371) + _327;
      _379 = _329 + 1;
      if (!(_379 == 10)) {
        _323 = _330;
        _324 = _331;
      ...
      while(true) {
        ...
        _280 = _377 * 0.10000000149011612f;
        _281 = WaveReadLaneFirst(_materialIndex);
        _289 = WaveReadLaneFirst(BindlessParameters_PostProcessAction[((int)((uint)(select(((uint)_281 < (uint)170000), _281, 0)) + 0u))].BindlessParameters_PostProcessAction._radialBlurClampInnerRadius);
        _290 = WaveReadLaneFirst(_materialIndex);
        _298 = WaveReadLaneFirst(BindlessParameters_PostProcessAction[((int)((uint)(select(((uint)_290 < (uint)170000), _290, 0)) + 0u))].BindlessParameters_PostProcessAction._radialBlurClampHardness);
        _300 = (TEXCOORD.x - _221) * _68;
        _301 = TEXCOORD.y - _222;
  // [sem: expr_sat]
        _312 = saturate((1.0f - ((1.0f / max(9.999999747378752e-06f, _289)) * sqrt(dot(float2(_300, _301), float2(_300, _301))))) * (1.0f / max((1.0f - _298), 9.999999747378752e-06f)));
  ...
  _395 = WaveReadLaneFirst(BindlessParameters_PostProcessAction[((int)((uint)(select(((uint)_385 < (uint)170000), _385, 0)) + 0u))].BindlessParameters_PostProcessAction._saturation.x);
  _396 = WaveReadLaneFirst(BindlessParameters_PostProcessAction[((int)((uint)(select(((uint)_385 < (uint)170000), _385, 0)) + 0u))].BindlessParameters_PostProcessAction._saturation.y);
  _397 = WaveReadLaneFirst(BindlessParameters_PostProcessAction[((int)((uint)(select(((uint)_385 < (uint)170000), _385, 0)) + 0u))].BindlessParameters_PostProcessAction._saturation.z);
  _401 = (1.0f - _395) * 0.3086000084877014f;
  _403 = (1.0f - _396) * 0.6093999743461609f;
  _405 = (1.0f - _397) * 0.0820000022649765f;
  _410 = _401 * _382;
  _427 = WaveReadLaneFirst(_materialIndex);
  _435 = WaveReadLaneFirst(BindlessParameters_PostProcessAction[((int)((uint)(select(((uint)_427 < (uint)170000), _427, 0)) + 0u))].BindlessParameters_PostProcessAction._contrast);
  _436 = max(_435, 0.0f);
  ...
  if (_97) {
    ...
    _455 = WaveReadLaneFirst(BindlessParameters_PostProcessAction[((int)((uint)(select(((uint)_447 < (uint)170000), _447, 0)) + 0u))].BindlessParameters_PostProcessAction._borderColor);
    _458 = (float)((uint)((uint)(((uint)(_455) >> 16) & 255)));
    _461 = (float)((uint)((uint)(((uint)(_455) >> 8) & 255)));
    _463 = (float)((uint)((uint)(_455 & 255)));
    _494 = 1.0f / max(0.0010000000474974513f, _exposure0.x);
  ...
  if (_527) {
    ...
    if (_etcParams.z == 0.0f) {
      ...
      _869 = 2.200000047683716f / ((min(max(_userImageAdjust.w, -1.0f), 1.0f) * 0.800000011920929f) + 2.200000047683716f);
  ...
  _961 = exp2(log2(_949 * 9.999999747378752e-05f) * 0.1593017578125f);
  _962 = exp2(log2(_950 * 9.999999747378752e-05f) * 0.1593017578125f);
  _963 = exp2(log2(_951 * 9.999999747378752e-05f) * 0.1593017578125f);
