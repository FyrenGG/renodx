...
float4 main(
  ...
  if (_420) {
    _426 = _exposure0.x * _userImageAdjust.z;
    _445 = exp2(_powerParams.x * log2(max(0.0f, (((_426 * max(0.0f, (((_402 * -0.62179f) - (_401 * 0.08326f)) + (_403 * 1.70505f)))) * _slopeParams.x) + _offsetParams.x))));
    _461 = exp2(log2(max(0.0f, (((_slopeParams.y * _426) * max(0.0f, (((_402 * 1.1408f) - (_401 * 0.01055f)) - (_403 * 0.13026f)))) + _offsetParams.y))) * _powerParams.y);
    _477 = exp2(log2(max(0.0f, (((_slopeParams.z * _426) * max(0.0f, (((_401 * 1.15297f) - (_402 * 0.12897f)) - (_403 * 0.024f)))) + _offsetParams.z))) * _powerParams.z);
    _478 = dot(float3(_445, _461, _477), float3(0.212671f, 0.71516f, 0.072169f));
    _482 = ((_445 - _478) * _powerParams.w) + _478;
    _485 = ((_461 - _478) * _powerParams.w) + _478;
    _488 = ((_477 - _478) * _powerParams.w) + _478;
    _495 = min(max(log2(mad(_488, 0.079223745f, mad(_485, 0.0784336f, (_482 * 0.84247905f)))), -12.47393f), 4.026069f) + 12.47393f;
    _502 = min(max(log2(mad(_488, 0.07916613f, mad(_485, 0.87846863f, (_482 * 0.042328242f)))), -12.47393f), 4.026069f) + 12.47393f;
    _509 = min(max(log2(mad(_488, 0.879143f, mad(_485, 0.0784336f, (_482 * 0.042375654f)))), -12.47393f), 4.026069f) + 12.47393f;
    _510 = _495 * 0.060606062f;
    _511 = _502 * 0.060606062f;
    _512 = _509 * 0.060606062f;
    _513 = _510 * _510;
    _514 = _511 * _511;
    _515 = _512 * _512;
    _531 = min(0.0f, (-0.0f - (((_495 * 0.0072181816f) + ((_513 * 0.4298f) + (((_513 * _513) * ((31.96f - (_495 * 2.4327273f)) + (_513 * 15.5f))) - ((_495 * 0.41624245f) * _513)))) + -0.00232f)));
    _547 = min(0.0f, (-0.0f - (((_502 * 0.0072181816f) + ((_514 * 0.4298f) + (((_514 * _514) * ((31.96f - (_502 * 2.4327273f)) + (_514 * 15.5f))) - ((_502 * 0.41624245f) * _514)))) + -0.00232f)));
    ...
    _565 = -0.0f - _547;
    _566 = -0.0f - _563;
    _567 = dot(float3(_564, _565, _566), float3(0.2126f, 0.7152f, 0.0722f));
    if (_nightToneParm == 1) {
      _584 = exp2(exp2(log2(abs((_time.w * 0.11666667f) + -1.4f)) * 8.0f) * -1.442695f) + 1.0f;
      _585 = -0.79999995f / _584;
      _586 = -1.2f / _584;
      _587 = 0.20000005f / _584;
      _590 = saturate((_exposure2.x + -0.6f) * 0.10638298f);  // [sem: expr_sat]
      _593 = saturate((_exposure2.x + -0.1f) * 2.0f);  // [sem: expr_sat]
      _597 = (_585 + 1.4f) + (_593 * (-0.39999998f - _585));
      _601 = (_586 + 1.6f) + (_593 * (-0.6f - _586));
      _605 = (_587 + 0.9f) + (_593 * (0.5f - _587));
      _622 = (lerp(_605, 1.4f, _590));  // [sem: blended]
      _623 = (lerp(_597, 1.0f, _590));  // [sem: blended]
      _624 = (lerp(_601, 1.2f, _590));  // [sem: blended]
    } else {
      _622 = 1.4f;  // [sem: blended]
      _623 = 1.0f;  // [sem: blended]
      _624 = ((saturate((_exposure2.x + -3.0f) * 0.14285715f) * 0.20000005f) + 1.0f);  // [sem: blended]
    }
    _625 = 1.0f - _624;
    _637 = ((exp2(log2(((saturate((_531 * _531) * _564) * _625) + _624) * _564) * _623) - _567) * _622) + _567;
    _649 = ((exp2(log2(((saturate((_547 * _547) * _565) * _625) + _624) * _565) * _623) - _567) * _622) + _567;
    _661 = ((exp2(log2(((saturate((_563 * _563) * _566) * _625) + _624) * _566) * _623) - _567) * _622) + _567;
    _668 = saturate(exp2(log2(mad(_661, -0.09902974f, mad(_649, -0.09802088f, (_637 * 1.196879f)))) * 2.2f));  // [sem: expr_sat]
    _675 = saturate(exp2(log2(mad(_661, -0.098961174f, mad(_649, 1.1519032f, (_637 * -0.052896854f)))) * 2.2f));  // [sem: expr_sat]
    _682 = saturate(exp2(log2(mad(_661, 1.1510737f, mad(_649, -0.09804345f, (_637 * -0.052971635f)))) * 2.2f));  // [sem: expr_sat]
  ...
  if (_etcParams.y > 1.0f) {
    ...
    _789 = saturate(1.0f - (saturate(_etcParams.y + -1.0f) * dot(float2(_780, _783), float2(_780, _783))));  // [sem: expr_sat]
    _794 = (_789 * _773);
    _795 = (_789 * _774);
    _796 = (_789 * _775);
  } else {
