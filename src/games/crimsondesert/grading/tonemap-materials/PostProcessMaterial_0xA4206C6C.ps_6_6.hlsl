...
float4 main(
  ...
  _148 = WaveReadLaneFirst(BindlessParameters_PostProcessEdgeBlur_CD[((int)((uint)((uint)(select(((uint)_140 < (uint)170000), _140, 0))) + (uint)(0)))].BindlessParameters_PostProcessEdgeBlur_CD._edgeBlurRatio);
  _149 = WaveReadLaneFirst(_materialIndex);
  _157 = WaveReadLaneFirst(BindlessParameters_PostProcessEdgeBlur_CD[((int)((uint)((uint)(select(((uint)_149 < (uint)170000), _149, 0))) + (uint)(0)))].BindlessParameters_PostProcessEdgeBlur_CD._edgeBlurShiftValue);
  if ((_148 > 0.0f) && (_157 > 0.0f)) {
    ...
    _175 = (pow(_164.x, 0.012683313f));  // [sem: _3__36__0__0__g_postProcessSizeColor_sample_derived]
    _176 = (pow(_164.y, 0.012683313f));  // [sem: _3__36__0__0__g_postProcessSizeColor_sample_derived]
    _177 = (pow(_164.z, 0.012683313f));  // [sem: _3__36__0__0__g_postProcessSizeColor_sample_derived]
    _203 = WaveReadLaneFirst(_materialIndex);
    _211 = WaveReadLaneFirst(BindlessParameters_PostProcessEdgeBlur_CD[((int)((uint)((uint)(select(((uint)_203 < (uint)170000), _203, 0))) + (uint)(0)))].BindlessParameters_PostProcessEdgeBlur_CD._edgeBlurBrightness);
    _212 = _211 * (1.0f - _164.w);
    _232 = WaveReadLaneFirst(_materialIndex);
    _242 = WaveReadLaneFirst(BindlessParameters_PostProcessEdgeBlur_CD[((int)((uint)((uint)(select(((uint)_232 < (uint)170000), _232, 0))) + (uint)(0)))].BindlessParameters_PostProcessEdgeBlur_CD._targetFocusPositionOffset.x);
    _243 = WaveReadLaneFirst(BindlessParameters_PostProcessEdgeBlur_CD[((int)((uint)((uint)(select(((uint)_232 < (uint)170000), _232, 0))) + (uint)(0)))].BindlessParameters_PostProcessEdgeBlur_CD._targetFocusPositionOffset.y);
    _244 = WaveReadLaneFirst(BindlessParameters_PostProcessEdgeBlur_CD[((int)((uint)((uint)(select(((uint)_232 < (uint)170000), _232, 0))) + (uint)(0)))].BindlessParameters_PostProcessEdgeBlur_CD._targetFocusPositionOffset.z);
    ...
    _300 = ((_invViewProjRelative[3].w) + (_invViewProjRelative[3].z)) + mad((_invViewProjRelative[3].y), _264, ((_invViewProjRelative[3].x) * _261));
    _301 = ((mad((_invViewProjRelative[0].y), _264, ((_invViewProjRelative[0].x) * _261)) + (_invViewProjRelative[0].z)) + (_invViewProjRelative[0].w)) / _300;
    _302 = (((_invViewProjRelative[1].w) + (_invViewProjRelative[1].z)) + mad((_invViewProjRelative[1].y), _264, ((_invViewProjRelative[1].x) * _261))) / _300;
    _303 = (((_invViewProjRelative[2].w) + (_invViewProjRelative[2].z)) + mad((_invViewProjRelative[2].y), _264, ((_invViewProjRelative[2].x) * _261))) / _300;
    ...
    _357 = WaveReadLaneFirst(BindlessParameters_PostProcessEdgeBlur_CD[((int)((uint)((uint)(select(((uint)_348 < (uint)170000), _348, 0))) + (uint)(0)))].BindlessParameters_PostProcessEdgeBlur_CD._edgeBlurNoiseScale.x);
    _358 = WaveReadLaneFirst(BindlessParameters_PostProcessEdgeBlur_CD[((int)((uint)((uint)(select(((uint)_348 < (uint)170000), _348, 0))) + (uint)(0)))].BindlessParameters_PostProcessEdgeBlur_CD._edgeBlurNoiseScale.y);
    _362 = WaveReadLaneFirst(_materialIndex);
    _370 = WaveReadLaneFirst(BindlessParameters_PostProcessEdgeBlur_CD[((int)((uint)((uint)(select(((uint)_362 < (uint)170000), _362, 0))) + (uint)(0)))].BindlessParameters_PostProcessEdgeBlur_CD._useTargetFocusDir);
    if (_370 > 0.001f) {
      _386 = WaveReadLaneFirst(_materialIndex);
      _395 = WaveReadLaneFirst(BindlessParameters_PostProcessEdgeBlur_CD[((int)((uint)((uint)(select(((uint)_386 < (uint)170000), _386, 0))) + (uint)(0)))].BindlessParameters_PostProcessEdgeBlur_CD._edgeBlurNoiseScale.x);
      _396 = WaveReadLaneFirst(BindlessParameters_PostProcessEdgeBlur_CD[((int)((uint)((uint)(select(((uint)_386 < (uint)170000), _386, 0))) + (uint)(0)))].BindlessParameters_PostProcessEdgeBlur_CD._edgeBlurNoiseScale.y);
      _400 = (_395 * select((_344 && _345), 0.75f, select((_344 && _346), 0.25f, ((select((_343 && _346), (_342 + -3.1415927f), select((_343 && _345), (_342 + 3.1415927f), _342)) * 0.15915494f) + 0.5f))));
      _401 = ((_347 * 0.31830987f) * _396);
    } else {
      _400 = ((_96 * _28) * _357);
      _401 = (_358 * _97);
    }
    _404 = WaveReadLaneFirst(_materialIndex);
    _413 = WaveReadLaneFirst(BindlessParameters_PostProcessEdgeBlur_CD[((int)((uint)((uint)(select(((uint)_404 < (uint)170000), _404, 0))) + (uint)(0)))].BindlessParameters_PostProcessEdgeBlur_CD._edgeBlurNoiseSpeed.x);
    _414 = WaveReadLaneFirst(BindlessParameters_PostProcessEdgeBlur_CD[((int)((uint)((uint)(select(((uint)_404 < (uint)170000), _404, 0))) + (uint)(0)))].BindlessParameters_PostProcessEdgeBlur_CD._edgeBlurNoiseSpeed.y);
    _419 = WaveReadLaneFirst(_materialIndex);
    _427 = WaveReadLaneFirst(BindlessParameters_PostProcessEdgeBlur_CD[((int)((uint)((uint)(select(((uint)_419 < (uint)170000), _419, 0))) + (uint)(0)))].BindlessParameters_PostProcessEdgeBlur_CD._edgeBlurNoiseTex);
    _434 = __0__7__0__0__g_bindlessTextures[((int)((uint)((uint)(select(((uint)_427 < (uint)65000), _427, 0))) + (uint)(0)))].Sample(__0__4__0__0__g_staticBilinearWrap, float2(((_413 * _time.x) + _400), ((_414 * _time.x) + _401)));
    _439 = (_434.x * 2.0f) + -0.99607843f;
    _440 = (_434.y * 2.0f) + -0.99607843f;
    _445 = WaveReadLaneFirst(_materialIndex);
    _453 = WaveReadLaneFirst(BindlessParameters_PostProcessEdgeBlur_CD[((int)((uint)((uint)(select(((uint)_445 < (uint)170000), _445, 0))) + (uint)(0)))].BindlessParameters_PostProcessEdgeBlur_CD._targetFocusCenterMask);
    _454 = WaveReadLaneFirst(_materialIndex);
    _462 = WaveReadLaneFirst(BindlessParameters_PostProcessEdgeBlur_CD[((int)((uint)((uint)(select(((uint)_454 < (uint)170000), _454, 0))) + (uint)(0)))].BindlessParameters_PostProcessEdgeBlur_CD._targetFocusCenterMaskEdgeThickness);
    _463 = _462 * _453;
    _464 = WaveReadLaneFirst(_materialIndex);
    _472 = WaveReadLaneFirst(BindlessParameters_PostProcessEdgeBlur_CD[((int)((uint)((uint)(select(((uint)_464 < (uint)170000), _464, 0))) + (uint)(0)))].BindlessParameters_PostProcessEdgeBlur_CD._targetFocusCenterMaskPower);
    if (!(_453 < 0.001f)) {
      _485 = saturate((((1.0f - _453) + _463) - abs((_347 * 0.63661975f) + -1.0f)) / max(0.001f, _463));  // [sem: expr_sat]
    } else {
    ...
    _502 = WaveReadLaneFirst(BindlessParameters_PostProcessEdgeBlur_CD[((int)((uint)((uint)(select(((uint)_494 < (uint)170000), _494, 0))) + (uint)(0)))].BindlessParameters_PostProcessEdgeBlur_CD._debugMode);
    if (_502 == 1) {
      if (!_486) {
        _512 = (pow(_485, _472));
      } else {
    ...
    _525 = WaveReadLaneFirst(BindlessParameters_PostProcessEdgeBlur_CD[((int)((uint)((uint)(select(((uint)_517 < (uint)170000), _517, 0))) + (uint)(0)))].BindlessParameters_PostProcessEdgeBlur_CD._edgeBlurNoiseDissolve);
    if (_525 > 0.001f) {
      _528 = WaveReadLaneFirst(_materialIndex);
      _536 = WaveReadLaneFirst(BindlessParameters_PostProcessEdgeBlur_CD[((int)((uint)((uint)(select(((uint)_528 < (uint)170000), _528, 0))) + (uint)(0)))].BindlessParameters_PostProcessEdgeBlur_CD._edgeBlurNoiseDissolve);
      // [sem: expr_sat]
    ...
    _546 = _515;
    _547 = _516;
    _548 = (((_212 * _134) + exp2(log2(max(0.0f, (_175 + -0.8359375f)) / (18.851562f - (_175 * 18.6875f))) * 6.277395f)) * 10000.0f);
    _549 = (((_212 * _135) + exp2(log2(max(0.0f, (_176 + -0.8359375f)) / (18.851562f - (_176 * 18.6875f))) * 6.277395f)) * 10000.0f);
    _550 = (((_212 * _136) + exp2(log2(max(0.0f, (_177 + -0.8359375f)) / (18.851562f - (_177 * 18.6875f))) * 6.277395f)) * 10000.0f);
  ...
  if (_578) {
    ...
    _633 = exp2(log2(max(0.0f, (((_584 * max(0.0f, (((_559 * 1.70505f) - (_560 * 0.62179f)) - (_561 * 0.08326f)))) * _slopeParams.x) + _offsetParams.x))) * _powerParams.x);
    _634 = exp2(log2(max(0.0f, (((max(0.0f, (((_560 * 1.1408f) - (_559 * 0.13026f)) - (_561 * 0.01055f))) * _584) * _slopeParams.y) + _offsetParams.y))) * _powerParams.y);
    _635 = exp2(log2(max(0.0f, (((max(0.0f, (((_559 * -0.024f) - (_560 * 0.12897f)) + (_561 * 1.15297f))) * _584) * _slopeParams.z) + _offsetParams.z))) * _powerParams.z);
  ...
  _1012 = exp2(log2(_1000 * 0.0001f) * 0.15930176f);
  _1013 = exp2(log2(_1001 * 0.0001f) * 0.15930176f);
  _1014 = exp2(log2(_1002 * 0.0001f) * 0.15930176f);
  SV_Target.x = exp2(log2((1.0f / ((_1012 * 18.6875f) + 1.0f)) * ((_1012 * 18.851562f) + 0.8359375f)) * 78.84375f);
  SV_Target.y = exp2(log2((1.0f / ((_1013 * 18.6875f) + 1.0f)) * ((_1013 * 18.851562f) + 0.8359375f)) * 78.84375f);
  SV_Target.z = exp2(log2((1.0f / ((_1014 * 18.6875f) + 1.0f)) * ((_1014 * 18.851562f) + 0.8359375f)) * 78.84375f);
  SV_Target.w = _575;
  return SV_Target;
}
