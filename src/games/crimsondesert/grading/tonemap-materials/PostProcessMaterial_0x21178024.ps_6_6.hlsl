...
float4 main(
  ...
  if (_1488) {
    ...
    float3 _rndx_tonemapped_color = TonemapReplacer(float3(_1471, _1470, _1469));
    _1736 = _rndx_tonemapped_color.x;
    _1743 = _rndx_tonemapped_color.y;
    _1750 = _rndx_tonemapped_color.z;
