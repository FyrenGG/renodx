...
float4 main(
  ...
  _121 = (_116 * saturate(select((_83 < 0.040449999272823334f), (_83 * 0.07739938050508499f), exp2(log2((_83 + 0.054999999701976776f) * 0.9478673338890076f) * 2.4000000953674316f)))) + _120;
  _122 = (_116 * saturate(select((_84 < 0.040449999272823334f), (_84 * 0.07739938050508499f), exp2(log2((_84 + 0.054999999701976776f) * 0.9478673338890076f) * 2.4000000953674316f)))) + _120;
  _123 = (_116 * saturate(select((_85 < 0.040449999272823334f), (_85 * 0.07739938050508499f), exp2(log2((_85 + 0.054999999701976776f) * 0.9478673338890076f) * 2.4000000953674316f)))) + _120;
  ...
  _191 = 2.200000047683716f / ((min(max(_userImageAdjust.w, -1.0f), 1.0f) * 0.800000011920929f) + 2.200000047683716f);
  _202 = (TEXCOORD.x * 2.0f) + -1.0f;
  _203 = TEXCOORD.y * 2.0f;
  _204 = 1.0f - _203;
  _232 = mad((_projToPrevProj[2].w), 1.0000000116860974e-07f, mad((_projToPrevProj[1].w), _204, ((_projToPrevProj[0].w) * _202))) + (_projToPrevProj[3].w);
  _235 = ((mad((_projToPrevProj[2].x), 1.0000000116860974e-07f, mad((_projToPrevProj[1].x), _204, ((_projToPrevProj[0].x) * _202))) + (_projToPrevProj[3].x)) / _232) - _202;
  _236 = ((mad((_projToPrevProj[2].y), 1.0000000116860974e-07f, mad((_projToPrevProj[1].y), _204, ((_projToPrevProj[0].y) * _202))) + (_projToPrevProj[3].y)) / _232) - _204;
