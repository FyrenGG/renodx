...
float4 main(
  ...
  if (_45 == _renderPassInteraction) {
    ...
    _69 = WaveReadLaneFirst(BindlessParameters_PostProcessInteraction_CD[((int)((uint)(select(((uint)_61 < (uint)170000), _61, 0)) + 0u))].BindlessParameters_PostProcessInteraction_CD._lineTex);
    _103 = (((float4)(__0__7__0__0__g_bindlessTextures[((int)((uint)(select(((uint)_69 < (uint)65000), _69, 0)) + 0u))].Sample(__0__4__0__0__g_staticBilinearWrap, float2((TEXCOORD.x * 50.0f), (TEXCOORD.y * 50.0f))))).x);
  // [sem: expr_sat]
    _104 = saturate(ceil(((_nearFarProj.x / max(1.0000000116860974e-07f, ((__3__36__0__0__g_depth.Sample(__0__4__0__0__g_staticBilinearClamp, float2(TEXCOORD.x, TEXCOORD.y))).x))) + 0.05000000074505806f) - (_nearFarProj.x / max(1.0000000116860974e-07f, (((float4)(__3__36__0__0__g_CustomRenderPassDepth.Load(int3(int(_customRenderPassSizeInvSize.x * TEXCOORD.x), int(_customRenderPassSizeInvSize.y * TEXCOORD.y), 0)))).x)))));
  } else {
    _103 = 0.0f;
  ...
  // [sem: _3__36__0__0__g_CustomRenderPassDepth_load]
    _122 = __3__36__0__0__g_CustomRenderPassDepth.Load(int3(int(_customRenderPassSizeInvSize.x * (TEXCOORD.x - (0.10000000149011612f / _srcTargetSizeAndInv.x))), _120, 0));
    _124 = 2.200000047683716f / _srcTargetSizeAndInv.x;
    _125 = TEXCOORD.x - _124;
    _131 = (_125 * 2.0f) + -1.0f;
    _133 = 1.0f - (TEXCOORD.y * 2.0f);
    _134 = max(1.0000000116860974e-07f, (((float4)(__3__36__0__0__g_CustomRenderPassDepth.Load(int3(int(_125 * _customRenderPassSizeInvSize.x), _120, 0)))).x));
    _170 = mad((_invViewProj[2].w), _134, mad((_invViewProj[1].w), _133, ((_invViewProj[0].w) * _131))) + (_invViewProj[3].w);
    _174 = _124 + TEXCOORD.x;
    _180 = (_174 * 2.0f) + -1.0f;
    _181 = max(1.0000000116860974e-07f, (((float4)(__3__36__0__0__g_CustomRenderPassDepth.Load(int3(int(_174 * _customRenderPassSizeInvSize.x), _120, 0)))).x));
    _197 = mad((_invViewProj[2].w), _181, mad((_invViewProj[1].w), _133, ((_invViewProj[0].w) * _180))) + (_invViewProj[3].w);
    _201 = 2.200000047683716f / _srcTargetSizeAndInv.y;
    _202 = TEXCOORD.y - _201;
    _205 = int(_customRenderPassSizeInvSize.x * TEXCOORD.x);
    _210 = (TEXCOORD.x * 2.0f) + -1.0f;
    _212 = 1.0f - (_202 * 2.0f);
    _213 = max(1.0000000116860974e-07f, (((float4)(__3__36__0__0__g_CustomRenderPassDepth.Load(int3(_205, int(_202 * _customRenderPassSizeInvSize.y), 0)))).x));
    _214 = (_invViewProj[0].x) * _210;
    _218 = (_invViewProj[0].y) * _210;
    _222 = (_invViewProj[0].z) * _210;
    _226 = (_invViewProj[0].w) * _210;
    _229 = mad((_invViewProj[2].w), _213, mad((_invViewProj[1].w), _212, _226)) + (_invViewProj[3].w);
    _233 = _201 + TEXCOORD.y;
    _239 = 1.0f - (_233 * 2.0f);
    _240 = max(1.0000000116860974e-07f, (((float4)(__3__36__0__0__g_CustomRenderPassDepth.Load(int3(_205, int(_233 * _customRenderPassSizeInvSize.y), 0)))).x));
    _252 = mad((_invViewProj[2].w), _240, mad((_invViewProj[1].w), _239, _226)) + (_invViewProj[3].w);
    _256 = ((mad((_invViewProj[2].x), _240, mad((_invViewProj[1].x), _239, _214)) + (_invViewProj[3].x)) / _252) - ((mad((_invViewProj[2].x), _213, mad((_invViewProj[1].x), _212, _214)) + (_invViewProj[3].x)) / _229);
    _257 = ((mad((_invViewProj[2].y), _240, mad((_invViewProj[1].y), _239, _218)) + (_invViewProj[3].y)) / _252) - ((mad((_invViewProj[2].y), _213, mad((_invViewProj[1].y), _212, _218)) + (_invViewProj[3].y)) / _229);
    _258 = ((mad((_invViewProj[2].z), _240, mad((_invViewProj[1].z), _239, _222)) + (_invViewProj[3].z)) / _252) - ((mad((_invViewProj[2].z), _213, mad((_invViewProj[1].z), _212, _222)) + (_invViewProj[3].z)) / _229);
    _259 = ((mad((_invViewProj[2].x), _181, mad((_invViewProj[1].x), _133, ((_invViewProj[0].x) * _180))) + (_invViewProj[3].x)) / _197) - ((mad((_invViewProj[2].x), _134, mad((_invViewProj[1].x), _133, ((_invViewProj[0].x) * _131))) + (_invViewProj[3].x)) / _170);
    _260 = ((mad((_invViewProj[2].y), _181, mad((_invViewProj[1].y), _133, ((_invViewProj[0].y) * _180))) + (_invViewProj[3].y)) / _197) - ((mad((_invViewProj[2].y), _134, mad((_invViewProj[1].y), _133, ((_invViewProj[0].y) * _131))) + (_invViewProj[3].y)) / _170);
    _261 = ((mad((_invViewProj[2].z), _181, mad((_invViewProj[1].z), _133, ((_invViewProj[0].z) * _180))) + (_invViewProj[3].z)) / _197) - ((mad((_invViewProj[2].z), _134, mad((_invViewProj[1].z), _133, ((_invViewProj[0].z) * _131))) + (_invViewProj[3].z)) / _170);
  ...
  // [sem: expr_sat]
    ...
    _300 = frac(_time.x * 0.4000000059604645f);
    _304 = abs((1.9989999532699585f - _284) - (_300 * 2.5f));
  ...
  // [sem: expr_sat]
    ...
    _331 = _330 * 0.0020000000949949026f;
    _332 = _331 * _48.x;
    _333 = _331 * _48.y;
    _334 = _331 * _48.z;
    ...
    if (_45 == _renderPassDetectObjective) {
      ...
      _401 = (saturate(_383.x * 1.0009784698486328f) * 2.0f) + -1.0f;  // [sem: _3__36__0__0__g_gbufferNormal_load_derived]
      _402 = (saturate(_383.y * 1.0009784698486328f) * 2.0f) + -1.0f;  // [sem: _3__36__0__0__g_gbufferNormal_load_derived]
      _403 = (saturate(_383.z * 1.0009784698486328f) * 2.0f) + -1.0f;  // [sem: _3__36__0__0__g_gbufferNormal_load_derived]
      _405 = rsqrt(dot(float3(_401, _402, _403), float3(_401, _402, _403)));  // [sem: invLength]
      _406 = _405 * _401;
      _407 = _405 * _402;
      _408 = _403 * _405;
      _411 = (((float)((uint)((uint)(((uint)((uint)(_380.w)) >> 8) & 255)))) * 0.007843137718737125f) + -1.0f;  // [sem: _3__36__0__0__g_gbufferBaseColor_load_derived]
      _412 = (((float)((uint)((uint)(_380.w & 255)))) * 0.007843137718737125f) + -1.0f;  // [sem: _3__36__0__0__g_gbufferBaseColor_load_derived]
      _415 = (_411 + _412) * 0.5f;
      _416 = (_411 - _412) * 0.5f;
  ...
  // [sem: expr_sat]
      ...
      _488 = abs((1.9989999532699585f - _464) - ((pow(_481, 0.5f)) * 2.25f));
      _491 = saturate(1.0f - (_488 * 40.0f));  // [sem: expr_sat]
      _507 = (saturate(exp2(log2(1.0f - abs(dot(float3(_453, _454, _455), float3(_viewDir.x, _viewDir.y, _viewDir.z)))) * 0.800000011920929f)) * _104) * saturate(1.0f - (_488 * 3.3333332538604736f));
      _508 = _exposure2.x * 25.0f;
      _515 = _508 * saturate((saturate(((2.0f - _464) * _103) + exp2(log2(1.0f - _464) * 4.0f)) * _104) * (_491 - ((_481 * 0.8999999761581421f) * _491)));
  ...
  if (_542) {
    ...
    if (_etcParams.z == 0.0f) {
      ...
      _884 = 2.200000047683716f / ((min(max(_userImageAdjust.w, -1.0f), 1.0f) * 0.800000011920929f) + 2.200000047683716f);
  ...
  if (_542 && (_etcParams.z > 0.0f)) {
    ...
    _949 = select((_917 <= 0.0031308000907301903f), (_917 * 12.920000076293945f), (((pow(_917, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f));
    _950 = select((_918 <= 0.0031308000907301903f), (_918 * 12.920000076293945f), (((pow(_918, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f));
  } else {
    _948 = _916;
    _949 = _917;
    _950 = _918;
