...
float4 main(
  ...
  _187 = saturate(_etcParams.w);
  _226 = (_186 * saturate(_rndx_tonemapped_color.x)) + _187;
  _213 = (_186 * saturate(_rndx_tonemapped_color.y)) + _187;
  _200 = (_186 * saturate(_rndx_tonemapped_color.z)) + _187;
  ...
  _327 = saturate(1.0f - ((_318 * _postProcessParams.x * CUSTOM_VIGNETTE) * dot(float2(_319, _321), float2(_319, _321))));  // [sem: expr_sat]
