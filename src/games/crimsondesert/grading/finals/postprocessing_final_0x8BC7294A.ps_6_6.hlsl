...
float4 main(
  ...
  // RenoDX: >>> [Patch: RemoveFinalSrgbDecodeHDR] [Version: 1.13.00]
  _219 = (_214 * _184) + _218;
  _220 = (_214 * _185) + _218;
  _221 = (_214 * _186) + _218;
  ...
  _282 = 1.0f - _281;
  _310 = mad((_projToPrevProj[2].w), 1.0000000116860974e-07f, mad((_projToPrevProj[1].w), _282, ((_projToPrevProj[0].w) * _280))) + (_projToPrevProj[3].w);
  _313 = ((mad((_projToPrevProj[2].x), 1.0000000116860974e-07f, mad((_projToPrevProj[1].x), _282, ((_projToPrevProj[0].x) * _280))) + (_projToPrevProj[3].x)) / _310) - _280;
  _314 = ((mad((_projToPrevProj[2].y), 1.0000000116860974e-07f, mad((_projToPrevProj[1].y), _282, ((_projToPrevProj[0].y) * _280))) + (_projToPrevProj[3].y)) / _310) - _282;
