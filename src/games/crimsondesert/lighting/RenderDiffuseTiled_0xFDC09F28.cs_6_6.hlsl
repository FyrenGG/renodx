...
void main(
  ...
  if (!(((_122 && _124) && _126) && _128)) {
    ...
    _3369 = _3363 * (((_3258 * 0.61312f) + (_3264 * 0.33951f)) + (_3270 * 0.04737f));
    _3375 = _3363 * (((_3258 * 0.0702f) + (_3264 * 0.91636f)) + (_3270 * 0.01345f));
    _3381 = _3363 * (((_3258 * 0.02062f) + (_3264 * 0.10958f)) + (_3270 * 0.8698f));
    _3382 = _3360 - _1071;
    _3383 = _3359 - _1073;
    _3384 = _3358 - _1075;
