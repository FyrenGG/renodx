...
float4 main(
  ...
  _536 = saturate(_etcParams.w);
  _537 = (_532 * saturate(_rndx_tonemapped_color.x)) + _536;
  _538 = (_532 * saturate(_rndx_tonemapped_color.y)) + _536;
  _539 = (_532 * saturate(_rndx_tonemapped_color.z)) + _536;
  ...
  _606 = 2.200000047683716f / ((min(max(_userImageAdjust.w, -1.0f), 1.0f) * 0.800000011920929f) + 2.200000047683716f);
  _617 = (TEXCOORD.x * 2.0f) + -1.0f;
  _618 = TEXCOORD.y * 2.0f;
  _619 = 1.0f - _618;
  _647 = mad((_projToPrevProj[2].w), 1.0000000116860974e-07f, mad((_projToPrevProj[1].w), _619, ((_projToPrevProj[0].w) * _617))) + (_projToPrevProj[3].w);
  _650 = ((mad((_projToPrevProj[2].x), 1.0000000116860974e-07f, mad((_projToPrevProj[1].x), _619, ((_projToPrevProj[0].x) * _617))) + (_projToPrevProj[3].x)) / _647) - _617;
  _651 = ((mad((_projToPrevProj[2].y), 1.0000000116860974e-07f, mad((_projToPrevProj[1].y), _619, ((_projToPrevProj[0].y) * _617))) + (_projToPrevProj[3].y)) / _647) - _619;
  ...
  _667 = abs(_617);
  _668 = abs(_618 + -1.0f);
  _672 = saturate(1.0f - ((_664 * _postProcessParams.x * CUSTOM_VIGNETTE) * dot(float2(_667, _668), float2(_667, _668))));  // [sem: expr_sat]
