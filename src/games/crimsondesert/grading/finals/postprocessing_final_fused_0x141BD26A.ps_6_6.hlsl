...
float4 main(
  ...
  _491 = saturate(_etcParams.w);
  _492 = (_487 * saturate(_rndx_tonemapped_color.x)) + _491;
  _493 = (_487 * saturate(_rndx_tonemapped_color.y)) + _491;
  _494 = (_487 * saturate(_rndx_tonemapped_color.z)) + _491;
  ...
  _561 = 2.200000047683716f / ((min(max(_userImageAdjust.w, -1.0f), 1.0f) * 0.800000011920929f) + 2.200000047683716f);
  _572 = (TEXCOORD.x * 2.0f) + -1.0f;
  _573 = TEXCOORD.y * 2.0f;
  _574 = 1.0f - _573;
  _602 = mad((_projToPrevProj[2].w), 1.0000000116860974e-07f, mad((_projToPrevProj[1].w), _574, ((_projToPrevProj[0].w) * _572))) + (_projToPrevProj[3].w);
  _605 = ((mad((_projToPrevProj[2].x), 1.0000000116860974e-07f, mad((_projToPrevProj[1].x), _574, ((_projToPrevProj[0].x) * _572))) + (_projToPrevProj[3].x)) / _602) - _572;
  _606 = ((mad((_projToPrevProj[2].y), 1.0000000116860974e-07f, mad((_projToPrevProj[1].y), _574, ((_projToPrevProj[0].y) * _572))) + (_projToPrevProj[3].y)) / _602) - _574;
  ...
  _623 = abs(_572);
  _624 = abs(_573 + -1.0f);
  _628 = saturate(1.0f - ((_620 * _postProcessParams.x * CUSTOM_VIGNETTE) * dot(float2(_623, _624), float2(_623, _624))));  // [sem: expr_sat]
