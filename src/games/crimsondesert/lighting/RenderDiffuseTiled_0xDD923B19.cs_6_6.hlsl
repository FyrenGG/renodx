...
Texture2D<float4> __3__36__0__0__g_puddleMask : register(t132, space36);

Texture2D<float4> __3__36__0__0__g_climateSandTex : register(t139, space36);

Texture2D<uint16_t> __3__36__0__0__g_sceneDecalMask : register(t133, space36);
...
Texture3D<float2> __3__36__0__0__g_hairDualScatteringLUT : register(t217, space36);

Texture2D<float4> __3__36__0__0__g_blueNoise : register(t142, space36);

Texture2D<float4> __3__36__0__0__g_bentCone : register(t88, space36);

Texture2D<float4> __3__36__0__0__g_character : register(t59, space36);

Texture2D<float4> __3__36__0__0__g_specularResult : register(t147, space36);

Texture2D<float2> __3__36__0__0__g_iblBrdfLookup : register(t148, space36);

Texture2D<float2> __3__36__0__0__g_hairBrdfLookup : register(t150, space36);

Texture2D<uint2> __3__36__0__0__g_stencilPrev : register(t66, space36);

Texture2D<half4> __3__36__0__0__g_sceneDiffuse : register(t176, space36);

Texture2D<half4> __3__36__0__0__g_diffuseResult : register(t177, space36);

Texture2D<half4> __3__36__0__0__g_diffuseResultPrev : register(t186, space36);

Texture2D<half4> __3__36__0__0__g_specularResultPrev : register(t67, space36);

Texture2D<half2> __3__36__0__0__g_sceneAO : register(t138, space36);
...
Texture2D<uint2> __3__36__0__0__g_stencil : register(t22, space36);

Texture2D<float4> __3__36__0__0__g_manyLightsMoments : register(t24, space36);

Texture2D<float> __3__36__0__0__g_specularRayHitDistance : register(t75, space36);

Texture2D<float> __3__36__0__0__g_caustic : register(t76, space36);

Texture2D<uint> __3__36__0__0__g_tiledManyLightsMasks : register(t33, space36);
...
RWTexture2D<half4> __3__38__0__1__g_sceneColorLightingOnlyForAwbUAV : register(u30, space38);
...
cbuffer __3__35__0__0__MaterialParameterPresetTableConstantBuffer : register(b39, space35) {
  struct {
...
void main(
  ...
  // RenoDX: >>> [Patch: RenderDiffuseTiledInvalidPixelGuard] [Version: 1.13.00]
  // Description: RenderDiffuseTiled evaluates partially valid 2x2 quads while preserving the per-pixel invalid predicate for full-resolution scene-color writes. This block computes the current pixel invalid flag and the 2x2 quad invalid flags used by the half-resolution history fallback and final scene-color guard.
  ...
  // RenoDX: <<< [Patch: RenderDiffuseTiledInvalidPixelGuard]
  ...
  // [sem: _3__36__0__0__g_sceneNormal_load_derived]
    ...
    // Sky-visibility earth-radial distance is world-space (_viewPos.x/z offsets); _3244 stays camera-relative for the cloud math below.
    float _rndx_skyVisX = _viewPos.x + _394;
    float _rndx_skyVisZ = _viewPos.z + _396;
    _3244 = (_396 * _396) + (_394 * _394);
    _3246 = sqrt(((_rndx_skyVisX * _rndx_skyVisX) + (_3240 * _3240)) + (_rndx_skyVisZ * _rndx_skyVisZ));
    _3251 = dot(float3((_rndx_skyVisX / _3246), (_3240 / _3246), (_rndx_skyVisZ / _3246)), float3(_3212, _3213, _3214));
  ...
  // [sem: _3__36__0__0__g_iblBrdfLookup_sampleLod]
    ...
    // RenoDX: >>> [Patch: RenderDiffuseTiledInvalidPixelGuard] [Version: 1.13.00]
    // Description: Avoid averaging half-resolution history across a 2x2 quad that contains any invalid pixel. This preserves the current pixel value for mixed valid/invalid quads instead of blending invalid neighbors into valid pixels.
    if (!(((_rndx_quadInvalid0 || _rndx_quadInvalid1) || _rndx_quadInvalid2) || _rndx_quadInvalid3)) {
    ...
    // RenoDX: >>> [Patch: RenderDiffuseTiledInvalidPixelGuard] [Version: 1.13.00]
    // Description: RenderDiffuseTiled can execute the full-resolution scene-color path for invalid pixels inside partially valid 2x2 quads. Guard that path so invalid pixels do not read, accumulate, or store full-resolution scene color while valid pixels preserve the native output.
