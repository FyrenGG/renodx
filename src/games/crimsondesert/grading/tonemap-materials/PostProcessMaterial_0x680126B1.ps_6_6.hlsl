...
float4 main(
  ...
  switch (_179) {
    case 0: {
      ...
      _193 = (pow(_183.x, 0.012683313339948654f));  // [sem: _3__36__0__0__g_sceneColor_sample_derived]
      _194 = (pow(_183.y, 0.012683313339948654f));  // [sem: _3__36__0__0__g_sceneColor_sample_derived]
      _195 = (pow(_183.z, 0.012683313339948654f));  // [sem: _3__36__0__0__g_sceneColor_sample_derived]
      ...
      _257 = (saturate(_239.x * 1.0009784698486328f) * 2.0f) + -1.0f;  // [sem: _3__36__0__0__g_gbufferNormal_load_derived]
      _258 = (saturate(_239.y * 1.0009784698486328f) * 2.0f) + -1.0f;  // [sem: _3__36__0__0__g_gbufferNormal_load_derived]
      _259 = (saturate(_239.z * 1.0009784698486328f) * 2.0f) + -1.0f;  // [sem: _3__36__0__0__g_gbufferNormal_load_derived]
      _261 = rsqrt(dot(float3(_257, _258, _259), float3(_257, _258, _259)));  // [sem: invLength]
      _262 = _261 * _257;
      _263 = _261 * _258;
      _264 = _259 * _261;
      _267 = (((float)((uint)((uint)(((uint)((uint)(_236.w)) >> 8) & 255)))) * 0.007843137718737125f) + -1.0f;  // [sem: _3__36__0__0__g_gbufferBaseColor_load_derived]
      _268 = (((float)((uint)((uint)(_236.w & 255)))) * 0.007843137718737125f) + -1.0f;  // [sem: _3__36__0__0__g_gbufferBaseColor_load_derived]
      _271 = (_267 + _268) * 0.5f;
      _272 = (_267 - _268) * 0.5f;
      ...
      _579 = (exp2(log2(max(0.0f, (_193 + -0.8359375f)) / (18.8515625f - (_193 * 18.6875f))) * 6.277394771575928f) * 10000.0f);
      _580 = (exp2(log2(max(0.0f, (_194 + -0.8359375f)) / (18.8515625f - (_194 * 18.6875f))) * 6.277394771575928f) * 10000.0f);
      _581 = (exp2(log2(max(0.0f, (_195 + -0.8359375f)) / (18.8515625f - (_195 * 18.6875f))) * 6.277394771575928f) * 10000.0f);
    ...
    case 1: {
      ...
      _325 = (pow(_315.x, 0.012683313339948654f));  // [sem: _3__36__0__0__g_sceneColor_sample_derived]
      _326 = (pow(_315.y, 0.012683313339948654f));  // [sem: _3__36__0__0__g_sceneColor_sample_derived]
      _327 = (pow(_315.z, 0.012683313339948654f));  // [sem: _3__36__0__0__g_sceneColor_sample_derived]
      ...
      _390 = (saturate(_372.x * 1.0009784698486328f) * 2.0f) + -1.0f;  // [sem: _3__36__0__0__g_gbufferNormal_load_derived]
      _391 = (saturate(_372.y * 1.0009784698486328f) * 2.0f) + -1.0f;  // [sem: _3__36__0__0__g_gbufferNormal_load_derived]
      _392 = (saturate(_372.z * 1.0009784698486328f) * 2.0f) + -1.0f;  // [sem: _3__36__0__0__g_gbufferNormal_load_derived]
      _394 = rsqrt(dot(float3(_390, _391, _392), float3(_390, _391, _392)));  // [sem: invLength]
      _395 = _394 * _390;
      _396 = _394 * _391;
      _397 = _392 * _394;
      _400 = (((float)((uint)((uint)(((uint)((uint)(_369.w)) >> 8) & 255)))) * 0.007843137718737125f) + -1.0f;  // [sem: _3__36__0__0__g_gbufferBaseColor_load_derived]
      _401 = (((float)((uint)((uint)(_369.w & 255)))) * 0.007843137718737125f) + -1.0f;  // [sem: _3__36__0__0__g_gbufferBaseColor_load_derived]
      _404 = (_400 + _401) * 0.5f;
      _405 = (_400 - _401) * 0.5f;
      ...
      _579 = (exp2(log2(max(0.0f, (_325 + -0.8359375f)) / (18.8515625f - (_325 * 18.6875f))) * 6.277394771575928f) * 10000.0f);
      _580 = (exp2(log2(max(0.0f, (_326 + -0.8359375f)) / (18.8515625f - (_326 * 18.6875f))) * 6.277394771575928f) * 10000.0f);
      _581 = (exp2(log2(max(0.0f, (_327 + -0.8359375f)) / (18.8515625f - (_327 * 18.6875f))) * 6.277394771575928f) * 10000.0f);
    ...
    case 2: {
      ...
      _458 = (pow(_448.x, 0.012683313339948654f));  // [sem: _3__36__0__0__g_sceneColor_sample_derived]
      _459 = (pow(_448.y, 0.012683313339948654f));  // [sem: _3__36__0__0__g_sceneColor_sample_derived]
      _460 = (pow(_448.z, 0.012683313339948654f));  // [sem: _3__36__0__0__g_sceneColor_sample_derived]
      ...
      _523 = (saturate(_505.x * 1.0009784698486328f) * 2.0f) + -1.0f;  // [sem: _3__36__0__0__g_gbufferNormal_load_derived]
      _524 = (saturate(_505.y * 1.0009784698486328f) * 2.0f) + -1.0f;  // [sem: _3__36__0__0__g_gbufferNormal_load_derived]
      _525 = (saturate(_505.z * 1.0009784698486328f) * 2.0f) + -1.0f;  // [sem: _3__36__0__0__g_gbufferNormal_load_derived]
      _527 = rsqrt(dot(float3(_523, _524, _525), float3(_523, _524, _525)));  // [sem: invLength]
      _528 = _527 * _523;
      _529 = _527 * _524;
      _530 = _525 * _527;
      _533 = (((float)((uint)((uint)(((uint)((uint)(_502.w)) >> 8) & 255)))) * 0.007843137718737125f) + -1.0f;  // [sem: _3__36__0__0__g_gbufferBaseColor_load_derived]
      _534 = (((float)((uint)((uint)(_502.w & 255)))) * 0.007843137718737125f) + -1.0f;  // [sem: _3__36__0__0__g_gbufferBaseColor_load_derived]
      _537 = (_533 + _534) * 0.5f;
      _538 = (_533 - _534) * 0.5f;
      ...
      _579 = (exp2(log2(max(0.0f, (_458 + -0.8359375f)) / (18.8515625f - (_458 * 18.6875f))) * 6.277394771575928f) * 10000.0f);
      _580 = (exp2(log2(max(0.0f, (_459 + -0.8359375f)) / (18.8515625f - (_459 * 18.6875f))) * 6.277394771575928f) * 10000.0f);
      _581 = (exp2(log2(max(0.0f, (_460 + -0.8359375f)) / (18.8515625f - (_460 * 18.6875f))) * 6.277394771575928f) * 10000.0f);
  ...
  _607 = (_582 < 1.0000000116860974e-07f) || (_582 == 1.0f);
  _608 = WaveReadLaneFirst(_materialIndex);
  _616 = WaveReadLaneFirst(BindlessParameters_PostProcessTransition[((int)((uint)(select(((uint)_608 < (uint)170000), _608, 0)) + 0u))].BindlessParameters_PostProcessTransition._impactFrame);
  if (!(!(_616 >= 0.0010000000474974513f))) {
    ...
    _641 = WaveReadLaneFirst(BindlessParameters_PostProcessTransition[((int)((uint)(select(((uint)_633 < (uint)170000), _633, 0)) + 0u))].BindlessParameters_PostProcessTransition._impactFrameInverse);
    _644 = select((_641 > 0.0010000000474974513f), (1.0f - _632), _632);
    _645 = WaveReadLaneFirst(_materialIndex);
    _653 = WaveReadLaneFirst(BindlessParameters_PostProcessTransition[((int)((uint)(select(((uint)_645 < (uint)170000), _645, 0)) + 0u))].BindlessParameters_PostProcessTransition._impactFrameFresnel);
    _654 = abs(_653);
    if (!(_607 || (!(_654 > 0.0f)))) {
      ...
      _683 = WaveReadLaneFirst(BindlessParameters_PostProcessTransition[((int)((uint)(select(((uint)_675 < (uint)170000), _675, 0)) + 0u))].BindlessParameters_PostProcessTransition._impactFrameFresnelIntensity);
      _689 = ((saturate(_683 * exp2(log2(select((_653 < 0.0f), (1.0f - _669), _669)) * _654)) + 0.0020000000949949026f) * _644);
    } else {
      _689 = _644;
    }
    _693 = _689 / max(0.0010000000474974513f, _exposure0.x);
  ...
  _715 = WaveReadLaneFirst(BindlessParameters_PostProcessTransition[((int)((uint)(select(((uint)_707 < (uint)170000), _707, 0)) + 0u))].BindlessParameters_PostProcessTransition._topVignetteRatio);
  _716 = WaveReadLaneFirst(_materialIndex);
  _724 = WaveReadLaneFirst(BindlessParameters_PostProcessTransition[((int)((uint)(select(((uint)_716 < (uint)170000), _716, 0)) + 0u))].BindlessParameters_PostProcessTransition._sideVignetteRatio);
  _725 = WaveReadLaneFirst(_materialIndex);
  _733 = WaveReadLaneFirst(BindlessParameters_PostProcessTransition[((int)((uint)(select(((uint)_725 < (uint)170000), _725, 0)) + 0u))].BindlessParameters_PostProcessTransition._bottomVignetteRatio);
  if (!(!(_724 >= 0.0010000000474974513f))) {
    _736 = TEXCOORD.x + -0.5f;
    _737 = TEXCOORD.y + -0.5f;
    _742 = WaveReadLaneFirst(_materialIndex);
    _750 = WaveReadLaneFirst(BindlessParameters_PostProcessTransition[((int)((uint)(select(((uint)_742 < (uint)170000), _742, 0)) + 0u))].BindlessParameters_PostProcessTransition._sideVignetteRadius);
    _756 = WaveReadLaneFirst(_materialIndex);
    _764 = WaveReadLaneFirst(BindlessParameters_PostProcessTransition[((int)((uint)(select(((uint)_756 < (uint)170000), _756, 0)) + 0u))].BindlessParameters_PostProcessTransition._sideVignettePower);
    _770 = WaveReadLaneFirst(_materialIndex);
    _778 = WaveReadLaneFirst(BindlessParameters_PostProcessTransition[((int)((uint)(select(((uint)_770 < (uint)170000), _770, 0)) + 0u))].BindlessParameters_PostProcessTransition._sideVignetteColor);
    _781 = (float)((uint)((uint)(((uint)(_778) >> 16) & 255)));
    _784 = (float)((uint)((uint)(((uint)(_778) >> 8) & 255)));
    _786 = (float)((uint)((uint)(_778 & 255)));
    _816 = max(0.0010000000474974513f, _exposure0.x);
    _820 = saturate(exp2(log2(abs(0.5f - TEXCOORD.x)) * _764) * (sqrt((_737 * _737) + (_736 * _736)) / max(0.0010000000474974513f, (1.0f - _750)))) * _724;
    _828 = (((select(((_781 * 0.003921568859368563f) < 0.040449999272823334f), (_781 * 0.0003035269910469651f), exp2(log2((_781 * 0.0037171270232647657f) + 0.052132703363895416f) * 2.4000000953674316f)) / _816) * _820) + _704);
    _829 = (((select(((_784 * 0.003921568859368563f) < 0.040449999272823334f), (_784 * 0.0003035269910469651f), exp2(log2((_784 * 0.0037171270232647657f) + 0.052132703363895416f) * 2.4000000953674316f)) / _816) * _820) + _705);
    _830 = (((select(((_786 * 0.003921568859368563f) < 0.040449999272823334f), (_786 * 0.0003035269910469651f), exp2(log2((_786 * 0.0037171270232647657f) + 0.052132703363895416f) * 2.4000000953674316f)) / _816) * _820) + _706);
  } else {
    _828 = _704;
    _829 = _705;
    _830 = _706;
  }
  if (!(!(_715 >= 0.0010000000474974513f))) {
    _833 = TEXCOORD.x + -0.5f;
    _834 = TEXCOORD.y + -0.5f;
    _839 = WaveReadLaneFirst(_materialIndex);
    _847 = WaveReadLaneFirst(BindlessParameters_PostProcessTransition[((int)((uint)(select(((uint)_839 < (uint)170000), _839, 0)) + 0u))].BindlessParameters_PostProcessTransition._topVignetteRadius);
    _852 = WaveReadLaneFirst(_materialIndex);
    _860 = WaveReadLaneFirst(BindlessParameters_PostProcessTransition[((int)((uint)(select(((uint)_852 < (uint)170000), _852, 0)) + 0u))].BindlessParameters_PostProcessTransition._topVignettePower);
    _866 = WaveReadLaneFirst(_materialIndex);
    _874 = WaveReadLaneFirst(BindlessParameters_PostProcessTransition[((int)((uint)(select(((uint)_866 < (uint)170000), _866, 0)) + 0u))].BindlessParameters_PostProcessTransition._topVignetteColor);
    _877 = (float)((uint)((uint)(((uint)(_874) >> 16) & 255)));
    _880 = (float)((uint)((uint)(((uint)(_874) >> 8) & 255)));
    _882 = (float)((uint)((uint)(_874 & 255)));
    _912 = max(0.0010000000474974513f, _exposure0.x);
    _916 = saturate(exp2(log2(1.0f - TEXCOORD.y) * _860) * (sqrt((_834 * _834) + (_833 * _833)) / max(0.0010000000474974513f, (1.0f - _847)))) * _715;
    _924 = (((select(((_877 * 0.003921568859368563f) < 0.040449999272823334f), (_877 * 0.0003035269910469651f), exp2(log2((_877 * 0.0037171270232647657f) + 0.052132703363895416f) * 2.4000000953674316f)) / _912) * _916) + _828);
    _925 = (((select(((_880 * 0.003921568859368563f) < 0.040449999272823334f), (_880 * 0.0003035269910469651f), exp2(log2((_880 * 0.0037171270232647657f) + 0.052132703363895416f) * 2.4000000953674316f)) / _912) * _916) + _829);
    _926 = (((select(((_882 * 0.003921568859368563f) < 0.040449999272823334f), (_882 * 0.0003035269910469651f), exp2(log2((_882 * 0.0037171270232647657f) + 0.052132703363895416f) * 2.4000000953674316f)) / _912) * _916) + _830);
  } else {
    _924 = _828;
    _925 = _829;
    _926 = _830;
  }
  if (!(!(_733 >= 0.0010000000474974513f))) {
    _929 = TEXCOORD.x + -0.5f;
    _930 = TEXCOORD.y + -0.5f;
    _935 = WaveReadLaneFirst(_materialIndex);
    _943 = WaveReadLaneFirst(BindlessParameters_PostProcessTransition[((int)((uint)(select(((uint)_935 < (uint)170000), _935, 0)) + 0u))].BindlessParameters_PostProcessTransition._bottomVignetteRadius);
    _947 = WaveReadLaneFirst(_materialIndex);
    _955 = WaveReadLaneFirst(BindlessParameters_PostProcessTransition[((int)((uint)(select(((uint)_947 < (uint)170000), _947, 0)) + 0u))].BindlessParameters_PostProcessTransition._bottomVignettePower);
    _961 = WaveReadLaneFirst(_materialIndex);
    _969 = WaveReadLaneFirst(BindlessParameters_PostProcessTransition[((int)((uint)(select(((uint)_961 < (uint)170000), _961, 0)) + 0u))].BindlessParameters_PostProcessTransition._bottomVignetteColor);
    _972 = (float)((uint)((uint)(((uint)(_969) >> 16) & 255)));
    _975 = (float)((uint)((uint)(((uint)(_969) >> 8) & 255)));
    _977 = (float)((uint)((uint)(_969 & 255)));
    _1007 = max(0.0010000000474974513f, _exposure0.x);
    _1011 = saturate((pow(TEXCOORD.y, _955)) * (sqrt((_930 * _930) + (_929 * _929)) / max(0.0010000000474974513f, (1.0f - _943)))) * _733;
    _1019 = (((select(((_972 * 0.003921568859368563f) < 0.040449999272823334f), (_972 * 0.0003035269910469651f), exp2(log2((_972 * 0.0037171270232647657f) + 0.052132703363895416f) * 2.4000000953674316f)) / _1007) * _1011) + _924);
    _1020 = (((select(((_975 * 0.003921568859368563f) < 0.040449999272823334f), (_975 * 0.0003035269910469651f), exp2(log2((_975 * 0.0037171270232647657f) + 0.052132703363895416f) * 2.4000000953674316f)) / _1007) * _1011) + _925);
    _1021 = (((select(((_977 * 0.003921568859368563f) < 0.040449999272823334f), (_977 * 0.0003035269910469651f), exp2(log2((_977 * 0.0037171270232647657f) + 0.052132703363895416f) * 2.4000000953674316f)) / _1007) * _1011) + _926);
  } else {
    _1019 = _924;
    _1020 = _925;
    _1021 = _926;
  ...
  _1030 = WaveReadLaneFirst(BindlessParameters_PostProcessTransition[((int)((uint)(select(((uint)_1022 < (uint)170000), _1022, 0)) + 0u))].BindlessParameters_PostProcessTransition._chapterTransition);
  if ((_1030 >= 0.0010000000474974513f) && (_1030 < 1.0f)) {
    _1035 = _1030 * 2.0f;
    _1036 = (_1035 > 1.0f);
    _1038 = select(_1036, (_1035 + -1.0f), _1035);
    _1039 = WaveReadLaneFirst(_materialIndex);
    _1047 = WaveReadLaneFirst(BindlessParameters_PostProcessTransition[((int)((uint)(select(((uint)_1039 < (uint)170000), _1039, 0)) + 0u))].BindlessParameters_PostProcessTransition._chapterTransitionNoiseTex);
    _1056 = (((float4)(__0__7__0__0__g_bindlessTextures[((int)((uint)(select(((uint)_1047 < (uint)65000), _1047, 0)) + 0u))].Sample(__0__4__0__0__g_staticBilinearWrap, float2(TEXCOORD.x, TEXCOORD.y)))).x) * 0.20000000298023224f;
  // [sem: _3__36__0__0__g_postProcessSizeColor_sample]
    ...
    _1069 = (pow(_1059.x, 0.012683313339948654f));  // [sem: _3__36__0__0__g_postProcessSizeColor_sample_derived]
    _1070 = (pow(_1059.y, 0.012683313339948654f));  // [sem: _3__36__0__0__g_postProcessSizeColor_sample_derived]
    _1071 = (pow(_1059.z, 0.012683313339948654f));  // [sem: _3__36__0__0__g_postProcessSizeColor_sample_derived]
    _1096 = exp2(log2(max(0.0f, (_1069 + -0.8359375f)) / (18.8515625f - (_1069 * 18.6875f))) * 6.277394771575928f) * 10000.0f;
    _1097 = exp2(log2(max(0.0f, (_1070 + -0.8359375f)) / (18.8515625f - (_1070 * 18.6875f))) * 6.277394771575928f) * 10000.0f;
    _1098 = exp2(log2(max(0.0f, (_1071 + -0.8359375f)) / (18.8515625f - (_1071 * 18.6875f))) * 6.277394771575928f) * 10000.0f;
    _1099 = WaveReadLaneFirst(_materialIndex);
    _1107 = WaveReadLaneFirst(BindlessParameters_PostProcessTransition[((int)((uint)(select(((uint)_1099 < (uint)170000), _1099, 0)) + 0u))].BindlessParameters_PostProcessTransition._chapterTransitionUseDivide);
    _1110 = (_1038 + -0.5f) * 1.5f;
    _1112 = _1056 + (TEXCOORD.x - _1110);
    _1117 = select((_1038 >= 0.8999999761581421f), ((_1038 + -0.8999999761581421f) * 10.0f), 0.0f);
    if (!(_1107 == 0.0f)) {
      _1122 = TEXCOORD.y + 0.44999998807907104f;
      _1123 = TEXCOORD.y + -0.44999998807907104f;
      _1132 = WaveReadLaneFirst(_materialIndex);
      _1140 = WaveReadLaneFirst(BindlessParameters_PostProcessTransition[((int)((uint)(select(((uint)_1132 < (uint)170000), _1132, 0)) + 0u))].BindlessParameters_PostProcessTransition._chapterTransitionTex);
      _1149 = WaveReadLaneFirst(_materialIndex);
      _1157 = WaveReadLaneFirst(BindlessParameters_PostProcessTransition[((int)((uint)(select(((uint)_1149 < (uint)170000), _1149, 0)) + 0u))].BindlessParameters_PostProcessTransition._chapterTransitionTex);
  // [sem: expr_sat]
      _1167 = saturate(((((float4)(__0__7__0__0__g_bindlessTextures[((int)((uint)(select(((uint)_1157 < (uint)65000), _1157, 0)) + 0u))].Sample(__0__4__0__0__g_staticBilinearClamp, float2((((1.0f - TEXCOORD.x) - _1110) + _1056), _1123)))).x) * select(((_1123 < 0.0f) || (_1123 > 1.0f)), 0.0f, 1.0f)) + ((((float4)(__0__7__0__0__g_bindlessTextures[((int)((uint)(select(((uint)_1140 < (uint)65000), _1140, 0)) + 0u))].Sample(__0__4__0__0__g_staticBilinearClamp, float2(_1112, _1122)))).x) * select(((_1122 < 0.0f) || (_1122 > 1.0f)), 0.0f, 1.0f)));
      ...
      _1202 = WaveReadLaneFirst(BindlessParameters_PostProcessTransition[((int)((uint)(select(((uint)_1194 < (uint)170000), _1194, 0)) + 0u))].BindlessParameters_PostProcessTransition._chapterTransitionTex);
      _1208 = __0__7__0__0__g_bindlessTextures[((int)((uint)(select(((uint)_1202 < (uint)65000), _1202, 0)) + 0u))].Sample(__0__4__0__0__g_staticBilinearClamp, float2(_1112, ((TEXCOORD.y * 0.949999988079071f) + 0.02500000037252903f)));
  ...
  if (_1253) {
    ...
    if (_etcParams.z == 0.0f) {
      ...
      _1595 = 2.200000047683716f / ((min(max(_userImageAdjust.w, -1.0f), 1.0f) * 0.800000011920929f) + 2.200000047683716f);
  ...
  if (_1253 && (_etcParams.z > 0.0f)) {
    ...
    _1660 = select((_1628 <= 0.0031308000907301903f), (_1628 * 12.920000076293945f), (((pow(_1628, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f));
    _1661 = select((_1629 <= 0.0031308000907301903f), (_1629 * 12.920000076293945f), (((pow(_1629, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f));
  } else {
    _1659 = _1627;
    _1660 = _1628;
    _1661 = _1629;
  ...
  _1687 = exp2(log2(_1675 * 9.999999747378752e-05f) * 0.1593017578125f);
  _1688 = exp2(log2(_1676 * 9.999999747378752e-05f) * 0.1593017578125f);
  _1689 = exp2(log2(_1677 * 9.999999747378752e-05f) * 0.1593017578125f);
  SV_Target.x = exp2(log2((1.0f / ((_1687 * 18.6875f) + 1.0f)) * ((_1687 * 18.8515625f) + 0.8359375f)) * 78.84375f);
  SV_Target.y = exp2(log2((1.0f / ((_1688 * 18.6875f) + 1.0f)) * ((_1688 * 18.8515625f) + 0.8359375f)) * 78.84375f);
  SV_Target.z = exp2(log2((1.0f / ((_1689 * 18.6875f) + 1.0f)) * ((_1689 * 18.8515625f) + 0.8359375f)) * 78.84375f);
  SV_Target.w = _1250;
  return SV_Target;
}
