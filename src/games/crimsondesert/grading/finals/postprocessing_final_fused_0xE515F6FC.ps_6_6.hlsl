...
float4 main(
  ...
  _206 = (_201 * saturate(_rndx_tonemapped_color.x)) + _205;
  _207 = (_201 * saturate(_rndx_tonemapped_color.y)) + _205;
  _208 = (_201 * saturate(_rndx_tonemapped_color.z)) + _205;
  ...
  _239 = (pow(_230, 0.012683313339948654f));
  _240 = (pow(_231, 0.012683313339948654f));
  _241 = (pow(_232, 0.012683313339948654f));
  _267 = (TEXCOORD.x * 2.0f) + -1.0f;
  _268 = TEXCOORD.y * 2.0f;
  _269 = 1.0f - _268;
  _297 = mad((_projToPrevProj[2].w), 1.0000000116860974e-07f, mad((_projToPrevProj[1].w), _269, ((_projToPrevProj[0].w) * _267))) + (_projToPrevProj[3].w);
  _300 = ((mad((_projToPrevProj[2].x), 1.0000000116860974e-07f, mad((_projToPrevProj[1].x), _269, ((_projToPrevProj[0].x) * _267))) + (_projToPrevProj[3].x)) / _297) - _267;
  _301 = ((mad((_projToPrevProj[2].y), 1.0000000116860974e-07f, mad((_projToPrevProj[1].y), _269, ((_projToPrevProj[0].y) * _267))) + (_projToPrevProj[3].y)) / _297) - _269;
  ...
  _318 = abs(_267);
  _319 = abs(_268 + -1.0f);
  _323 = saturate(1.0f - ((_315 * _postProcessParams.x * CUSTOM_VIGNETTE) * dot(float2(_318, _319), float2(_318, _319))));  // [sem: expr_sat]
  _333 = exp2(log2(_323 * exp2(log2(max(0.0f, (_239 + -0.8359375f)) / (18.8515625f - (_239 * 18.6875f))) * 6.277394771575928f)) * 0.1593017578125f);
  _334 = exp2(log2(_323 * exp2(log2(max(0.0f, (_240 + -0.8359375f)) / (18.8515625f - (_240 * 18.6875f))) * 6.277394771575928f)) * 0.1593017578125f);
  _335 = exp2(log2(_323 * exp2(log2(max(0.0f, (_241 + -0.8359375f)) / (18.8515625f - (_241 * 18.6875f))) * 6.277394771575928f)) * 0.1593017578125f);
  if (!(SV_Position.y < _viewDir.w)) {
    if (!(SV_Position.y >= (_screenSizeAndInvSize.y - _viewDir.w))) {
      _373 = exp2(log2((1.0f / ((_333 * 18.6875f) + 1.0f)) * ((_333 * 18.8515625f) + 0.8359375f)) * 78.84375f);
      _374 = exp2(log2((1.0f / ((_334 * 18.6875f) + 1.0f)) * ((_334 * 18.8515625f) + 0.8359375f)) * 78.84375f);
      _375 = exp2(log2((1.0f / ((_335 * 18.6875f) + 1.0f)) * ((_335 * 18.8515625f) + 0.8359375f)) * 78.84375f);
    } else {
      _373 = 0.0f;
      _374 = 0.0f;
      _375 = 0.0f;
