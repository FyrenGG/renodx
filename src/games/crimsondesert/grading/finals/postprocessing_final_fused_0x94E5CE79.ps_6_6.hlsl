...
float4 main(
  ...
  _193 = saturate(_etcParams.w);
  _217 = (_192 * saturate(_rndx_tonemapped_color.x)) + _193;
  _209 = (_192 * saturate(_rndx_tonemapped_color.y)) + _193;
  _201 = (_192 * saturate(_rndx_tonemapped_color.z)) + _193;
  ...
  _318 = saturate(1.0f - ((_309 * _postProcessParams.x * CUSTOM_VIGNETTE) * dot(float2(_310, _312), float2(_310, _312))));  // [sem: expr_sat]
