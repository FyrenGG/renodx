...
float4 main(
  ...
  _255 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)(select(((uint)_247 < (uint)170000), _247, 0)) + 0u))].BindlessParameters_PostProcessUber_CD._noiseTex);
  [branch]
  if (!(!(_fleeCount >= 0.0010000000474974513f))) {
    _279 = __0__7__0__0__g_bindlessTextures[((int)((uint)(select(((uint)_255 < (uint)65000), _255, 0)) + 0u))].Sample(__0__4__0__0__g_staticBilinearWrap, float2((TEXCOORD.x * 4.0f), ((((_fleeCount * 0.0010000000474974513f) + -0.10000000149011612f) + ((TEXCOORD.y / _36) * 4.0f)) + (_time.x * 0.019999999552965164f))));
    _288 = (TEXCOORD.x + -0.5f) + ((_279.x + -0.5f) * 0.15000000596046448f);
    _289 = (TEXCOORD.y + -0.5f) + ((_279.y + -0.5f) * 0.15000000596046448f);
  // [sem: expr_sat]
    _302 = saturate(_fleeCount * 0.20000000298023224f) * saturate((((_fleeCount * 0.004999999888241291f) + -0.6000000238418579f) + sqrt((_288 * _288) + (_289 * _289))) / ((_fleeCount * 0.004000000189989805f) + 0.10000000149011612f));
  ...
  _321 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)(select(((uint)_313 < (uint)170000), _313, 0)) + 0u))].BindlessParameters_PostProcessUber_CD._uiMainMenuEffect);
  if ((_227 >= 0.0010000000474974513f) || (_321 >= 0.0010000000474974513f)) {
    _326 = WaveReadLaneFirst(_materialIndex);
    _334 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)(select(((uint)_326 < (uint)170000), _326, 0)) + 0u))].BindlessParameters_PostProcessUber_CD._uiMainMenuEffect);
    if (_334 > _227) {
      _337 = WaveReadLaneFirst(_materialIndex);
      _345 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)(select(((uint)_337 < (uint)170000), _337, 0)) + 0u))].BindlessParameters_PostProcessUber_CD._uiMainMenuEffect);
      _347 = _345;
    } else {
      _347 = _227;
    }
    _355 = _347 * 0.5f;
    _379 = __0__7__0__0__g_bindlessTextures[((int)((uint)(select(((uint)_255 < (uint)65000), _255, 0)) + 0u))].Sample(__0__4__0__0__g_staticBilinearWrap, float2(((TEXCOORD.x * 2.0f) * _36), (TEXCOORD.y * 2.0f)));
    _384 = WaveReadLaneFirst(_materialIndex);
    _392 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)(select(((uint)_384 < (uint)170000), _384, 0)) + 0u))].BindlessParameters_PostProcessUber_CD._uiMainMenuEffect);
    _394 = (_227 < 0.0010000000474974513f);
    _395 = _394 && (_392 >= 0.0010000000474974513f);
    _397 = WaveReadLaneFirst(_materialIndex);
    _405 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)(select(((uint)_397 < (uint)170000), _397, 0)) + 0u))].BindlessParameters_PostProcessUber_CD._uiMainMenuEffect);
    _415 = (TEXCOORD.y - select(_395, 0.550000011920929f, 0.5f)) - ((_379.y + -0.5f) * 0.05000000074505806f);
    _416 = ((TEXCOORD.x - ((_379.x + -0.5f) * 0.05000000074505806f)) + select(_395, -0.41999998688697815f, -0.5f)) * _36;
    _427 = ((_347 * -0.8999999761581421f) * (1.0f - saturate((select((_394 && (_405 >= 0.0010000000474974513f)), 0.3499999940395355f, 0.4000000059604645f) - sqrt((_416 * _416) + (_415 * _415))) * 1.4285714626312256f))) + 1.0f;
  ...
  if (((_50 >= 0.0010000000474974513f) && (_81 >= 0.0010000000474974513f)) | ((_59 >= 0.0010000000474974513f) && (_94 >= 0.0010000000474974513f)) | ((_68 >= 0.0010000000474974513f) && (_107 >= 0.0010000000474974513f))) {
    ...
    _450 = _240 + -0.5f;
  // [sem: invLength]
    _459 = rsqrt(dot(float2(_449, _450), float2(_449, _450))) * ((max(max(_81, _94), _107) * 0.009999999776482582f) * sqrt((_450 * _450) + (_449 * _449)));
    _460 = _459 * _449;
    _462 = _459 * _450;
  ...
  if ((_120 >= 0.0010000000474974513f) && (_129 >= 0.0010000000474974513f)) {
    ...
    _491 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)(select(((uint)_482 < (uint)170000), _482, 0)) + 0u))].BindlessParameters_PostProcessUber_CD._chromaticAberrationShiftPosition.x);
    _492 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)(select(((uint)_482 < (uint)170000), _482, 0)) + 0u))].BindlessParameters_PostProcessUber_CD._chromaticAberrationShiftPosition.y);
    _493 = _239 - _491;
    _494 = _240 - _492;
  // [sem: invLength]
    _503 = rsqrt(dot(float2(_493, _494), float2(_493, _494))) * ((_129 * 0.009999999776482582f) * sqrt((_494 * _494) + (_493 * _493)));
    _504 = _503 * _493;
    _506 = _503 * _494;
  ...
  _539 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)(select(((uint)_531 < (uint)170000), _531, 0)) + 0u))].BindlessParameters_PostProcessUber_CD._detectModeG);
  _540 = WaveReadLaneFirst(_materialIndex);
  _548 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)(select(((uint)_540 < (uint)170000), _540, 0)) + 0u))].BindlessParameters_PostProcessUber_CD._detectModeR);
  _549 = WaveReadLaneFirst(_materialIndex);
  _557 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)(select(((uint)_549 < (uint)170000), _549, 0)) + 0u))].BindlessParameters_PostProcessUber_CD._detectModeB);
  _558 = WaveReadLaneFirst(_materialIndex);
  _566 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)(select(((uint)_558 < (uint)170000), _558, 0)) + 0u))].BindlessParameters_PostProcessUber_CD._detectModeKnowledge);
  _567 = WaveReadLaneFirst(_materialIndex);
  _575 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)(select(((uint)_567 < (uint)170000), _567, 0)) + 0u))].BindlessParameters_PostProcessUber_CD._detectModeInterrupt);
  ...
  if (_580 > 0.0f) {
    ...
    _598 = (_575 >= 0.0010000000474974513f);
    _602 = select(_598, 0.800000011920929f, _595);
    _603 = select(_598, 0.6000000238418579f, _596);
    _604 = select(_598, 0.20000000298023224f, _597);
    _611 = (1.0f - _602) * 0.3086000084877014f;
    _613 = (1.0f - _603) * 0.6093999743461609f;
    _615 = (1.0f - _604) * 0.0820000022649765f;
    _617 = select(_598, 2.0f, _592) * _528;
    _618 = select(_598, 2.0f, _593) * _529;
    _619 = select(_598, 2.0f, _594) * _530;
    _623 = _611 * _617;
    _628 = 0.009999999776482582f / max(0.0010000000474974513f, _exposure0.x);
    _638 = max((abs(TEXCOORD.x + -0.5f) + -0.07500000298023224f), 0.0f);
    _639 = max((abs(TEXCOORD.y + -0.5f) + -0.07500000298023224f), 0.0f);
  ...
  // [sem: _3__36__0__0__g_CustomRenderPassValue_load]
    ...
    _710 = (((float)((uint)((uint)((uint)((uint)(_700.x)) >> 20)))) * 0.0004884005174972117f) + -1.0f;  // [sem: _3__36__0__0__g_CustomRenderPassValue_load_derived]
    _711 = (((float)((uint)((uint)(((uint)((uint)(_700.x)) >> 8) & 4095)))) * 0.0004884005174972117f) + -1.0f;  // [sem: _3__36__0__0__g_CustomRenderPassValue_load_derived]
    _713 = 1.0f - abs(_710);
    _714 = abs(_711);
    _715 = _713 - _714;
    if (!(_715 >= 0.0f)) {
    ...
    if (_702 == _renderPassTest) {
      ...
      _761 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)(select(((uint)_753 < (uint)170000), _753, 0)) + 0u))].BindlessParameters_PostProcessUber_CD._testEffectRatio);
      _762 = _761 * (1.0f / max(0.0010000000474974513f, _exposure0.x));
      _963 = (_762 + _667);
      _964 = _668;
      _965 = (_762 + _669);
      _966 = _702;
      ...
      if ((_702 == _renderPassDetectObjective) || ((!(_702 == _renderPassDetectObjective)) && (_702 == _renderPassKnowledgeNPC))) {
        ...
        if (!(_702 == _renderPassDetectRemoteCatch)) {
          ...
          _813 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)(select(((uint)_805 < (uint)170000), _805, 0)) + 0u))].BindlessParameters_PostProcessUber_CD._itemRatio);
          if (!(_813 > 0.0010000000474974513f)) {
            __branch_chain_801 = true;
          } else {
        ...
        if (__branch_chain_801) {
          ...
          if ((_885) | ((_702 == _renderPassTest) || (_702 == _renderPassEnemy)) | (_702 == _renderPassDetectPickedRemoteCatch)) {
            if ((_characterHighlight > 0.0010000000474974513f) || (_highLightForVisionRemoteCatch > 0.0010000000474974513f)) {
              ...
              _937 = 1.0f / max(0.0010000000474974513f, _exposure0.x);
          ...
          _831 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)(select(((uint)_823 < (uint)170000), _823, 0)) + 0u))].BindlessParameters_PostProcessUber_CD._detectColorBase);
          _834 = (float)((uint)((uint)(((uint)(_831) >> 16) & 255)));
          _837 = (float)((uint)((uint)(((uint)(_831) >> 8) & 255)));
          _839 = (float)((uint)((uint)(_831 & 255)));
          _872 = max(0.0010000000474974513f, _exposure0.x);
  ...
  if (!(!(_wantedRegionRatio >= 0.0010000000474974513f))) {
    ...
    if (!(!(_wantedRegionOpacity >= 0.0010000000474974513f))) {
      ...
      _983 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)(select(((uint)_975 < (uint)170000), _975, 0)) + 0u))].BindlessParameters_PostProcessUber_CD._wantedRegionColor);
      _986 = (float)((uint)((uint)(((uint)(_983) >> 16) & 255)));
      _989 = (float)((uint)((uint)(((uint)(_983) >> 8) & 255)));
      _991 = (float)((uint)((uint)(_983 & 255)));
      _1024 = max(0.0010000000474974513f, _exposure0.x);
      _1032 = _wantedRegionRadius * _wantedRegionRatio;
      _1034 = saturate(_1032) * 4.0f;
      _1040 = (_239 * 2.0f) + -1.0f;
      _1042 = 1.0f - (_240 * 2.0f);
      _1043 = max(1.0000000116860974e-07f, ((__3__36__0__0__g_depth.Sample(__0__4__0__0__g_staticBilinearClamp, float2(_239, _240))).x));
      _1071 = mad((_invViewProj[2].w), _1043, mad((_invViewProj[1].w), _1042, ((_invViewProj[0].w) * _1040))) + (_invViewProj[3].w);
      _1077 = ((mad((_invViewProj[2].x), _1043, mad((_invViewProj[1].x), _1042, ((_invViewProj[0].x) * _1040))) + (_invViewProj[3].x)) / _1071) - _wantedRegionPosition.x;
      _1078 = ((mad((_invViewProj[2].z), _1043, mad((_invViewProj[1].z), _1042, ((_invViewProj[0].z) * _1040))) + (_invViewProj[3].z)) / _1071) - _wantedRegionPosition.z;
      ...
      _1132 = (((((float)((uint)((uint)((uint)(_983) >> 24)))) * 0.003921568859368563f) * _wantedRegionOpacity) * _1102) * ((float)((bool)(uint)((uint)(((((uint2)(__3__36__0__0__g_stencil.Load(int3((int)(uint((_bufferSizeAndInvSize.x * _239) + -0.5f)), (int)(uint((_bufferSizeAndInvSize.y * _240) + -0.5f)), 0)))).x) & 127) + -53) > (uint)14)));
  ...
  if (((_temperatureWarning <= -0.009999999776482582f) || (_temperatureWarning >= 0.009999999776482582f)) || (_electrocutionWarning > 0.0010000000474974513f)) {
    ...
    _1163 = _temperatureWarning * 0.009999999776482582f;
    if (_temperatureWarning > 0.0f) {
      _1166 = saturate(saturate(_1163));  // [sem: expr_sat]
      _1167 = TEXCOORD.x + -0.5f;
      _1168 = TEXCOORD.y + -0.6000000238418579f;
      _1176 = saturate((_1166 + -0.5f) + sqrt((_1168 * _1168) + (_1167 * _1167))) * _1166;
      _1181 = (1.0f - (_1176 * 0.30000001192092896f)) * _1144;
      _1182 = (1.0f - (_1176 * 0.699999988079071f)) * _1145;
      ...
      _1209 = ((_1197 * (_1157.y - (_1144 * 0.10000002384185791f))) + _1144);  // [sem: blended]
      _1210 = ((_1197 * _1157.z) + _1145);  // [sem: blended]
    }
    _1211 = _1143 + _1208;
    if (!(_electrocutionWarning == 0.0f)) {
      _1217 = max(0.0010000000474974513f, _exposure0.x);
      _1221 = TEXCOORD.x + -0.5f;
      _1222 = TEXCOORD.y + -0.6000000238418579f;
      _1230 = (_electrocutionWarning * 0.5f) * saturate(sqrt((_1222 * _1222) + (_1221 * _1221)) + -0.30000001192092896f);
      _1237 = (_1230 * ((0.05000000074505806f / _1217) - _1211)) + _1211;
      _1238 = (_1230 * ((0.10000000149011612f / _1217) - _1209)) + _1209;
  ...
  if (!(!(_hpPercentage <= 20.0f))) {
    _1258 = 1.0f - (_hpPercentage * 0.009999999776482582f);
    if ((!(_hpPercentage <= 0.0f)) && (_1258 >= 0.0010000000474974513f)) {
      _1273 = _time.x * 0.30000001192092896f;
      _1284 = (((float4)(__0__7__0__0__g_bindlessTextures[((int)((uint)(select(((uint)_255 < (uint)65000), _255, 0)) + 0u))].Sample(__0__4__0__0__g_staticBilinearWrap, float2((_1273 + (TEXCOORD.x * 12.0f)), (_1273 + (TEXCOORD.y * 6.0f)))))).w) * 0.10000000149011612f;
      _1287 = WaveReadLaneFirst(_materialIndex);
      _1295 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)(select(((uint)_1287 < (uint)170000), _1287, 0)) + 0u))].BindlessParameters_PostProcessUber_CD._borderEdgeNoiseTexture);
      _1309 = (_hpPercentage * 0.0020000000949949026f) + 0.36000001430511475f;
      _1312 = max((abs(TEXCOORD.x + -0.5f) - _1309), 0.0f);
      _1313 = max((abs(TEXCOORD.y + -0.5f) - _1309), 0.0f);
      _1325 = sin(frac(_time.x * (2.0f - (_hpPercentage * 0.05000000074505806f))) * 3.1415927410125732f);
      _1337 = 1.0f - _240;
      ...
      _1351 = (_1341 * 0.0112674031406641f) + 0.022386489436030388f;
      _1360 = 1.0f / max(0.0010000000474974513f, _exposure0.x);
      _1362 = select(_1349, 0.006995410192757845f, 0.04317210242152214f) * _1360;
      _1366 = (min(max(_1258, 0.0f), 1.0f) * saturate((saturate(((_1325 * 0.19999998807907104f) + 0.800000011920929f) * saturate(sqrt((_1313 * _1313) + (_1312 * _1312)) * 3.846153974533081f)) * 2.0f) - ((((float4)(__0__7__0__0__g_bindlessTextures[((int)((uint)(select(((uint)_1295 < (uint)65000), _1295, 0)) + 0u))].Sample(__0__4__0__0__g_staticBilinearWrap, float2((((TEXCOORD.x * 2.0f) + 0.30000001192092896f) + _1284), (_1284 + TEXCOORD.y))))).x) * 1.440000057220459f))) * _1340;
      _1367 = _1340 * (0.12999999523162842f - (_hpPercentage * 0.006000000052154064f));
      _1374 = (((select(_1349, 0.215860515832901f, 0.04317210242152214f) * _1360) - _1250) * _1367) + _1250;
  ...
  _1400 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)(select(((uint)_1390 < (uint)170000), _1390, 0)) + 0u))].BindlessParameters_PostProcessUber_CD._channelBrightness.x);
  _1401 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)(select(((uint)_1390 < (uint)170000), _1390, 0)) + 0u))].BindlessParameters_PostProcessUber_CD._channelBrightness.y);
  _1402 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)(select(((uint)_1390 < (uint)170000), _1390, 0)) + 0u))].BindlessParameters_PostProcessUber_CD._channelBrightness.z);
  _1403 = WaveReadLaneFirst(_materialIndex);
  _1413 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)(select(((uint)_1403 < (uint)170000), _1403, 0)) + 0u))].BindlessParameters_PostProcessUber_CD._saturation.x);
  _1414 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)(select(((uint)_1403 < (uint)170000), _1403, 0)) + 0u))].BindlessParameters_PostProcessUber_CD._saturation.y);
  _1415 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)(select(((uint)_1403 < (uint)170000), _1403, 0)) + 0u))].BindlessParameters_PostProcessUber_CD._saturation.z);
  _1416 = WaveReadLaneFirst(_materialIndex);
  _1424 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)(select(((uint)_1416 < (uint)170000), _1416, 0)) + 0u))].BindlessParameters_PostProcessUber_CD._contrast);
  _1429 = (_138 > 0.0010000000474974513f);
  if (_1429 && ((_isPhotosensitiveMode_isAllolwBlood & 1) == 0)) {
    _1436 = (_1400 > (_1401 + 0.05000000074505806f)) && (_1400 > (_1402 + 0.05000000074505806f));
    _1437 = _1400 * 0.4000000059604645f;
    _1445 = (_1413 > (_1414 + 0.05000000074505806f)) && (_1413 > (_1415 + 0.05000000074505806f));
    _1446 = _1413 * 0.4000000059604645f;
  ...
  _1458 = _1452 * _1388;
  _1459 = _1453 * _1389;
  _1463 = (1.0f - _1454) * 0.3086000084877014f;
  _1465 = (1.0f - _1455) * 0.6093999743461609f;
  _1467 = (1.0f - _1456) * 0.0820000022649765f;
  _1472 = _1463 * _1457;
  ...
  _1507 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)(select(((uint)_1499 < (uint)170000), _1499, 0)) + 0u))].BindlessParameters_PostProcessUber_CD._invertColor);
  ...
  _1531 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)(select(((uint)_1523 < (uint)170000), _1523, 0)) + 0u))].BindlessParameters_PostProcessUber_CD._borderRatio);
  [branch]
  if (!(!(_1531 >= 0.0010000000474974513f))) {
    _1534 = WaveReadLaneFirst(_materialIndex);
    _1543 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)(select(((uint)_1534 < (uint)170000), _1534, 0)) + 0u))].BindlessParameters_PostProcessUber_CD._borderEdgeNoiseTile.x);
    _1544 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)(select(((uint)_1534 < (uint)170000), _1534, 0)) + 0u))].BindlessParameters_PostProcessUber_CD._borderEdgeNoiseTile.y);
    _1547 = WaveReadLaneFirst(_materialIndex);
    _1556 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)(select(((uint)_1547 < (uint)170000), _1547, 0)) + 0u))].BindlessParameters_PostProcessUber_CD._borderEdgeNoiseOffset.x);
    _1557 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)(select(((uint)_1547 < (uint)170000), _1547, 0)) + 0u))].BindlessParameters_PostProcessUber_CD._borderEdgeNoiseOffset.y);
    _1560 = WaveReadLaneFirst(_materialIndex);
    _1568 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)(select(((uint)_1560 < (uint)170000), _1560, 0)) + 0u))].BindlessParameters_PostProcessUber_CD._borderEdgeNoiseTexture);
    _1577 = WaveReadLaneFirst(_materialIndex);
    _1585 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)(select(((uint)_1577 < (uint)170000), _1577, 0)) + 0u))].BindlessParameters_PostProcessUber_CD._borderSmoothness);
    _1586 = WaveReadLaneFirst(_materialIndex);
    _1594 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)(select(((uint)_1586 < (uint)170000), _1586, 0)) + 0u))].BindlessParameters_PostProcessUber_CD._borderWidth);
    ...
    _1622 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)(select(((uint)_1614 < (uint)170000), _1614, 0)) + 0u))].BindlessParameters_PostProcessUber_CD._borderFlickerSpeed);
    if (_1622 > 0.0010000000474974513f) {
      _1625 = WaveReadLaneFirst(_materialIndex);
      _1634 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)(select(((uint)_1625 < (uint)170000), _1625, 0)) + 0u))].BindlessParameters_PostProcessUber_CD._borderFlickerOpacityMinMax.x);
      _1635 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)(select(((uint)_1625 < (uint)170000), _1625, 0)) + 0u))].BindlessParameters_PostProcessUber_CD._borderFlickerOpacityMinMax.y);
      _1643 = WaveReadLaneFirst(_materialIndex);
      _1651 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)(select(((uint)_1643 < (uint)170000), _1643, 0)) + 0u))].BindlessParameters_PostProcessUber_CD._borderFlickerIntensity);
      _1655 = ((min(max(sin((_1622 * 3.1415927410125732f) * _time.x), _1634), _1635) * _1613) * _1651);
    } else {
      _1655 = _1613;
    }
    _1657 = WaveReadLaneFirst(_materialIndex);
    _1665 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)(select(((uint)_1657 < (uint)170000), _1657, 0)) + 0u))].BindlessParameters_PostProcessUber_CD._borderEdgeNoiseRatio);
    _1671 = min(max(_1531, 0.0f), 1.0f) * saturate(saturate(_1655) - (_1665 * (((float4)(__0__7__0__0__g_bindlessTextures[((int)((uint)(select(((uint)_1568 < (uint)65000), _1568, 0)) + 0u))].Sample(__0__4__0__0__g_staticBilinearWrap, float2((_1556 + (_1543 * TEXCOORD.x)), (_1557 + (_1544 * TEXCOORD.y)))))).x)));
    _1672 = WaveReadLaneFirst(_materialIndex);
    _1680 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)(select(((uint)_1672 < (uint)170000), _1672, 0)) + 0u))].BindlessParameters_PostProcessUber_CD._borderColor);
    _1683 = (float)((uint)((uint)(((uint)(_1680) >> 16) & 255)));
    _1686 = (float)((uint)((uint)(((uint)(_1680) >> 8) & 255)));
    _1688 = (float)((uint)((uint)(_1680 & 255)));
    _1713 = select(((_1683 * 0.003921568859368563f) < 0.040449999272823334f), (_1683 * 0.0003035269910469651f), exp2(log2((_1683 * 0.0037171270232647657f) + 0.052132703363895416f) * 2.4000000953674316f));
    _1720 = _1429 && ((_isPhotosensitiveMode_isAllolwBlood & 1) == 0);
    _1721 = _1713 * 0.4000000059604645f;
    _1728 = 1.0f / max(0.0010000000474974513f, _exposure0.x);
  ...
  if (!(!(_59 >= 0.0010000000474974513f))) {
    ...
    _1761 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)(select(((uint)_1753 < (uint)170000), _1753, 0)) + 0u))].BindlessParameters_PostProcessUber_CD._statusVignetteRadius2);
    _1767 = WaveReadLaneFirst(_materialIndex);
    _1775 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)(select(((uint)_1767 < (uint)170000), _1767, 0)) + 0u))].BindlessParameters_PostProcessUber_CD._statusVignettePower2);
  // [sem: expr_sat]
    _1780 = saturate(exp2(log2(abs(0.5f - TEXCOORD.x)) * _1775) * (sqrt((_1748 * _1748) + (_1747 * _1747)) / max(0.0010000000474974513f, (1.0f - _1761))));
    ...
    _1803 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)(select(((uint)_1795 < (uint)170000), _1795, 0)) + 0u))].BindlessParameters_PostProcessUber_CD._statusVignetteColor2);
    _1806 = (float)((uint)((uint)(((uint)(_1803) >> 16) & 255)));
    _1809 = (float)((uint)((uint)(((uint)(_1803) >> 8) & 255)));
    _1811 = (float)((uint)((uint)(_1803 & 255)));
    _1836 = select(((_1806 * 0.003921568859368563f) < 0.040449999272823334f), (_1806 * 0.0003035269910469651f), exp2(log2((_1806 * 0.0037171270232647657f) + 0.052132703363895416f) * 2.4000000953674316f));
    _1843 = _1429 && ((_isPhotosensitiveMode_isAllolwBlood & 1) == 0);
    _1844 = _1836 * 0.20000000298023224f;
    _1851 = max(0.0010000000474974513f, _exposure0.x);
  ...
  if (!(!(_50 >= 0.0010000000474974513f))) {
    ...
    _1885 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)(select(((uint)_1877 < (uint)170000), _1877, 0)) + 0u))].BindlessParameters_PostProcessUber_CD._statusVignetteRadius1);
    _1890 = WaveReadLaneFirst(_materialIndex);
    _1898 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)(select(((uint)_1890 < (uint)170000), _1890, 0)) + 0u))].BindlessParameters_PostProcessUber_CD._statusVignettePower1);
  // [sem: expr_sat]
    _1903 = saturate(exp2(log2(1.0f - TEXCOORD.y) * _1898) * (sqrt((_1872 * _1872) + (_1871 * _1871)) / max(0.0010000000474974513f, (1.0f - _1885))));
    ...
    _1924 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)(select(((uint)_1916 < (uint)170000), _1916, 0)) + 0u))].BindlessParameters_PostProcessUber_CD._statusVignetteColor1);
    _1927 = (float)((uint)((uint)(((uint)(_1924) >> 16) & 255)));
    _1930 = (float)((uint)((uint)(((uint)(_1924) >> 8) & 255)));
    _1932 = (float)((uint)((uint)(_1924 & 255)));
    _1957 = select(((_1927 * 0.003921568859368563f) < 0.040449999272823334f), (_1927 * 0.0003035269910469651f), exp2(log2((_1927 * 0.0037171270232647657f) + 0.052132703363895416f) * 2.4000000953674316f));
    _1964 = _1429 && ((_isPhotosensitiveMode_isAllolwBlood & 1) == 0);
    _1965 = _1957 * 0.20000000298023224f;
    _1972 = max(0.0010000000474974513f, _exposure0.x);
  ...
  if (!(!(_68 >= 0.0010000000474974513f))) {
    ...
    _2006 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)(select(((uint)_1998 < (uint)170000), _1998, 0)) + 0u))].BindlessParameters_PostProcessUber_CD._statusVignetteRadius3);
    _2010 = WaveReadLaneFirst(_materialIndex);
    _2018 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)(select(((uint)_2010 < (uint)170000), _2010, 0)) + 0u))].BindlessParameters_PostProcessUber_CD._statusVignettePower3);
  // [sem: expr_sat]
    _2023 = saturate((pow(TEXCOORD.y, _2018)) * (sqrt((_1993 * _1993) + (_1992 * _1992)) / max(0.0010000000474974513f, (1.0f - _2006))));
    ...
    _2044 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)(select(((uint)_2036 < (uint)170000), _2036, 0)) + 0u))].BindlessParameters_PostProcessUber_CD._statusVignetteColor3);
    _2047 = (float)((uint)((uint)(((uint)(_2044) >> 16) & 255)));
    _2050 = (float)((uint)((uint)(((uint)(_2044) >> 8) & 255)));
    _2052 = (float)((uint)((uint)(_2044 & 255)));
    _2077 = select(((_2047 * 0.003921568859368563f) < 0.040449999272823334f), (_2047 * 0.0003035269910469651f), exp2(log2((_2047 * 0.0037171270232647657f) + 0.052132703363895416f) * 2.4000000953674316f));
    _2084 = _1429 && ((_isPhotosensitiveMode_isAllolwBlood & 1) == 0);
    _2085 = _2077 * 0.20000000298023224f;
    _2092 = max(0.0010000000474974513f, _exposure0.x);
  ...
  if (!(!(_hideStateRatio >= 0.0010000000474974513f))) {
    ...
    _2140 = (((_2132 * _2132) * 0.8999999761581421f) * saturate(_hideStateRatio * 4.0f)) * (3.0f - (_2132 * 2.0f));
    _2143 = dot(float3(_2107, _2108, _2109), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f)) * (1.0f - _2114);
    _2146 = (pow(_2140, 0.5f));
    _2153 = ((_2143 - _2107) * _2146) + _2107;
    _2154 = ((_2143 - _2108) * _2146) + _2108;
    _2155 = ((_2143 - _2109) * _2146) + _2109;
    _2159 = 0.0010000000474974513f / max(0.0010000000474974513f, _exposure0.x);
  ...
  if (_followLearning > 0.0010000000474974513f) {
    ...
    _2185 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)(select(((uint)_2177 < (uint)170000), _2177, 0)) + 0u))].BindlessParameters_PostProcessUber_CD._followLearningColor);
    _2188 = (float)((uint)((uint)(((uint)(_2185) >> 16) & 255)));
    _2191 = (float)((uint)((uint)(((uint)(_2185) >> 8) & 255)));
    _2193 = (float)((uint)((uint)(_2185 & 255)));
    _2223 = max(0.0010000000474974513f, _exposure0.x);
    _2224 = select(((_2188 * 0.003921568859368563f) < 0.040449999272823334f), (_2188 * 0.0003035269910469651f), exp2(log2((_2188 * 0.0037171270232647657f) + 0.052132703363895416f) * 2.4000000953674316f)) / _2223;
    _2225 = select(((_2191 * 0.003921568859368563f) < 0.040449999272823334f), (_2191 * 0.0003035269910469651f), exp2(log2((_2191 * 0.0037171270232647657f) + 0.052132703363895416f) * 2.4000000953674316f)) / _2223;
    _2226 = select(((_2193 * 0.003921568859368563f) < 0.040449999272823334f), (_2193 * 0.0003035269910469651f), exp2(log2((_2193 * 0.0037171270232647657f) + 0.052132703363895416f) * 2.4000000953674316f)) / _2223;
    _2227 = WaveReadLaneFirst(_materialIndex);
    _2235 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)(select(((uint)_2227 < (uint)170000), _2227, 0)) + 0u))].BindlessParameters_PostProcessUber_CD._followLearningNoiseTex);
    _2246 = __0__7__0__0__g_bindlessTextures[((int)((uint)(select(((uint)_255 < (uint)65000), _255, 0)) + 0u))].Sample(__0__4__0__0__g_staticBilinearWrap, float2(_239, ((_time.x * 0.20000000298023224f) + _240)));
    ...
    _2259 = max(1.0000000116860974e-07f, _2253.x);  // [sem: _3__36__0__0__g_depth_sample_derived]
    _2295 = mad((_invViewProj[2].w), _2259, mad((_invViewProj[1].w), _2258, ((_invViewProj[0].w) * _2256))) + (_invViewProj[3].w);
    ...
    _2330 = (saturate(_2312.x * 1.0009784698486328f) * 2.0f) + -1.0f;  // [sem: _3__36__0__0__g_gbufferNormal_load_derived]
    _2331 = (saturate(_2312.y * 1.0009784698486328f) * 2.0f) + -1.0f;  // [sem: _3__36__0__0__g_gbufferNormal_load_derived]
    _2332 = (saturate(_2312.z * 1.0009784698486328f) * 2.0f) + -1.0f;  // [sem: _3__36__0__0__g_gbufferNormal_load_derived]
    _2334 = rsqrt(dot(float3(_2330, _2331, _2332), float3(_2330, _2331, _2332)));  // [sem: invLength]
    _2335 = _2334 * _2330;
    _2336 = _2334 * _2331;
    _2337 = _2332 * _2334;
    _2340 = (((float)((uint)((uint)(((uint)((uint)(_2309.w)) >> 8) & 255)))) * 0.007843137718737125f) + -1.0f;  // [sem: _3__36__0__0__g_gbufferBaseColor_load_derived]
    _2341 = (((float)((uint)((uint)(_2309.w & 255)))) * 0.007843137718737125f) + -1.0f;  // [sem: _3__36__0__0__g_gbufferBaseColor_load_derived]
    ...
    _2384 = _2381 * _2379;
    _2387 = _time.x * 0.5f;
    _2390 = (((mad((_invViewProj[2].z), _2259, mad((_invViewProj[1].z), _2258, ((_invViewProj[0].z) * _2256))) + (_invViewProj[3].z)) / _2295) - _2387) * 0.20000000298023224f;
    _2391 = (((mad((_invViewProj[2].y), _2259, mad((_invViewProj[1].y), _2258, ((_invViewProj[0].y) * _2256))) + (_invViewProj[3].y)) / _2295) - _2387) * 0.20000000298023224f;
    _2398 = __0__7__0__0__g_bindlessTextures[((int)((uint)(select(((uint)_2235 < (uint)65000), _2235, 0)) + 0u))].Sample(__0__4__0__0__g_staticBilinearWrap, float2(_2390, _2391));
    _2401 = (((mad((_invViewProj[2].x), _2259, mad((_invViewProj[1].x), _2258, ((_invViewProj[0].x) * _2256))) + (_invViewProj[3].x)) / _2295) - _2387) * 0.20000000298023224f;
    _2410 = (abs(_2383) * ((((float4)(__0__7__0__0__g_bindlessTextures[((int)((uint)(select(((uint)_2235 < (uint)65000), _2235, 0)) + 0u))].Sample(__0__4__0__0__g_staticBilinearWrap, float2(_2401, _2390)))).w) - _2398.w)) + _2398.w;
    _2413 = (((((float4)(__0__7__0__0__g_bindlessTextures[((int)((uint)(select(((uint)_2235 < (uint)65000), _2235, 0)) + 0u))].Sample(__0__4__0__0__g_staticBilinearWrap, float2(_2401, _2391)))).w) - _2410) * abs(_2384)) + _2410;
    _2414 = _2246.z + -0.5f;
    _2419 = _239 + -0.5f;
    _2421 = _240 + -0.5f;
    _2426 = 0.375f - (_2414 * 0.25f);
    _2429 = max((abs(((_2246.x + -0.5f) * 0.10000000149011612f) + _2419) - _2426), 0.0f);
    _2430 = max((abs(((_2246.y + -0.5f) * 0.10000000149011612f) + _2421) - _2426), 0.0f);
    ...
    _2466 = (_2421 < 0.0f);
    _2478 = _2413 * 0.5f;
    _2491 = __0__7__0__0__g_bindlessTextures[((int)((uint)(select(((uint)_2235 < (uint)65000), _2235, 0)) + 0u))].Sample(__0__4__0__0__g_staticBilinearWrap, float2(((((_2414 * -0.5f) - _2478) - (_time.x * 0.20000000298023224f)) + select((_2464 && _2465), 7.5f, select((_2464 && _2466), -7.5f, (select((_2463 && _2466), (_2460 + -3.1415927410125732f), select((_2463 && _2465), (_2460 + 3.1415927410125732f), _2460)) * 4.774648189544678f)))), (((((_2246.w + -0.5f) * -0.5f) - _2478) + (_2455 * 2.0f)) - (_time.x * 1.5f))));
    if (!(_966 == _renderPassSelfPlayer)) {
      _2526 = (_966 == _renderPassTest);
    } else {
      _2526 = true;
    }
    _2527 = !((1.0f - saturate(ceil(((_nearFarProj.x / max(1.0000000116860974e-07f, ((__3__36__0__0__g_depth.Sample(__0__4__0__0__g_staticBilinearClamp, float2(_239, _240))).x))) + 0.5f) - (_nearFarProj.x / max(1.0000000116860974e-07f, (((float4)(__3__36__0__0__g_CustomRenderPassDepth.Load(int3(int(_customRenderPassSizeInvSize.x * _239), int(_customRenderPassSizeInvSize.y * _240), 0)))).x)))))) == 0.0f);
    _2529 = _2527 || (!_2526);
    ...
    _2555 = _2529 && _2543;
    if (_2555) {
      _2562 = ((_followLearning * 0.25f) * _2491.w) * saturate(_2455 - (_2545 * 0.20000000298023224f));
  // [sem: _3__36__0__0__g_sceneColor_sample]
      ...
      if (_2529) {
        ...
        _2591 = _2553;
        _2592 = _2554;
        _2593 = (_2458 * 0.4000000059604645f);
      }
    }
    _2594 = dot(float3(_2590, _2591, _2592), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f));
    _2601 = ((_2594 - _2590) * _2593) + _2590;
    _2602 = ((_2594 - _2591) * _2593) + _2591;
    _2603 = ((_2594 - _2592) * _2593) + _2592;
    _2605 = _2413 * (_2246.z * 0.30000001192092896f);
    _2611 = saturate(_2593 * 5.0f) * 0.8999999761581421f;
    ...
    _2629 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)(select(((uint)_2621 < (uint)170000), _2621, 0)) + 0u))].BindlessParameters_PostProcessUber_CD._followLearningSaturationTone);
    _2632 = (float)((uint)((uint)(((uint)(_2629) >> 16) & 255)));
    _2635 = (float)((uint)((uint)(((uint)(_2629) >> 8) & 255)));
    _2637 = (float)((uint)((uint)(_2629 & 255)));
    _2662 = select(((_2632 * 0.003921568859368563f) < 0.040449999272823334f), (_2632 * 0.0003035269910469651f), exp2(log2((_2632 * 0.0037171270232647657f) + 0.052132703363895416f) * 2.4000000953674316f));
    _2663 = select(((_2635 * 0.003921568859368563f) < 0.040449999272823334f), (_2635 * 0.0003035269910469651f), exp2(log2((_2635 * 0.0037171270232647657f) + 0.052132703363895416f) * 2.4000000953674316f));
    _2664 = select(((_2637 * 0.003921568859368563f) < 0.040449999272823334f), (_2637 * 0.0003035269910469651f), exp2(log2((_2637 * 0.0037171270232647657f) + 0.052132703363895416f) * 2.4000000953674316f));
    _2668 = (1.0f - _2662) * 0.3086000084877014f;
    _2670 = (1.0f - _2663) * 0.6093999743461609f;
    _2672 = (1.0f - _2664) * 0.0820000022649765f;
    _2677 = _2668 * _2618;
  ...
  // [sem: expr_sat]
    ...
    _2733 = 0.0010000000474974513f / max(0.0010000000474974513f, _exposure0.x);
  ...
  if ((dot(float4(_enemyAlert1.x, _enemyAlert1.y, _enemyAlert1.z, _enemyAlert1.w), float4(1.0f, 1.0f, 1.0f, 1.0f)) > 0.0f) | (dot(float4(_enemyAlert2.x, _enemyAlert2.y, _enemyAlert2.z, _enemyAlert2.w), float4(1.0f, 1.0f, 1.0f, 1.0f)) > 0.0f)) {
    ...
    _2786 = max(0.0010000000474974513f, _exposure0.x);
    _2803 = __0__7__0__0__g_bindlessTextures[((int)((uint)(select(((uint)_255 < (uint)65000), _255, 0)) + 0u))].Sample(__0__4__0__0__g_staticBilinearWrap, float2(((TEXCOORD.x * 2.0f) * _36), ((_time.x * 0.10000000149011612f) + (TEXCOORD.y * 2.0f))));
    _2806 = _2803.x + -0.5f;
    _2807 = _2803.y + -0.5f;
    _2817 = 0.44999998807907104f - (_2806 * 0.004999999888241291f);
    _2820 = max((abs((TEXCOORD.x + -0.5f) + (_2806 * 0.019999999552965164f)) - _2817), 0.0f);
    _2821 = max((abs((TEXCOORD.y + -0.5f) + (_2807 * 0.019999999552965164f)) - _2817), 0.0f);
    _2832 = WaveReadLaneFirst(_materialIndex);
    _2840 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)(select(((uint)_2832 < (uint)170000), _2832, 0)) + 0u))].BindlessParameters_PostProcessUber_CD._enemyAlertTex);
    _2847 = __0__7__0__0__g_bindlessTextures[((int)((uint)(select(((uint)_2840 < (uint)65000), _2840, 0)) + 0u))].Sample(__0__4__0__0__g_staticBilinearClamp, float2((TEXCOORD.x - (_2807 * 0.029999999329447746f)), (TEXCOORD.y - (_2806 * 0.029999999329447746f))));
    _2852 = (TEXCOORD.y > 0.5f);
    _2854 = (TEXCOORD.x < 0.5f);
    _2858 = (TEXCOORD.y < 0.5f);
    _2866 = (TEXCOORD.x > 0.5f);
  // [sem: expr_sat]
    _2890 = saturate(dot(float4((_2847.x * ((float)((bool)_2858))), (_2847.y * ((float)((bool)((uint)(_2866 && _2858))))), (_2847.z * ((float)((bool)_2866))), (_2847.w * ((float)((bool)((uint)(_2866 && _2852)))))), float4(_enemyAlert2.x, _enemyAlert2.y, _enemyAlert2.z, _enemyAlert2.w)) + dot(float4((_2847.x * ((float)((bool)_2852))), (_2847.y * ((float)((bool)((uint)(_2854 && _2852))))), (_2847.z * ((float)((bool)_2854))), (_2847.w * ((float)((bool)((uint)(_2854 && _2858)))))), float4(_enemyAlert1.x, _enemyAlert1.y, _enemyAlert1.z, _enemyAlert1.w))) * saturate(sqrt((_2821 * _2821) + (_2820 * _2820)) * 20.0f);
    _2892 = (_2890 * _2890) * _2890;
    _2903 = ((_2892 * ((select(_2780, 0.09989875555038452f, 0.08437622338533401f) / _2786) - _2758)) + _2758);
    _2904 = ((_2892 * ((select(_2780, 0.027320895344018936f, 0.030713455751538277f) / _2786) - _2759)) + _2759);
    _2905 = ((_2892 * ((select(_2780, 0.04817182570695877f, 0.07036010921001434f) / _2786) - _2760)) + _2760);
  } else {
    _2903 = _2758;
    _2904 = _2759;
    _2905 = _2760;
  ...
  if (_2922) {
    ...
    if (CUSTOM_BASIC_POSTPROCESS_FINAL == 1.f && !(_etcParams.z > 0.0f) && CUSTOM_SHARPENING_TYPE == 1 && CUSTOM_SHARPENING > 0.f) {
      ...
      float _rndx_menu_effect = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)(select(((uint)_rndx_mi < (uint)170000), _rndx_mi, 0)) + 0u))].BindlessParameters_PostProcessUber_CD._uiMainMenuEffect);
    ...
    if (_etcParams.z == 0.0f) {
      ...
      _3264 = 2.200000047683716f / ((min(max(_userImageAdjust.w, -1.0f), 1.0f) * 0.800000011920929f) + 2.200000047683716f);
  ...
  if (_2922 && (_etcParams.z > 0.0f)) {
    ...
    _3329 = select((_3297 <= 0.0031308000907301903f), (_3297 * 12.920000076293945f), (((pow(_3297, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f));
    _3330 = select((_3298 <= 0.0031308000907301903f), (_3298 * 12.920000076293945f), (((pow(_3298, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f));
  } else {
    _3328 = _3296;
    _3329 = _3297;
    _3330 = _3298;
