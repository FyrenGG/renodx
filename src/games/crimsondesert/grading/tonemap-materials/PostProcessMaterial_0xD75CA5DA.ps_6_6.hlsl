...
float4 main(
  ...
  if (_1349) {
    ...
    float3 _rndx_tonemapped_color = TonemapReplacer(float3(_1332, _1331, _1330));
    _1597 = _rndx_tonemapped_color.x;
    _1604 = _rndx_tonemapped_color.y;
    _1611 = _rndx_tonemapped_color.z;
