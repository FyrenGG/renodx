...
float4 main(
  ...
  if (_1840) {
    _1846 = _exposure0.x * _userImageAdjust.z;
    _1865 = exp2(_powerParams.x * log2(max(0.0f, (((_1846 * max(0.0f, (((_1819 * -0.62179f) - (_1818 * 0.08326f)) + (_1820 * 1.70505f)))) * _slopeParams.x) + _offsetParams.x))));
    _1881 = exp2(log2(max(0.0f, (((_slopeParams.y * _1846) * max(0.0f, (((_1819 * 1.1408f) - (_1818 * 0.01055f)) - (_1820 * 0.13026f)))) + _offsetParams.y))) * _powerParams.y);
    _1897 = exp2(log2(max(0.0f, (((_slopeParams.z * _1846) * max(0.0f, (((_1818 * 1.15297f) - (_1819 * 0.12897f)) - (_1820 * 0.024f)))) + _offsetParams.z))) * _powerParams.z);
    _1898 = dot(float3(_1865, _1881, _1897), float3(0.212671f, 0.71516f, 0.072169f));
    _1902 = ((_1865 - _1898) * _powerParams.w) + _1898;
    _1905 = ((_1881 - _1898) * _powerParams.w) + _1898;
    _1908 = ((_1897 - _1898) * _powerParams.w) + _1898;
    _1915 = min(max(log2(mad(_1908, 0.079223745f, mad(_1905, 0.0784336f, (_1902 * 0.84247905f)))), -12.47393f), 4.026069f) + 12.47393f;
    _1922 = min(max(log2(mad(_1908, 0.07916613f, mad(_1905, 0.87846863f, (_1902 * 0.042328242f)))), -12.47393f), 4.026069f) + 12.47393f;
    _1929 = min(max(log2(mad(_1908, 0.879143f, mad(_1905, 0.0784336f, (_1902 * 0.042375654f)))), -12.47393f), 4.026069f) + 12.47393f;
    _1930 = _1915 * 0.060606062f;
    _1931 = _1922 * 0.060606062f;
    _1932 = _1929 * 0.060606062f;
    _1933 = _1930 * _1930;
    _1934 = _1931 * _1931;
    _1935 = _1932 * _1932;
    _1951 = min(0.0f, (-0.0f - (((_1915 * 0.0072181816f) + ((_1933 * 0.4298f) + (((_1933 * _1933) * ((31.96f - (_1915 * 2.4327273f)) + (_1933 * 15.5f))) - ((_1915 * 0.41624245f) * _1933)))) + -0.00232f)));
    _1967 = min(0.0f, (-0.0f - (((_1922 * 0.0072181816f) + ((_1934 * 0.4298f) + (((_1934 * _1934) * ((31.96f - (_1922 * 2.4327273f)) + (_1934 * 15.5f))) - ((_1922 * 0.41624245f) * _1934)))) + -0.00232f)));
    _1983 = min(0.0f, (-0.0f - (((_1929 * 0.0072181816f) + ((_1935 * 0.4298f) + (((_1935 * _1935) * ((31.96f - (_1929 * 2.4327273f)) + (_1935 * 15.5f))) - ((_1929 * 0.41624245f) * _1935)))) + -0.00232f)));
    _1984 = -0.0f - _1951;
    _1985 = -0.0f - _1967;
    _1986 = -0.0f - _1983;
    _1987 = dot(float3(_1984, _1985, _1986), float3(0.2126f, 0.7152f, 0.0722f));
    if (_nightToneParm == 1) {
      _2004 = exp2(exp2(log2(abs((_time.w * 0.11666667f) + -1.4f)) * 8.0f) * -1.442695f) + 1.0f;
      _2005 = -0.79999995f / _2004;
      _2006 = -1.2f / _2004;
      _2007 = 0.20000005f / _2004;
      _2010 = saturate((_exposure2.x + -0.6f) * 0.10638298f);  // [sem: expr_sat]
      _2013 = saturate((_exposure2.x + -0.1f) * 2.0f);  // [sem: expr_sat]
      _2017 = (_2005 + 1.4f) + (_2013 * (-0.39999998f - _2005));
      _2021 = (_2006 + 1.6f) + (_2013 * (-0.6f - _2006));
      _2025 = (_2007 + 0.9f) + (_2013 * (0.5f - _2007));
      _2042 = (lerp(_2025, 1.4f, _2010));  // [sem: blended]
      _2043 = (lerp(_2017, 1.0f, _2010));  // [sem: blended]
      _2044 = (lerp(_2021, 1.2f, _2010));  // [sem: blended]
    } else {
      _2042 = 1.4f;  // [sem: blended]
      _2043 = 1.0f;  // [sem: blended]
      _2044 = ((saturate((_exposure2.x + -3.0f) * 0.14285715f) * 0.20000005f) + 1.0f);  // [sem: blended]
    }
    _2045 = 1.0f - _2044;
    _2057 = ((exp2(log2(((saturate((_1951 * _1951) * _1984) * _2045) + _2044) * _1984) * _2043) - _1987) * _2042) + _1987;
    _2069 = ((exp2(log2(((saturate((_1967 * _1967) * _1985) * _2045) + _2044) * _1985) * _2043) - _1987) * _2042) + _1987;
    _2081 = ((exp2(log2(((saturate((_1983 * _1983) * _1986) * _2045) + _2044) * _1986) * _2043) - _1987) * _2042) + _1987;
    _2088 = saturate(exp2(log2(mad(_2081, -0.09902974f, mad(_2069, -0.09802088f, (_2057 * 1.196879f)))) * 2.2f));  // [sem: expr_sat]
    _2095 = saturate(exp2(log2(mad(_2081, -0.098961174f, mad(_2069, 1.1519032f, (_2057 * -0.052896854f)))) * 2.2f));  // [sem: expr_sat]
    _2102 = saturate(exp2(log2(mad(_2081, 1.1510737f, mad(_2069, -0.09804345f, (_2057 * -0.052971635f)))) * 2.2f));  // [sem: expr_sat]
