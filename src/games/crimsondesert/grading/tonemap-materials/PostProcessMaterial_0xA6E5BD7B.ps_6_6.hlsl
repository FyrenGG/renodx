...
cbuffer __3__35__0__0__WaterConstantBuffer : register(b2, space35) {
  ...
  float4 _waterDepthViewProjRelative[4] : packoffset(c003.x);
  float4 _waterDepthViewProjRelativeInv[4] : packoffset(c007.x);
  float4 _waterDepthFrustumPlanes[6] : packoffset(c011.x);
  float4 _waterReadbackTextureSize : packoffset(c017.x);
  float4 _waterReadbackViewProjRelative[4] : packoffset(c018.x);
  float4 _waterReadbackViewProjRelativeInv[4] : packoffset(c022.x);
