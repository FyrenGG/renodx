...
float4 main(
  ...
  if (_346) {
    ...
    _401 = exp2(log2(max(0.0f, (((_352 * max(0.0f, (((_326 * 1.70505f) - (_327 * 0.62179f)) - (_328 * 0.08326f)))) * _slopeParams.x) + _offsetParams.x))) * _powerParams.x);
    _402 = exp2(log2(max(0.0f, (((max(0.0f, (((_327 * 1.1408f) - (_326 * 0.13026f)) - (_328 * 0.01055f))) * _352) * _slopeParams.y) + _offsetParams.y))) * _powerParams.y);
    _403 = exp2(log2(max(0.0f, (((max(0.0f, (((_326 * -0.024f) - (_327 * 0.12897f)) + (_328 * 1.15297f))) * _352) * _slopeParams.z) + _offsetParams.z))) * _powerParams.z);
