...
float4 main(
  ...
  if (_156) {
    ...
    if (_etcParams.z == 0.0f) {
      ...
      _498 = 2.200000047683716f / ((min(max(_userImageAdjust.w, -1.0f), 1.0f) * 0.800000011920929f) + 2.200000047683716f);
  ...
  _590 = exp2(log2(_578 * 9.999999747378752e-05f) * 0.1593017578125f);
  _591 = exp2(log2(_579 * 9.999999747378752e-05f) * 0.1593017578125f);
  _592 = exp2(log2(_580 * 9.999999747378752e-05f) * 0.1593017578125f);
