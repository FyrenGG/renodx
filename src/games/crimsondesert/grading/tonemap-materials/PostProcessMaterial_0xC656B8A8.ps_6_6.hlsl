...
float4 main(
  ...
  if (_31 > 0.0f) {
    ...
    while(true) {
      ...
      while(true) {
        ...
        _96 = (pow(_86.x, 0.012683313f));  // [sem: _3__36__0__0__g_sceneColor_sample_derived]
        _97 = (pow(_86.y, 0.012683313f));  // [sem: _3__36__0__0__g_sceneColor_sample_derived]
        _98 = (pow(_86.z, 0.012683313f));  // [sem: _3__36__0__0__g_sceneColor_sample_derived]
        _123 = ((_global_0[min((uint)(((int)(_60) + (int)(5))), 10u)]) * (_global_0[min((uint)(((int)(_65) + (int)(5))), 10u)])) * 10000.0f;
        _127 = (exp2(log2(max(0.0f, (_96 + -0.8359375f)) / (18.851562f - (_96 * 18.6875f))) * 6.277395f) * _123) + _62;
        _128 = (exp2(log2(max(0.0f, (_97 + -0.8359375f)) / (18.851562f - (_97 * 18.6875f))) * 6.277395f) * _123) + _63;
        _129 = (exp2(log2(max(0.0f, (_98 + -0.8359375f)) / (18.851562f - (_98 * 18.6875f))) * 6.277395f) * _123) + _64;
        _130 = (int)(_65) + (int)(1);
        if (!(_130 == 6)) {
          _62 = _127;
          _63 = _128;
        ...
        while(true) {
          _181 = (_127 * 1.8792827f);
          _182 = (_128 * 1.8792827f);
          _183 = (_129 * 1.8792827f);
          break;
        }
        break;
      }
    ...
    if (_40 > 0.0f) {
      ...
      _150 = (pow(_140.x, 0.012683313f));  // [sem: _3__36__0__0__g_sceneColor_sample_derived]
      _151 = (pow(_140.y, 0.012683313f));  // [sem: _3__36__0__0__g_sceneColor_sample_derived]
      _152 = (pow(_140.z, 0.012683313f));  // [sem: _3__36__0__0__g_sceneColor_sample_derived]
      _181 = (exp2(log2(max(0.0f, (_150 + -0.8359375f)) / (18.851562f - (_150 * 18.6875f))) * 6.277395f) * 10000.0f);
      _182 = (exp2(log2(max(0.0f, (_151 + -0.8359375f)) / (18.851562f - (_151 * 18.6875f))) * 6.277395f) * 10000.0f);
      _183 = (exp2(log2(max(0.0f, (_152 + -0.8359375f)) / (18.851562f - (_152 * 18.6875f))) * 6.277395f) * 10000.0f);
    } else {
      _181 = 0.0f;
      _182 = 0.0f;
      _183 = 0.0f;
  ...
  if (_49 > 0.0f) {
    ...
    _195 = WaveReadLaneFirst(BindlessParameters_PostProcessAction[((int)((uint)((uint)(select(((uint)_186 < (uint)170000), _186, 0))) + (uint)(0)))].BindlessParameters_PostProcessAction._borderEdgeNoiseTile.x);
    _196 = WaveReadLaneFirst(BindlessParameters_PostProcessAction[((int)((uint)((uint)(select(((uint)_186 < (uint)170000), _186, 0))) + (uint)(0)))].BindlessParameters_PostProcessAction._borderEdgeNoiseTile.y);
    _199 = WaveReadLaneFirst(_materialIndex);
    _208 = WaveReadLaneFirst(BindlessParameters_PostProcessAction[((int)((uint)((uint)(select(((uint)_199 < (uint)170000), _199, 0))) + (uint)(0)))].BindlessParameters_PostProcessAction._borderEdgeNoiseOffset.x);
    _209 = WaveReadLaneFirst(BindlessParameters_PostProcessAction[((int)((uint)((uint)(select(((uint)_199 < (uint)170000), _199, 0))) + (uint)(0)))].BindlessParameters_PostProcessAction._borderEdgeNoiseOffset.y);
    _212 = WaveReadLaneFirst(_materialIndex);
    _220 = WaveReadLaneFirst(BindlessParameters_PostProcessAction[((int)((uint)((uint)(select(((uint)_212 < (uint)170000), _212, 0))) + (uint)(0)))].BindlessParameters_PostProcessAction._borderEdgeNoiseTexture);
    _229 = WaveReadLaneFirst(_materialIndex);
    _237 = WaveReadLaneFirst(BindlessParameters_PostProcessAction[((int)((uint)((uint)(select(((uint)_229 < (uint)170000), _229, 0))) + (uint)(0)))].BindlessParameters_PostProcessAction._borderSmoothness);
    _238 = WaveReadLaneFirst(_materialIndex);
    _246 = WaveReadLaneFirst(BindlessParameters_PostProcessAction[((int)((uint)((uint)(select(((uint)_238 < (uint)170000), _238, 0))) + (uint)(0)))].BindlessParameters_PostProcessAction._borderWidth);
    _252 = (1.0f - _246) * 0.5f;
    ...
    _274 = WaveReadLaneFirst(BindlessParameters_PostProcessAction[((int)((uint)((uint)(select(((uint)_266 < (uint)170000), _266, 0))) + (uint)(0)))].BindlessParameters_PostProcessAction._borderFlickerSpeed);
    if (_274 > 0.0f) {
      _277 = WaveReadLaneFirst(_materialIndex);
      _286 = WaveReadLaneFirst(BindlessParameters_PostProcessAction[((int)((uint)((uint)(select(((uint)_277 < (uint)170000), _277, 0))) + (uint)(0)))].BindlessParameters_PostProcessAction._borderFlickerOpacityMinMax.x);
      _287 = WaveReadLaneFirst(BindlessParameters_PostProcessAction[((int)((uint)((uint)(select(((uint)_277 < (uint)170000), _277, 0))) + (uint)(0)))].BindlessParameters_PostProcessAction._borderFlickerOpacityMinMax.y);
      _295 = WaveReadLaneFirst(_materialIndex);
      _303 = WaveReadLaneFirst(BindlessParameters_PostProcessAction[((int)((uint)((uint)(select(((uint)_295 < (uint)170000), _295, 0))) + (uint)(0)))].BindlessParameters_PostProcessAction._borderFlickerIntensity);
      _307 = ((min(max(sin((_274 * 3.1415927f) * _time.x), _286), _287) * _265) * _303);
    } else {
      _307 = _265;
    }
    _309 = WaveReadLaneFirst(_materialIndex);
    _317 = WaveReadLaneFirst(BindlessParameters_PostProcessAction[((int)((uint)((uint)(select(((uint)_309 < (uint)170000), _309, 0))) + (uint)(0)))].BindlessParameters_PostProcessAction._borderEdgeNoiseRatio);
    _325 = (min(max(_49, 0.0f), 1.0f) * saturate(saturate(_307) - (_317 * (((float4)(__0__7__0__0__g_bindlessTextures[((int)((uint)((uint)(select(((uint)_220 < (uint)65000), _220, 0))) + (uint)(0)))].Sample(__0__4__0__0__g_staticBilinearWrap, float2((_208 + (_195 * TEXCOORD.x)), (_209 + (_196 * TEXCOORD.y)))))).x))));
  } else {
    _325 = 1.0f;
  }
  ...
  if (_342) {
    ...
    _397 = exp2(log2(max(0.0f, (((_348 * max(0.0f, (((_181 * 1.70505f) - (_182 * 0.62179f)) - (_183 * 0.08326f)))) * _slopeParams.x) + _offsetParams.x))) * _powerParams.x);
    _398 = exp2(log2(max(0.0f, (((max(0.0f, (((_182 * 1.1408f) - (_181 * 0.13026f)) - (_183 * 0.01055f))) * _348) * _slopeParams.y) + _offsetParams.y))) * _powerParams.y);
    _399 = exp2(log2(max(0.0f, (((max(0.0f, (((_181 * -0.024f) - (_182 * 0.12897f)) + (_183 * 1.15297f))) * _348) * _slopeParams.z) + _offsetParams.z))) * _powerParams.z);
  ...
  _777 = exp2(log2(_765 * 0.0001f) * 0.15930176f);
  _778 = exp2(log2(_766 * 0.0001f) * 0.15930176f);
  SV_Target.x = exp2(log2((1.0f / ((_776 * 18.6875f) + 1.0f)) * ((_776 * 18.851562f) + 0.8359375f)) * 78.84375f);
  SV_Target.y = exp2(log2((1.0f / ((_777 * 18.6875f) + 1.0f)) * ((_777 * 18.851562f) + 0.8359375f)) * 78.84375f);
  SV_Target.z = exp2(log2((1.0f / ((_778 * 18.6875f) + 1.0f)) * ((_778 * 18.851562f) + 0.8359375f)) * 78.84375f);
  SV_Target.w = _339;
  return SV_Target;
}
