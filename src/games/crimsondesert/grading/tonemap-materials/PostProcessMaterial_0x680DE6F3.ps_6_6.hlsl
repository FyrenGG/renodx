    ...
    while(true) {
      ...
      if (_etcParams.y > 1.0f) {
        ...
        _572 = abs((TEXCOORD.y * 2.0f) + -1.0f);
              ...
              _578 = saturate(1.0f - (dot(float2(_569, _572), float2(_569, _572)) * _rndx_vignette_strength));  // [sem: expr_sat]
      ...
      if (!(!(_etcParams.y >= 1.0f))) {
        ...
        _633 = _617;
            ...
            if (CUSTOM_BASIC_POSTPROCESS_FINAL == 1.f && !(_etcParams.z > 0.0f)) {
              float3 _rndx_final_color = FinalizeSDR(float3(_631, _632, _633), _sunDirection.y, _moonDirection.y);
              _631 = _rndx_final_color.x;
              _632 = _rndx_final_color.y;
              _633 = _rndx_final_color.z;
            }
