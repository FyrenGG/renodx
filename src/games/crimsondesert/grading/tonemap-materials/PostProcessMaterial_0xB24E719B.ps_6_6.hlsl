...
float4 main(
  ...
  while(true) {
    ...
    if (_2420) {
      _2426 = _userImageAdjust.z * _exposure0.x;
      _2475 = exp2(log2(max(0.0f, (((_2426 * max(0.0f, (((_2401 * 1.70505f) - (_2402 * 0.62179f)) - (_2403 * 0.08326f)))) * _slopeParams.x) + _offsetParams.x))) * _powerParams.x);
      _2476 = exp2(log2(max(0.0f, (((max(0.0f, (((_2402 * 1.1408f) - (_2401 * 0.13026f)) - (_2403 * 0.01055f))) * _2426) * _slopeParams.y) + _offsetParams.y))) * _powerParams.y);
      _2477 = exp2(log2(max(0.0f, (((max(0.0f, (((_2401 * -0.024f) - (_2402 * 0.12897f)) + (_2403 * 1.15297f))) * _2426) * _slopeParams.z) + _offsetParams.z))) * _powerParams.z);
      _2479 = dot(float3(_2475, _2476, _2477), float3(0.212671f, 0.71516f, 0.072169f));
      _2486 = ((_2475 - _2479) * _powerParams.w) + _2479;
      _2487 = ((_2476 - _2479) * _powerParams.w) + _2479;
      _2488 = ((_2477 - _2479) * _powerParams.w) + _2479;
      _2507 = min(max(log2(mad(_2488, 0.079223745f, mad(_2487, 0.0784336f, (_2486 * 0.84247905f)))), -12.47393f), 4.026069f) + 12.47393f;
      _2508 = min(max(log2(mad(_2488, 0.07916613f, mad(_2487, 0.87846863f, (_2486 * 0.042328242f)))), -12.47393f), 4.026069f) + 12.47393f;
      _2509 = min(max(log2(mad(_2488, 0.879143f, mad(_2487, 0.0784336f, (_2486 * 0.042375654f)))), -12.47393f), 4.026069f) + 12.47393f;
      _2510 = _2507 * 0.060606062f;
      _2511 = _2508 * 0.060606062f;
      _2512 = _2509 * 0.060606062f;
      _2513 = _2510 * _2510;
      _2514 = _2511 * _2511;
      _2515 = _2512 * _2512;
      _2561 = min(0.0f, (-0.0f - (((_2507 * 0.0072181816f) + ((_2513 * 0.4298f) + (((_2513 * _2513) * ((31.96f - (_2507 * 2.4327273f)) + (_2513 * 15.5f))) - ((_2507 * 0.41624245f) * _2513)))) + -0.00232f)));
      _2562 = min(0.0f, (-0.0f - (((_2508 * 0.0072181816f) + ((_2514 * 0.4298f) + (((_2514 * _2514) * ((31.96f - (_2508 * 2.4327273f)) + (_2514 * 15.5f))) - ((_2508 * 0.41624245f) * _2514)))) + -0.00232f)));
      _2563 = min(0.0f, (-0.0f - (((_2509 * 0.0072181816f) + ((_2515 * 0.4298f) + (((_2515 * _2515) * ((31.96f - (_2509 * 2.4327273f)) + (_2515 * 15.5f))) - ((_2509 * 0.41624245f) * _2515)))) + -0.00232f)));
      _2564 = -0.0f - _2561;
      _2565 = -0.0f - _2562;
      _2566 = -0.0f - _2563;
      _2567 = dot(float3(_2564, _2565, _2566), float3(0.2126f, 0.7152f, 0.0722f));
      if (_nightToneParm == 1) {
        _2584 = exp2(exp2(log2(abs((_time.w * 0.11666667f) + -1.4f)) * 8.0f) * -1.442695f) + 1.0f;
        _2585 = -0.79999995f / _2584;
        _2586 = -1.2f / _2584;
        _2587 = 0.20000005f / _2584;
        _2593 = saturate((_exposure2.x + -0.6f) * 0.10638298f);  // [sem: expr_sat]
        _2596 = saturate((_exposure2.x + -0.1f) * 2.0f);  // [sem: expr_sat]
        _2603 = (_2585 + 1.4f) + (_2596 * (-0.39999998f - _2585));
        _2604 = (_2586 + 1.6f) + (_2596 * (-0.6f - _2586));
        _2605 = (_2587 + 0.9f) + (_2596 * (0.5f - _2587));
        _2622 = (lerp(_2604, 1.2f, _2593));  // [sem: blended]
        _2623 = (lerp(_2603, 1.0f, _2593));  // [sem: blended]
        _2624 = (lerp(_2605, 1.4f, _2593));  // [sem: blended]
      } else {
        _2622 = ((saturate((_exposure2.x + -3.0f) * 0.14285715f) * 0.20000005f) + 1.0f);  // [sem: blended]
        _2623 = 1.0f;  // [sem: blended]
        _2624 = 1.4f;  // [sem: blended]
      }
      _2634 = 1.0f - _2622;
      _2659 = ((exp2(log2(((saturate((_2561 * _2561) * _2564) * _2634) + _2622) * _2564) * _2623) - _2567) * _2624) + _2567;
      _2660 = ((exp2(log2(((saturate((_2562 * _2562) * _2565) * _2634) + _2622) * _2565) * _2623) - _2567) * _2624) + _2567;
      _2661 = ((exp2(log2(((saturate((_2563 * _2563) * _2566) * _2634) + _2622) * _2566) * _2623) - _2567) * _2624) + _2567;
      _2680 = saturate(exp2(log2(mad(_2661, -0.09902974f, mad(_2660, -0.09802088f, (_2659 * 1.196879f)))) * 2.2f));  // [sem: expr_sat]
      _2681 = saturate(exp2(log2(mad(_2661, -0.098961174f, mad(_2660, 1.1519032f, (_2659 * -0.052896854f)))) * 2.2f));  // [sem: expr_sat]
      _2682 = saturate(exp2(log2(mad(_2661, 1.1510737f, mad(_2660, -0.09804345f, (_2659 * -0.052971635f)))) * 2.2f));  // [sem: expr_sat]
