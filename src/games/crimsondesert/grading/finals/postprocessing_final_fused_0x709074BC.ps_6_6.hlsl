...
float4 main(
  ...
  _360 = saturate(_etcParams.w);
  _384 = (_359 * saturate(_rndx_tonemapped_color.x)) + _360;
  _376 = (_359 * saturate(_rndx_tonemapped_color.y)) + _360;
  _368 = (_359 * saturate(_rndx_tonemapped_color.z)) + _360;
  ...
  _484 = saturate(1.0f - ((_475 * _postProcessParams.x * CUSTOM_VIGNETTE) * dot(float2(_476, _478), float2(_476, _478))));  // [sem: expr_sat]
