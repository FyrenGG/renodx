...
float4 main(
  ...
  _446 = saturate(_etcParams.w);
  _448 = (_445 * saturate(_rndx_tonemapped_color.x)) + _446;
  _450 = (_445 * saturate(_rndx_tonemapped_color.y)) + _446;
  _452 = (_445 * saturate(_rndx_tonemapped_color.z)) + _446;
  ...
  _544 = saturate(1.0f - ((_postProcessParams.x * CUSTOM_VIGNETTE * _534) * dot(float2(_535, _537), float2(_535, _537))));  // [sem: expr_sat]
