...
float4 main(
  ...
  _707 = 2.200000047683716f / ((min(max(_userImageAdjust.w, -1.0f), 1.0f) * 0.800000011920929f) + 2.200000047683716f);
  _718 = (TEXCOORD.x * 2.0f) + -1.0f;
  _719 = TEXCOORD.y * 2.0f;
  _720 = 1.0f - _719;
  _748 = mad((_projToPrevProj[2].w), 1.0000000116860974e-07f, mad((_projToPrevProj[1].w), _720, ((_projToPrevProj[0].w) * _718))) + (_projToPrevProj[3].w);
  _751 = ((mad((_projToPrevProj[2].x), 1.0000000116860974e-07f, mad((_projToPrevProj[1].x), _720, ((_projToPrevProj[0].x) * _718))) + (_projToPrevProj[3].x)) / _748) - _718;
  _752 = ((mad((_projToPrevProj[2].y), 1.0000000116860974e-07f, mad((_projToPrevProj[1].y), _720, ((_projToPrevProj[0].y) * _718))) + (_projToPrevProj[3].y)) / _748) - _720;
