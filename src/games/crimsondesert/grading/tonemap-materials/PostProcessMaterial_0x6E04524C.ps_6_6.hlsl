...
float4 main(
  ...
  _112 = WaveReadLaneFirst(BindlessParameters_PostProcessEdgeBlur_CD[((int)((uint)(select(((uint)_104 < (uint)170000), _104, 0)) + 0u))].BindlessParameters_PostProcessEdgeBlur_CD._edgeBlurRatio);
  _113 = WaveReadLaneFirst(_materialIndex);
  _121 = WaveReadLaneFirst(BindlessParameters_PostProcessEdgeBlur_CD[((int)((uint)(select(((uint)_113 < (uint)170000), _113, 0)) + 0u))].BindlessParameters_PostProcessEdgeBlur_CD._edgeBlurShiftValue);
  if ((_112 > 0.0f) && (_121 > 0.0f)) {
    ...
    _142 = WaveReadLaneFirst(BindlessParameters_PostProcessEdgeBlur_CD[((int)((uint)(select(((uint)_134 < (uint)170000), _134, 0)) + 0u))].BindlessParameters_PostProcessEdgeBlur_CD._edgeBlurBrightness);
    _143 = _142 * (1.0f - _128.w);
    _160 = WaveReadLaneFirst(_materialIndex);
    _170 = WaveReadLaneFirst(BindlessParameters_PostProcessEdgeBlur_CD[((int)((uint)(select(((uint)_160 < (uint)170000), _160, 0)) + 0u))].BindlessParameters_PostProcessEdgeBlur_CD._targetFocusPositionOffset.x);
    _171 = WaveReadLaneFirst(BindlessParameters_PostProcessEdgeBlur_CD[((int)((uint)(select(((uint)_160 < (uint)170000), _160, 0)) + 0u))].BindlessParameters_PostProcessEdgeBlur_CD._targetFocusPositionOffset.y);
    _172 = WaveReadLaneFirst(BindlessParameters_PostProcessEdgeBlur_CD[((int)((uint)(select(((uint)_160 < (uint)170000), _160, 0)) + 0u))].BindlessParameters_PostProcessEdgeBlur_CD._targetFocusPositionOffset.z);
    ...
    _228 = ((_invViewProjRelative[3].w) + (_invViewProjRelative[2].w)) + mad((_invViewProjRelative[1].w), _192, ((_invViewProjRelative[0].w) * _189));
    _229 = ((mad((_invViewProjRelative[1].x), _192, ((_invViewProjRelative[0].x) * _189)) + (_invViewProjRelative[2].x)) + (_invViewProjRelative[3].x)) / _228;
    _230 = (((_invViewProjRelative[3].y) + (_invViewProjRelative[2].y)) + mad((_invViewProjRelative[1].y), _192, ((_invViewProjRelative[0].y) * _189))) / _228;
    _231 = (((_invViewProjRelative[3].z) + (_invViewProjRelative[2].z)) + mad((_invViewProjRelative[1].z), _192, ((_invViewProjRelative[0].z) * _189))) / _228;
    ...
    _285 = WaveReadLaneFirst(BindlessParameters_PostProcessEdgeBlur_CD[((int)((uint)(select(((uint)_276 < (uint)170000), _276, 0)) + 0u))].BindlessParameters_PostProcessEdgeBlur_CD._edgeBlurNoiseScale.x);
    _286 = WaveReadLaneFirst(BindlessParameters_PostProcessEdgeBlur_CD[((int)((uint)(select(((uint)_276 < (uint)170000), _276, 0)) + 0u))].BindlessParameters_PostProcessEdgeBlur_CD._edgeBlurNoiseScale.y);
    _290 = WaveReadLaneFirst(_materialIndex);
    _298 = WaveReadLaneFirst(BindlessParameters_PostProcessEdgeBlur_CD[((int)((uint)(select(((uint)_290 < (uint)170000), _290, 0)) + 0u))].BindlessParameters_PostProcessEdgeBlur_CD._useTargetFocusDir);
    if (_298 > 0.0010000000474974513f) {
      _314 = WaveReadLaneFirst(_materialIndex);
      _323 = WaveReadLaneFirst(BindlessParameters_PostProcessEdgeBlur_CD[((int)((uint)(select(((uint)_314 < (uint)170000), _314, 0)) + 0u))].BindlessParameters_PostProcessEdgeBlur_CD._edgeBlurNoiseScale.x);
      _324 = WaveReadLaneFirst(BindlessParameters_PostProcessEdgeBlur_CD[((int)((uint)(select(((uint)_314 < (uint)170000), _314, 0)) + 0u))].BindlessParameters_PostProcessEdgeBlur_CD._edgeBlurNoiseScale.y);
      _328 = (_323 * select((_272 && _273), 0.75f, select((_272 && _274), 0.25f, ((select((_271 && _274), (_270 + -3.1415927410125732f), select((_271 && _273), (_270 + 3.1415927410125732f), _270)) * 0.15915493667125702f) + 0.5f))));
      _329 = ((_275 * 0.31830987334251404f) * _324);
    } else {
      _328 = ((_96 * _28) * _285);
      _329 = (_286 * _97);
    }
    _332 = WaveReadLaneFirst(_materialIndex);
    _341 = WaveReadLaneFirst(BindlessParameters_PostProcessEdgeBlur_CD[((int)((uint)(select(((uint)_332 < (uint)170000), _332, 0)) + 0u))].BindlessParameters_PostProcessEdgeBlur_CD._edgeBlurNoiseSpeed.x);
    _342 = WaveReadLaneFirst(BindlessParameters_PostProcessEdgeBlur_CD[((int)((uint)(select(((uint)_332 < (uint)170000), _332, 0)) + 0u))].BindlessParameters_PostProcessEdgeBlur_CD._edgeBlurNoiseSpeed.y);
    _347 = WaveReadLaneFirst(_materialIndex);
    _355 = WaveReadLaneFirst(BindlessParameters_PostProcessEdgeBlur_CD[((int)((uint)(select(((uint)_347 < (uint)170000), _347, 0)) + 0u))].BindlessParameters_PostProcessEdgeBlur_CD._edgeBlurNoiseTex);
    _362 = __0__7__0__0__g_bindlessTextures[((int)((uint)(select(((uint)_355 < (uint)65000), _355, 0)) + 0u))].Sample(__0__4__0__0__g_staticBilinearWrap, float2(((_341 * _time.x) + _328), ((_342 * _time.x) + _329)));
    _367 = (_362.x * 2.0f) + -0.9960784316062927f;
    _368 = (_362.y * 2.0f) + -0.9960784316062927f;
    _373 = WaveReadLaneFirst(_materialIndex);
    _381 = WaveReadLaneFirst(BindlessParameters_PostProcessEdgeBlur_CD[((int)((uint)(select(((uint)_373 < (uint)170000), _373, 0)) + 0u))].BindlessParameters_PostProcessEdgeBlur_CD._targetFocusCenterMask);
    _382 = WaveReadLaneFirst(_materialIndex);
    _390 = WaveReadLaneFirst(BindlessParameters_PostProcessEdgeBlur_CD[((int)((uint)(select(((uint)_382 < (uint)170000), _382, 0)) + 0u))].BindlessParameters_PostProcessEdgeBlur_CD._targetFocusCenterMaskEdgeThickness);
    _391 = _390 * _381;
    _392 = WaveReadLaneFirst(_materialIndex);
    _400 = WaveReadLaneFirst(BindlessParameters_PostProcessEdgeBlur_CD[((int)((uint)(select(((uint)_392 < (uint)170000), _392, 0)) + 0u))].BindlessParameters_PostProcessEdgeBlur_CD._targetFocusCenterMaskPower);
  ...
  // [sem: expr_sat]
    ...
    _414 = (_400 < 0.0010000000474974513f);
    if (!_414) {
      _420 = (pow(_413, _400));
    } else {
      _420 = 1.0f;
    ...
    _430 = WaveReadLaneFirst(BindlessParameters_PostProcessEdgeBlur_CD[((int)((uint)(select(((uint)_422 < (uint)170000), _422, 0)) + 0u))].BindlessParameters_PostProcessEdgeBlur_CD._debugMode);
    if (_430 == 1) {
      if (!_414) {
        _440 = (pow(_413, _400));
      } else {
    ...
    _453 = WaveReadLaneFirst(BindlessParameters_PostProcessEdgeBlur_CD[((int)((uint)(select(((uint)_445 < (uint)170000), _445, 0)) + 0u))].BindlessParameters_PostProcessEdgeBlur_CD._edgeBlurNoiseDissolve);
    if (_453 > 0.0010000000474974513f) {
      _456 = WaveReadLaneFirst(_materialIndex);
      _464 = WaveReadLaneFirst(BindlessParameters_PostProcessEdgeBlur_CD[((int)((uint)(select(((uint)_456 < (uint)170000), _456, 0)) + 0u))].BindlessParameters_PostProcessEdgeBlur_CD._edgeBlurNoiseDissolve);
  // [sem: expr_sat]
  ...
  if (_506) {
    ...
    if (_etcParams.z == 0.0f) {
      ...
      _848 = 2.200000047683716f / ((min(max(_userImageAdjust.w, -1.0f), 1.0f) * 0.800000011920929f) + 2.200000047683716f);
