...
float4 main(
  ...
  _158 = saturate(_etcParams.w);
  _204 = (_157 * saturate(_rndx_tonemapped_color.x)) + _158;
  _191 = (_157 * saturate(_rndx_tonemapped_color.y)) + _158;
  _178 = (_157 * saturate(_rndx_tonemapped_color.z)) + _158;
  ...
  _305 = saturate(1.0f - ((_296 * _postProcessParams.x * CUSTOM_VIGNETTE) * dot(float2(_297, _299), float2(_297, _299))));  // [sem: expr_sat]
