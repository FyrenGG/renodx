...
Texture2DArray<uint2> __3__36__0__0__g_dynamicShadowStencilArray : register(t235, space36);

Texture2DArray<half4> __3__36__0__0__g_dynamicShadowColorArray : register(t236, space36);
...
Texture2D<uint> __3__36__0__0__g_depthStencil : register(t23, space36);

Texture2D<uint> __3__36__0__0__g_sceneNormal : register(t61, space36);

Texture2D<float2> __3__36__0__0__g_raytracedShadow : register(t124, space36);

RWTexture2D<half4> __3__38__0__1__g_shadowColorResultUAV : register(u41, space38);
...
void main(
  ...
  if ((_79 < 1.0000000116860974e-07f) || _107) {
    ...
    if (_2284 > 0.0f) {
      ...
      // Description: SceneShadowTiledCS 0xA5C85C1A uses this native contact ray direction on Lighting High/Ultra with Sun/Moon RT enabled; stable direction keeps Contact Micro Shadows from inheriting per-frame random cone wobble when the feature is enabled.
