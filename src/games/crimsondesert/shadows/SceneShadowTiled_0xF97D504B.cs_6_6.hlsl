...
void main(
  ...
  if ((_84 < 1e-07f) || _111) {
    ...
    if (_1941 > 0.0f) {
      ...
      _2075 = ((abs(_1966) * (select(_1947, 12.0f, 2.0f) - _1948)) + _1948) * select(_169, 0.01f, 0.1f);
      if (!_169) {
      ...
      if (_85 == 15) {
        _2273 = ((10.0f - (saturate(_120 * 0.001f) * 9.0f)) * _2264);
      } else {
        _2273 = _2264;
      }
      if (!_2099) {
      ...
      if (_120 < 8.0f) {
        ...
        while(true) {
          ...
          _2456 = __3__36__0__0__g_depthStencil.Load(int3(((int)(_bufferSizeAndInvSize.x * min(max(_2443, _2421), (1.0f - _2421)))), ((int)(_bufferSizeAndInvSize.y * _2442)), 0));
          ...
          if (!(_2522 == 0)) {
            ...
            // [sem: expr_sat]
            _2566 = saturate(((saturate(1.0f - ((_2551 * _2551) * _2546)) * (1.0f - _2436)) * saturate((-0.0f - _2471) / (_2440 * 0.0046548597f))) + _2436);
            _2567 = _2462;
          } else {
        ...
        while(true) {
          // [sem: _3__36__0__0__g_depthStencil_load]
          _2631 = __3__36__0__0__g_depthStencil.Load(int3(((int)(_bufferSizeAndInvSize.x * min(max(_2616, _2421), (1.0f - _2421)))), ((int)(_bufferSizeAndInvSize.y * _2615)), 0));
          ...
          if (!(_2697 == 0)) {
            ...
            // [sem: expr_sat]
            _2741 = saturate(((saturate(1.0f - ((_2726 * _2726) * _2721)) * (1.0f - _2611)) * saturate((-0.0f - _2646) / (_2617 * 0.0046548597f))) + _2611);
            _2742 = _2637;
          } else {
