...
float4 main(
  ...
  _405 = saturate(_etcParams.w);
  _406 = (_401 * saturate(_rndx_tonemapped_color.x)) + _405;
  _407 = (_401 * saturate(_rndx_tonemapped_color.y)) + _405;
  _408 = (_401 * saturate(_rndx_tonemapped_color.z)) + _405;
  ...
  _475 = 2.200000047683716f / ((min(max(_userImageAdjust.w, -1.0f), 1.0f) * 0.800000011920929f) + 2.200000047683716f);
  _486 = (TEXCOORD.x * 2.0f) + -1.0f;
  _487 = TEXCOORD.y * 2.0f;
  _488 = 1.0f - _487;
  _516 = mad((_projToPrevProj[2].w), 1.0000000116860974e-07f, mad((_projToPrevProj[1].w), _488, ((_projToPrevProj[0].w) * _486))) + (_projToPrevProj[3].w);
  _519 = ((mad((_projToPrevProj[2].x), 1.0000000116860974e-07f, mad((_projToPrevProj[1].x), _488, ((_projToPrevProj[0].x) * _486))) + (_projToPrevProj[3].x)) / _516) - _486;
  _520 = ((mad((_projToPrevProj[2].y), 1.0000000116860974e-07f, mad((_projToPrevProj[1].y), _488, ((_projToPrevProj[0].y) * _486))) + (_projToPrevProj[3].y)) / _516) - _488;
  ...
  _536 = abs(_486);
  _537 = abs(_487 + -1.0f);
  _541 = saturate(1.0f - ((_533 * _postProcessParams.x * CUSTOM_VIGNETTE) * dot(float2(_536, _537), float2(_536, _537))));  // [sem: expr_sat]
