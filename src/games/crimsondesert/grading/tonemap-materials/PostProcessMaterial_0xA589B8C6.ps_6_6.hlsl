...
float4 main(
  ...
  if (_38) {
    ...
    _286 = _rndx_tonemapped_color.x;
    _293 = _rndx_tonemapped_color.y;
  ...
  if (_etcParams.y > 1.0f) {
    ...
    _407 = saturate(1.0f - (dot(float2(_398, _401), float2(_398, _401)) * _rndx_vignette_strength));  // [sem: expr_sat]
