...
float4 main(
  ...
  if (_1501) {
    ...
    float3 _rndx_tonemapped_color = TonemapReplacer(float3(_1482, _1483, _1484));
    _1761 = _rndx_tonemapped_color.x;
    _1762 = _rndx_tonemapped_color.y;
    _1763 = _rndx_tonemapped_color.z;
