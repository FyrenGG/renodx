...
float4 main(
  ...
  _42 = (pow(_32.x, 0.012683313339948654f));  // [sem: _3__36__0__0__g_sceneColor_sample_derived]
  _43 = (pow(_32.y, 0.012683313339948654f));  // [sem: _3__36__0__0__g_sceneColor_sample_derived]
  _44 = (pow(_32.z, 0.012683313339948654f));  // [sem: _3__36__0__0__g_sceneColor_sample_derived]
  ...
  if (!(!(_80 >= 0.0010000000474974513f))) {
    ...
    _99 = WaveReadLaneFirst(BindlessParameters_PostProcessGhost_CD[((int)((uint)(select(((uint)_91 < (uint)170000), _91, 0)) + 0u))].BindlessParameters_PostProcessGhost_CD._ghostNoiseTex);
    _108 = WaveReadLaneFirst(_materialIndex);
    _116 = WaveReadLaneFirst(BindlessParameters_PostProcessGhost_CD[((int)((uint)(select(((uint)_108 < (uint)170000), _108, 0)) + 0u))].BindlessParameters_PostProcessGhost_CD._ghostFXRatio);
    _117 = WaveReadLaneFirst(_materialIndex);
    _125 = WaveReadLaneFirst(BindlessParameters_PostProcessGhost_CD[((int)((uint)(select(((uint)_117 < (uint)170000), _117, 0)) + 0u))].BindlessParameters_PostProcessGhost_CD._ghostNoiseIntensity);
    _127 = _125 * (_116 * (((float4)(__0__7__0__0__g_bindlessTextures[((int)((uint)(select(((uint)_99 < (uint)65000), _99, 0)) + 0u))].Sample(__0__4__0__0__g_staticBilinearWrap, float2(((TEXCOORD.x * 3.0f) * _84), ((_time.x * 0.30000001192092896f) + (_84 * TEXCOORD.y)))))).y));
    _130 = (_127 * 0.009999999776482582f) + TEXCOORD.x;
    _131 = (_127 * 0.05000000074505806f) + TEXCOORD.y;
    _167 = WaveReadLaneFirst(_materialIndex);
    _175 = WaveReadLaneFirst(BindlessParameters_PostProcessGhost_CD[((int)((uint)(select(((uint)_167 < (uint)170000), _167, 0)) + 0u))].BindlessParameters_PostProcessGhost_CD._ghostFXRatio);
  // [sem: _3__36__0__0__g_postProcessSizeColor_sample]
    ...
    _188 = (pow(_178.x, 0.012683313339948654f));  // [sem: _3__36__0__0__g_postProcessSizeColor_sample_derived]
    _189 = (pow(_178.y, 0.012683313339948654f));  // [sem: _3__36__0__0__g_postProcessSizeColor_sample_derived]
    _190 = (pow(_178.z, 0.012683313339948654f));  // [sem: _3__36__0__0__g_postProcessSizeColor_sample_derived]
    _219 = (saturate(ceil(((_nearFarProj.x / max(1.0000000116860974e-07f, (((float)((uint)((uint)((((uint)(__3__36__0__0__g_depthOpaque.Load(int3((int)(uint((_bufferSizeAndInvSize.x * _130) + -0.5f)), (int)(uint((_bufferSizeAndInvSize.y * _131) + -0.5f)), 0)))).x) & 16777215)))) * 5.960465188081798e-08f))) + 0.05000000074505806f) - (_nearFarProj.x / max(1.0000000116860974e-07f, (((float4)(__3__36__0__0__g_CustomRenderPassDepth.Load(int3(int(_customRenderPassSizeInvSize.x * _130), int(_customRenderPassSizeInvSize.y * _131), 0)))).x))))) * 10000.0f) * _175;
    _227 = (((exp2(log2(max(0.0f, (_188 + -0.8359375f)) / (18.8515625f - (_188 * 18.6875f))) * 6.277394771575928f) - _66) * _219) + _69);
    _228 = (((exp2(log2(max(0.0f, (_189 + -0.8359375f)) / (18.8515625f - (_189 * 18.6875f))) * 6.277394771575928f) - _67) * _219) + _70);
    _229 = (((exp2(log2(max(0.0f, (_190 + -0.8359375f)) / (18.8515625f - (_190 * 18.6875f))) * 6.277394771575928f) - _68) * _219) + _71);
  } else {
    _227 = _69;
    _228 = _70;
    _229 = _71;
  ...
  if (_246) {
    ...
    if (_etcParams.z == 0.0f) {
      ...
      _588 = 2.200000047683716f / ((min(max(_userImageAdjust.w, -1.0f), 1.0f) * 0.800000011920929f) + 2.200000047683716f);
  ...
  if (_246 && (_etcParams.z > 0.0f)) {
    ...
    _653 = select((_621 <= 0.0031308000907301903f), (_621 * 12.920000076293945f), (((pow(_621, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f));
    _654 = select((_622 <= 0.0031308000907301903f), (_622 * 12.920000076293945f), (((pow(_622, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f));
  } else {
    _652 = _620;
    _653 = _621;
    _654 = _622;
  ...
  _682 = exp2(log2(_670 * 9.999999747378752e-05f) * 0.1593017578125f);
  SV_Target.x = exp2(log2((1.0f / ((_680 * 18.6875f) + 1.0f)) * ((_680 * 18.8515625f) + 0.8359375f)) * 78.84375f);
  SV_Target.y = exp2(log2((1.0f / ((_681 * 18.6875f) + 1.0f)) * ((_681 * 18.8515625f) + 0.8359375f)) * 78.84375f);
  SV_Target.z = exp2(log2((1.0f / ((_682 * 18.6875f) + 1.0f)) * ((_682 * 18.8515625f) + 0.8359375f)) * 78.84375f);
  SV_Target.w = _243;
  return SV_Target;
}
