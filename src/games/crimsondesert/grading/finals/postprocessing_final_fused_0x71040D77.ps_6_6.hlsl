...
float4 main(
  ...
  _169 = 1.0f - abs(_etcParams.w);
  _173 = saturate(_etcParams.w);
  _174 = (_169 * saturate(_rndx_tonemapped_color.x)) + _173;
  _175 = (_169 * saturate(_rndx_tonemapped_color.y)) + _173;
  _176 = (_169 * saturate(_rndx_tonemapped_color.z)) + _173;
  // RenoDX: <<< [Patch: FusedFinalFadeRestore]
  if (_colorGradingParams.w > 0.0f) {
    _181 = saturate(_colorGradingParams.w);  // [sem: expr_sat]
    _198 = (((max(0.0f, (1.0f - _174)) - _174) * _181) + _174);
    _199 = (((max(0.0f, (1.0f - _175)) - _175) * _181) + _175);
    _200 = (((max(0.0f, (1.0f - _176)) - _176) * _181) + _176);
  } else {
    _198 = _174;
    _199 = _175;
    _200 = _176;
  }
  _206 = _userImageAdjust.y + 1.0f;
  _210 = _userImageAdjust.x + 0.5f;
  _211 = ((_198 + -0.5f) * _206) + _210;
  _212 = ((_199 + -0.5f) * _206) + _210;
  _213 = ((_200 + -0.5f) * _206) + _210;
  _243 = 2.200000047683716f / ((min(max(_userImageAdjust.w, -1.0f), 1.0f) * 0.800000011920929f) + 2.200000047683716f);
  _254 = (TEXCOORD.x * 2.0f) + -1.0f;
  _255 = TEXCOORD.y * 2.0f;
  _256 = 1.0f - _255;
  _284 = mad((_projToPrevProj[2].w), 1.0000000116860974e-07f, mad((_projToPrevProj[1].w), _256, ((_projToPrevProj[0].w) * _254))) + (_projToPrevProj[3].w);
  _287 = ((mad((_projToPrevProj[2].x), 1.0000000116860974e-07f, mad((_projToPrevProj[1].x), _256, ((_projToPrevProj[0].x) * _254))) + (_projToPrevProj[3].x)) / _284) - _254;
  _288 = ((mad((_projToPrevProj[2].y), 1.0000000116860974e-07f, mad((_projToPrevProj[1].y), _256, ((_projToPrevProj[0].y) * _254))) + (_projToPrevProj[3].y)) / _284) - _256;
  if (_localToneMappingParams.w > 0.0f) {
    _302 = saturate(1.0f - (sqrt((_288 * _288) + (_287 * _287)) * 2.0f));  // [sem: expr_sat]
  } else {
    _302 = 1.0f;  // [sem: expr_sat]
  }
  _305 = abs(_254);
  _306 = abs(_255 + -1.0f);
  _310 = saturate(1.0f - ((_302 * _postProcessParams.x * CUSTOM_VIGNETTE) * dot(float2(_305, _306), float2(_305, _306))));  // [sem: expr_sat]
  if (!(SV_Position.y < _viewDir.w)) {
    if (!(SV_Position.y >= (_screenSizeAndInvSize.y - _viewDir.w))) {
      _324 = (_310 * exp2(log2(saturate(mad(_colorBlind0.z, _213, mad(_colorBlind0.y, _212, (_colorBlind0.x * _211))))) * _243));
      _325 = (_310 * exp2(log2(saturate(mad(_colorBlind1.z, _213, mad(_colorBlind1.y, _212, (_colorBlind1.x * _211))))) * _243));
      _326 = (_310 * exp2(log2(saturate(mad(_colorBlind2.z, _213, mad(_colorBlind2.y, _212, (_colorBlind2.x * _211))))) * _243));
    } else {
      _324 = 0.0f;
      _325 = 0.0f;
      _326 = 0.0f;
