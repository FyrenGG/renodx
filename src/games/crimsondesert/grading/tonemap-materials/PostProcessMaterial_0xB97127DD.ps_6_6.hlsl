...
float4 main(
  ...
  if (_380) {
    _386 = _exposure0.x * _userImageAdjust.z;
    _405 = exp2(_powerParams.x * log2(max(0.0f, (((_386 * max(0.0f, (((_359 * -0.62179f) - (_358 * 0.08326f)) + (_360 * 1.70505f)))) * _slopeParams.x) + _offsetParams.x))));
    _421 = exp2(log2(max(0.0f, (((_slopeParams.y * _386) * max(0.0f, (((_359 * 1.1408f) - (_358 * 0.01055f)) - (_360 * 0.13026f)))) + _offsetParams.y))) * _powerParams.y);
    _437 = exp2(log2(max(0.0f, (((_slopeParams.z * _386) * max(0.0f, (((_358 * 1.15297f) - (_359 * 0.12897f)) - (_360 * 0.024f)))) + _offsetParams.z))) * _powerParams.z);
    _438 = dot(float3(_405, _421, _437), float3(0.212671f, 0.71516f, 0.072169f));
    _442 = ((_405 - _438) * _powerParams.w) + _438;
    _445 = ((_421 - _438) * _powerParams.w) + _438;
    _448 = ((_437 - _438) * _powerParams.w) + _438;
    _455 = min(max(log2(mad(_448, 0.079223745f, mad(_445, 0.0784336f, (_442 * 0.84247905f)))), -12.47393f), 4.026069f) + 12.47393f;
    _462 = min(max(log2(mad(_448, 0.07916613f, mad(_445, 0.87846863f, (_442 * 0.042328242f)))), -12.47393f), 4.026069f) + 12.47393f;
    _469 = min(max(log2(mad(_448, 0.879143f, mad(_445, 0.0784336f, (_442 * 0.042375654f)))), -12.47393f), 4.026069f) + 12.47393f;
    _470 = _455 * 0.060606062f;
    _471 = _462 * 0.060606062f;
    _472 = _469 * 0.060606062f;
    _473 = _470 * _470;
    _474 = _471 * _471;
    _475 = _472 * _472;
    _491 = min(0.0f, (-0.0f - (((_455 * 0.0072181816f) + ((_473 * 0.4298f) + (((_473 * _473) * ((31.96f - (_455 * 2.4327273f)) + (_473 * 15.5f))) - ((_455 * 0.41624245f) * _473)))) + -0.00232f)));
    _507 = min(0.0f, (-0.0f - (((_462 * 0.0072181816f) + ((_474 * 0.4298f) + (((_474 * _474) * ((31.96f - (_462 * 2.4327273f)) + (_474 * 15.5f))) - ((_462 * 0.41624245f) * _474)))) + -0.00232f)));
    ...
    _525 = -0.0f - _507;
    _526 = -0.0f - _523;
    _527 = dot(float3(_524, _525, _526), float3(0.2126f, 0.7152f, 0.0722f));
    if (_nightToneParm == 1) {
      _544 = exp2(exp2(log2(abs((_time.w * 0.11666667f) + -1.4f)) * 8.0f) * -1.442695f) + 1.0f;
      _545 = -0.79999995f / _544;
      _546 = -1.2f / _544;
      _547 = 0.20000005f / _544;
      _550 = saturate((_exposure2.x + -0.6f) * 0.10638298f);  // [sem: expr_sat]
      _553 = saturate((_exposure2.x + -0.1f) * 2.0f);  // [sem: expr_sat]
      _557 = (_545 + 1.4f) + (_553 * (-0.39999998f - _545));
      _561 = (_546 + 1.6f) + (_553 * (-0.6f - _546));
      _565 = (_547 + 0.9f) + (_553 * (0.5f - _547));
      _582 = (lerp(_565, 1.4f, _550));  // [sem: blended]
      _583 = (lerp(_557, 1.0f, _550));  // [sem: blended]
      _584 = (lerp(_561, 1.2f, _550));  // [sem: blended]
    } else {
      _582 = 1.4f;  // [sem: blended]
      _583 = 1.0f;  // [sem: blended]
      _584 = ((saturate((_exposure2.x + -3.0f) * 0.14285715f) * 0.20000005f) + 1.0f);  // [sem: blended]
    }
    _585 = 1.0f - _584;
    _597 = ((exp2(log2(((saturate((_491 * _491) * _524) * _585) + _584) * _524) * _583) - _527) * _582) + _527;
    _609 = ((exp2(log2(((saturate((_507 * _507) * _525) * _585) + _584) * _525) * _583) - _527) * _582) + _527;
    _621 = ((exp2(log2(((saturate((_523 * _523) * _526) * _585) + _584) * _526) * _583) - _527) * _582) + _527;
    _628 = saturate(exp2(log2(mad(_621, -0.09902974f, mad(_609, -0.09802088f, (_597 * 1.196879f)))) * 2.2f));  // [sem: expr_sat]
    _635 = saturate(exp2(log2(mad(_621, -0.098961174f, mad(_609, 1.1519032f, (_597 * -0.052896854f)))) * 2.2f));  // [sem: expr_sat]
    _642 = saturate(exp2(log2(mad(_621, 1.1510737f, mad(_609, -0.09804345f, (_597 * -0.052971635f)))) * 2.2f));  // [sem: expr_sat]
  ...
  if (_etcParams.y > 1.0f) {
    ...
    _749 = saturate(1.0f - (saturate(_etcParams.y + -1.0f) * dot(float2(_740, _743), float2(_740, _743))));  // [sem: expr_sat]
    _754 = (_749 * _733);
    _755 = (_749 * _734);
    _756 = (_749 * _735);
  } else {
