...
float4 main(
  ...
  if (_888) {
    ...
    float3 _rndx_tonemapped_color = TonemapReplacer(float3(_863, _867, _871));
    _1136 = _rndx_tonemapped_color.x;
    _1143 = _rndx_tonemapped_color.y;
    _1150 = _rndx_tonemapped_color.z;
