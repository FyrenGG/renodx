...
float4 main(
  ...
  _455 = saturate(_etcParams.w);
  _458 = (_454 * saturate(_rndx_tonemapped_color.x)) + _455;
  _461 = (_454 * saturate(_rndx_tonemapped_color.y)) + _455;
  _464 = (_454 * saturate(_rndx_tonemapped_color.z)) + _455;
  ...
  _567 = saturate(1.0f - ((_postProcessParams.x * CUSTOM_VIGNETTE * _557) * dot(float2(_558, _560), float2(_558, _560))));  // [sem: expr_sat]
