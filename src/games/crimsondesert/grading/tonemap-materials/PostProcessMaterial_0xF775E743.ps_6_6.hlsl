...
float4 main(
  ...
  _37 = (uint)(SV_Position.y);
  if (_etcParams.y == 1.0f) {
    _54 = (((float)((uint)((uint)((((uint2)(__3__36__0__0__g_stencil.Load(int3(((int)((uint)(SV_Position.x))), _37, 0)))).x) & 127)))) + 0.5f);
  } else {
    _54 = _postProcessParams.x;
  }
  _57 = (_localToneMappingParams.w > 0.0f);
  if (_57) {
    _63 = _exposure0.x * _userImageAdjust.z;
    _82 = exp2(_powerParams.x * log2(max(0.0f, (((_63 * max(0.0f, (((_33.x * 1.70505f) - (_33.y * 0.62179f)) - (_33.z * 0.08326f)))) * _slopeParams.x) + _offsetParams.x))));
    _98 = exp2(log2(max(0.0f, (((_slopeParams.y * _63) * max(0.0f, (((_33.y * 1.1408f) - (_33.x * 0.13026f)) - (_33.z * 0.01055f)))) + _offsetParams.y))) * _powerParams.y);
    _114 = exp2(log2(max(0.0f, (((_slopeParams.z * _63) * max(0.0f, (((_33.x * -0.024f) - (_33.y * 0.12897f)) + (_33.z * 1.15297f)))) + _offsetParams.z))) * _powerParams.z);
  ...
  if (_57 && (_etcParams.z > 0.0f)) {
    _463 = select((_433 <= 0.0031308f), (_433 * 12.92f), (((pow(_433, 0.41666666f)) * 1.055f) + -0.055f));
