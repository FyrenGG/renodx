...
float4 main(
  ...
  _601 = saturate(_etcParams.w);
  _602 = (_597 * saturate(_rndx_tonemapped_color.x)) + _601;
  _603 = (_597 * saturate(_rndx_tonemapped_color.y)) + _601;
  _604 = (_597 * saturate(_rndx_tonemapped_color.z)) + _601;
  ...
  _671 = 2.200000047683716f / ((min(max(_userImageAdjust.w, -1.0f), 1.0f) * 0.800000011920929f) + 2.200000047683716f);
  _682 = (TEXCOORD.x * 2.0f) + -1.0f;
  _683 = TEXCOORD.y * 2.0f;
  _684 = 1.0f - _683;
  _712 = mad((_projToPrevProj[2].w), 1.0000000116860974e-07f, mad((_projToPrevProj[1].w), _684, ((_projToPrevProj[0].w) * _682))) + (_projToPrevProj[3].w);
  _715 = ((mad((_projToPrevProj[2].x), 1.0000000116860974e-07f, mad((_projToPrevProj[1].x), _684, ((_projToPrevProj[0].x) * _682))) + (_projToPrevProj[3].x)) / _712) - _682;
  _716 = ((mad((_projToPrevProj[2].y), 1.0000000116860974e-07f, mad((_projToPrevProj[1].y), _684, ((_projToPrevProj[0].y) * _682))) + (_projToPrevProj[3].y)) / _712) - _684;
  ...
  _732 = abs(_682);
  _733 = abs(_683 + -1.0f);
  _737 = saturate(1.0f - ((_729 * _postProcessParams.x * CUSTOM_VIGNETTE) * dot(float2(_732, _733), float2(_732, _733))));  // [sem: expr_sat]
