...
float4 main(
  ...
  _2773 = 2.200000047683716f / ((min(max(_userImageAdjust.w, -1.0f), 1.0f) * 0.800000011920929f) + 2.200000047683716f);
  _2784 = (TEXCOORD.x * 2.0f) + -1.0f;
  _2785 = TEXCOORD.y * 2.0f;
  _2786 = 1.0f - _2785;
  _2814 = mad((_projToPrevProj[2].w), 1.0000000116860974e-07f, mad((_projToPrevProj[1].w), _2786, ((_projToPrevProj[0].w) * _2784))) + (_projToPrevProj[3].w);
  _2817 = ((mad((_projToPrevProj[2].x), 1.0000000116860974e-07f, mad((_projToPrevProj[1].x), _2786, ((_projToPrevProj[0].x) * _2784))) + (_projToPrevProj[3].x)) / _2814) - _2784;
  _2818 = ((mad((_projToPrevProj[2].y), 1.0000000116860974e-07f, mad((_projToPrevProj[1].y), _2786, ((_projToPrevProj[0].y) * _2784))) + (_projToPrevProj[3].y)) / _2814) - _2786;
