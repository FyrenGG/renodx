...
float4 main(
  ...
  _81 = WaveReadLaneFirst(BindlessParameters_PostProcessLensFlareForGimmick_CD[((int)((uint)(select(((uint)_73 < (uint)170000), _73, 0)) + 0u))].BindlessParameters_PostProcessLensFlareForGimmick_CD._fishEyeIntensity);
  ...
  _151 = WaveReadLaneFirst(BindlessParameters_PostProcessLensFlareForGimmick_CD[((int)((uint)(select(((uint)_143 < (uint)170000), _143, 0)) + 0u))].BindlessParameters_PostProcessLensFlareForGimmick_CD._useFishUV);
  _152 = (_151 == 1.0f);
  _155 = select(_152, _140, TEXCOORD.x) + -0.5f;
  _156 = select(_152, (_141 * _89), TEXCOORD.y) + -0.5f;
  _157 = _155 * _72;
  _197 = mad((_viewProj[2].w), _questGuideWorldPosition.z, mad((_viewProj[1].w), _questGuideWorldPosition.y, ((_viewProj[0].w) * _questGuideWorldPosition.x))) + (_viewProj[3].w);
  _200 = (mad((_viewProj[2].z), _questGuideWorldPosition.z, mad((_viewProj[1].z), _questGuideWorldPosition.y, ((_viewProj[0].z) * _questGuideWorldPosition.x))) + (_viewProj[3].z)) / _197;
  _201 = ((mad((_viewProj[2].y), _questGuideWorldPosition.z, mad((_viewProj[1].y), _questGuideWorldPosition.y, ((_viewProj[0].y) * _questGuideWorldPosition.x))) + (_viewProj[3].y)) / _197) * -0.5f;
  _203 = (_72 * 0.5f) * ((mad((_viewProj[2].x), _questGuideWorldPosition.z, mad((_viewProj[1].x), _questGuideWorldPosition.y, ((_viewProj[0].x) * _questGuideWorldPosition.x))) + (_viewProj[3].x)) / _197);
  if ((!(abs(_questGuideWorldPosition.x) <= 9.999999747378752e-06f)) || ((!(!(abs(_questGuideWorldPosition.x) <= 9.999999747378752e-06f))) && (!(abs(_questGuideWorldPosition.y) <= 9.999999747378752e-06f)))) {
    if (!((_201 >= 1.0499999523162842f) || ((_201 <= -1.5f) || ((_203 >= 1.600000023841858f) || ((_203 <= -1.600000023841858f) || ((_200 < 0.0f) || (_203 <= -1.5f))))))) {
      ...
      _246 = (_237 < 0.0f);
      _249 = _246 && _243;
      _250 = select(_249, (_240 + -3.1415927410125732f), select((_245 && _243), (_240 + 3.1415927410125732f), _240));
      _251 = _246 && _244;
      _253 = _245 && _244;
      _254 = select(_253, 1.5707963705062866f, select(_251, -1.5707963705062866f, _250));
      _258 = sqrt((_238 * _238) + (_237 * _237));
      _275 = WaveReadLaneFirst(_materialIndex);
      _283 = WaveReadLaneFirst(BindlessParameters_PostProcessLensFlareForGimmick_CD[((int)((uint)(select(((uint)_275 < (uint)170000), _275, 0)) + 0u))].BindlessParameters_PostProcessLensFlareForGimmick_CD._sunFlareWeightIntensity);
      _285 = WaveReadLaneFirst(_materialIndex);
      _293 = WaveReadLaneFirst(BindlessParameters_PostProcessLensFlareForGimmick_CD[((int)((uint)(select(((uint)_285 < (uint)170000), _285, 0)) + 0u))].BindlessParameters_PostProcessLensFlareForGimmick_CD._sunFlareWeightThreshold);
      _299 = _203 - _157;
      _300 = _201 - _156;
      _305 = WaveReadLaneFirst(_materialIndex);
      _313 = WaveReadLaneFirst(BindlessParameters_PostProcessLensFlareForGimmick_CD[((int)((uint)(select(((uint)_305 < (uint)170000), _305, 0)) + 0u))].BindlessParameters_PostProcessLensFlareForGimmick_CD._sunFlareScale);
      _316 = max((0.019999999552965164f / (_313 * sqrt((_300 * _300) + (_299 * _299)))), 0.0f);
      _317 = _316 * _316;
      _328 = WaveReadLaneFirst(_materialIndex);
      _336 = WaveReadLaneFirst(BindlessParameters_PostProcessLensFlareForGimmick_CD[((int)((uint)(select(((uint)_328 < (uint)170000), _328, 0)) + 0u))].BindlessParameters_PostProcessLensFlareForGimmick_CD._sunFlareAnimSpeed);
      _337 = _336 * _time.x;
      _339 = WaveReadLaneFirst(_materialIndex);
      _347 = WaveReadLaneFirst(BindlessParameters_PostProcessLensFlareForGimmick_CD[((int)((uint)(select(((uint)_339 < (uint)170000), _339, 0)) + 0u))].BindlessParameters_PostProcessLensFlareForGimmick_CD._noiseTex);
      _354 = __0__7__0__0__g_bindlessTextures[((int)((uint)(select(((uint)_347 < (uint)65000), _347, 0)) + 0u))].Sample(__0__4__0__0__g_staticBilinearWrap, float2((((sin((_254 * 2.0f) + _203) * 4.0f) - cos((_254 * 3.0f) + _201)) + _337), _337));
      _362 = 1.0f / exp2((_258 * 1.4426950216293335f) * ((frac(_354.x) * 0.6600000262260437f) + 0.33000001311302185f));
      _365 = frac((_362 * 20.0f) + 1.0031249523162842f);
      _372 = exp2(log2(1.0f - abs((_362 * 2.0f) + -1.0f)) * 0.30000001192092896f);
      _409 = sin(select(_253, 6.2831854820251465f, select(_251, -6.2831854820251465f, (_250 * 4.0f))));
      _410 = _409 * _237;
      _411 = _409 * _238;
      _430 = exp2(log2(((saturate(_362 + -0.8999999761581421f) * 3.0f) + exp2(log2(1.0f - saturate(sqrt((_410 * _410) + (_411 * _411)))) * 8.0f)) * _362) * 12.949999809265137f) * (_362 * 0.4999999701976776f);
      _434 = WaveReadLaneFirst(_materialIndex);
      _442 = WaveReadLaneFirst(BindlessParameters_PostProcessLensFlareForGimmick_CD[((int)((uint)(select(((uint)_434 < (uint)170000), _434, 0)) + 0u))].BindlessParameters_PostProcessLensFlareForGimmick_CD._noiseTex);
      _446 = exp2(log2(_258 * 16.0f) * 0.5f);
      _450 = atan(_238 / _237);
      _453 = (_237 == 0.0f);
      _454 = (_238 >= 0.0f);
      _471 = __0__7__0__0__g_bindlessTextures[((int)((uint)(select(((uint)_442 < (uint)65000), _442, 0)) + 0u))].Sample(__0__4__0__0__g_staticBilinearWrap, float2(select((_453 && _454), 2.356194496154785f, select((_453 && _243), -2.356194496154785f, (select(_249, (_450 + -3.1415927410125732f), select((_246 && _454), (_450 + 3.1415927410125732f), _450)) * 1.5f))), ((_time.x * 0.20000000298023224f) - _446)));
      _478 = atan((-0.0f - _238) / (-0.0f - _237));
      _481 = (_237 > -0.0f);
      _482 = (_237 == -0.0f);
      _483 = (_238 <= -0.0f);
      _484 = (_238 > -0.0f);
      _499 = __0__7__0__0__g_bindlessTextures[((int)((uint)(select(((uint)_442 < (uint)65000), _442, 0)) + 0u))].Sample(__0__4__0__0__g_staticBilinearWrap, float2(select((_482 && _483), 2.356194496154785f, select((_482 && _484), -2.356194496154785f, (select((_481 && _484), (_478 + -3.1415927410125732f), select((_481 && _483), (_478 + 3.1415927410125732f), _478)) * 1.5f))), ((_time.x * 0.20000000298023224f) - (_446 * 0.5f))));
      _524 = exp2(log2(min(max((1.0f - (_258 * 2.0f)), 0.0f), 1.0f)) * 5.199999809265137f);
      _535 = exp2(log2(min(max((1.100000023841858f - (_258 * 4.0f)), 0.0f), 1.0f)) * 4.199999809265137f) * 0.10000000149011612f;
      _550 = (((pow(_258, 0.10000000149011612f)) * 0.10000000149011612f) + 0.800000011920929f) + (sin(_354.x * 8.0f) * 0.20000000298023224f);
      _560 = (exp2(log2(saturate(1.0f - (_283 * sqrt((_155 * _155) + (_156 * _156))))) * _293) * 150.0f) * _exposure2.x;
      _564 = WaveReadLaneFirst(_materialIndex);
      _572 = WaveReadLaneFirst(BindlessParameters_PostProcessLensFlareForGimmick_CD[((int)((uint)(select(((uint)_564 < (uint)170000), _564, 0)) + 0u))].BindlessParameters_PostProcessLensFlareForGimmick_CD._lensDirtTexture);
      _579 = __0__7__0__0__g_bindlessTextures[((int)((uint)(select(((uint)_572 < (uint)65000), _572, 0)) + 0u))].Sample(__0__4__0__0__g_staticBilinearWrap, float2(TEXCOORD.x, TEXCOORD.y));
      _583 = WaveReadLaneFirst(_materialIndex);
      _591 = WaveReadLaneFirst(BindlessParameters_PostProcessLensFlareForGimmick_CD[((int)((uint)(select(((uint)_583 < (uint)170000), _583, 0)) + 0u))].BindlessParameters_PostProcessLensFlareForGimmick_CD._lensDirtThreshold);
      _604 = WaveReadLaneFirst(_materialIndex);
      _612 = WaveReadLaneFirst(BindlessParameters_PostProcessLensFlareForGimmick_CD[((int)((uint)(select(((uint)_604 < (uint)170000), _604, 0)) + 0u))].BindlessParameters_PostProcessLensFlareForGimmick_CD._lensDirtIntensity);
      _634 = ((_viewDir.y + _viewDir.x) * 33.60000228881836f) + (TEXCOORD.x * 0.10000000149011612f);
      _638 = frac(sin(floor(_634)) * 43758.546875f);
      _649 = WaveReadLaneFirst(_materialIndex);
      _657 = WaveReadLaneFirst(BindlessParameters_PostProcessLensFlareForGimmick_CD[((int)((uint)(select(((uint)_649 < (uint)170000), _649, 0)) + 0u))].BindlessParameters_PostProcessLensFlareForGimmick_CD._lensflareRatio);
      _659 = _657 * (((((frac(_634) * (frac(sin(ceil(_634)) * 43758.546875f) - _638)) + _638) * 0.6499999761581421f) + 0.3499999940395355f) * (((float4)(__3__36__0__0__g_postProcessSizeColor.Sample(__0__4__0__0__g_staticBilinearClamp, float2(TEXCOORD.x, TEXCOORD.y)))).w));
      _670 = (((_659 * (((((((_535 + (_524 * exp2(log2(saturate(max(_471.x, _499.x))) * 4.0f))) * 5.599999904632568f) + (_430 * (((min(max((abs((frac(_365 + 1.0f) * 6.0f) + -3.0f) + -1.0f), 0.0f), 1.0f) + -1.0f) * _372) + 1.0f))) * _550) + _317) * _560) + (((float4)(__3__36__0__0__g_postProcessSizeColor.Sample(__0__4__0__0__g_staticBilinearClamp, float2((TEXCOORD.x - _49), (TEXCOORD.y - _51))))).x))) * saturate((_612 * (saturate(pow(_579.x, _591)) + -1.0f)) + 1.0f)) + _65.x);
      _671 = (((_659 * (((((((_535 + (_524 * exp2(log2(saturate(max(_471.y, _499.y))) * 4.0f))) * 5.599999904632568f) + (_430 * (((min(max((abs((frac(_365 + 0.6666666865348816f) * 6.0f) + -3.0f) + -1.0f), 0.0f), 1.0f) + -1.0f) * _372) + 1.0f))) * _550) + _317) * _560) + (((float4)(__3__36__0__0__g_postProcessSizeColor.Sample(__0__4__0__0__g_staticBilinearClamp, float2(TEXCOORD.x, TEXCOORD.y)))).y))) * saturate((_612 * (saturate(pow(_579.y, _591)) + -1.0f)) + 1.0f)) + _65.y);
      _672 = (((_659 * (((((((_535 + (_524 * exp2(log2(saturate(max(_471.z, _499.z))) * 4.0f))) * 7.0f) + (_430 * (((min(max((abs((frac(_365 + 0.3333333432674408f) * 6.0f) + -3.0f) + -1.0f), 0.0f), 1.0f) + -1.0f) * _372) + 1.0f))) * _550) + _317) * _560) + (((float4)(__3__36__0__0__g_postProcessSizeColor.Sample(__0__4__0__0__g_staticBilinearClamp, float2((_49 + TEXCOORD.x), (_51 + TEXCOORD.y))))).z))) * saturate((_612 * (saturate(pow(_579.z, _591)) + -1.0f)) + 1.0f)) + _65.z);
    } else {
      _670 = _65.x;
      _671 = _65.y;
      _672 = _65.z;
  ...
  if (_689) {
    ...
    if (_etcParams.z == 0.0f) {
      ...
      _1031 = 2.200000047683716f / ((min(max(_userImageAdjust.w, -1.0f), 1.0f) * 0.800000011920929f) + 2.200000047683716f);
