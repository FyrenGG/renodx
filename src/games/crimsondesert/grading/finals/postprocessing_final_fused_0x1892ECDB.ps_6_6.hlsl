...
float4 main(
  ...
  _163 = 1.0f - abs(_etcParams.w);
  _167 = saturate(_etcParams.w);
  _168 = (_163 * saturate(_rndx_tonemapped_color.x)) + _167;
  _169 = (_163 * saturate(_rndx_tonemapped_color.y)) + _167;
  _170 = (_163 * saturate(_rndx_tonemapped_color.z)) + _167;
  // RenoDX: <<< [Patch: FusedFinalFadeRestore]
  if (_colorGradingParams.w > 0.0f) {
    _175 = saturate(_colorGradingParams.w);  // [sem: expr_sat]
    _192 = (((max(0.0f, (1.0f - _168)) - _168) * _175) + _168);
    _193 = (((max(0.0f, (1.0f - _169)) - _169) * _175) + _169);
    _194 = (((max(0.0f, (1.0f - _170)) - _170) * _175) + _170);
  } else {
    _192 = _168;
    _193 = _169;
    _194 = _170;
  }
  _200 = _userImageAdjust.y + 1.0f;
  _204 = _userImageAdjust.x + 0.5f;
  _205 = ((_192 + -0.5f) * _200) + _204;
  _206 = ((_193 + -0.5f) * _200) + _204;
  _207 = ((_194 + -0.5f) * _200) + _204;
  _237 = 2.200000047683716f / ((min(max(_userImageAdjust.w, -1.0f), 1.0f) * 0.800000011920929f) + 2.200000047683716f);
  _248 = (TEXCOORD.x * 2.0f) + -1.0f;
  _249 = TEXCOORD.y * 2.0f;
  _250 = 1.0f - _249;
  _278 = mad((_projToPrevProj[2].w), 1.0000000116860974e-07f, mad((_projToPrevProj[1].w), _250, ((_projToPrevProj[0].w) * _248))) + (_projToPrevProj[3].w);
  _281 = ((mad((_projToPrevProj[2].x), 1.0000000116860974e-07f, mad((_projToPrevProj[1].x), _250, ((_projToPrevProj[0].x) * _248))) + (_projToPrevProj[3].x)) / _278) - _248;
  _282 = ((mad((_projToPrevProj[2].y), 1.0000000116860974e-07f, mad((_projToPrevProj[1].y), _250, ((_projToPrevProj[0].y) * _248))) + (_projToPrevProj[3].y)) / _278) - _250;
  if (_localToneMappingParams.w > 0.0f) {
    _296 = saturate(1.0f - (sqrt((_282 * _282) + (_281 * _281)) * 2.0f));  // [sem: expr_sat]
  } else {
    _296 = 1.0f;  // [sem: expr_sat]
  }
  _299 = abs(_248);
  _300 = abs(_249 + -1.0f);
  _304 = saturate(1.0f - ((_296 * _postProcessParams.x * CUSTOM_VIGNETTE) * dot(float2(_299, _300), float2(_299, _300))));  // [sem: expr_sat]
  if (!(SV_Position.y < _viewDir.w)) {
    if (!(SV_Position.y >= (_screenSizeAndInvSize.y - _viewDir.w))) {
      _318 = (_304 * exp2(log2(saturate(mad(_colorBlind0.z, _207, mad(_colorBlind0.y, _206, (_colorBlind0.x * _205))))) * _237));
      _319 = (_304 * exp2(log2(saturate(mad(_colorBlind1.z, _207, mad(_colorBlind1.y, _206, (_colorBlind1.x * _205))))) * _237));
      _320 = (_304 * exp2(log2(saturate(mad(_colorBlind2.z, _207, mad(_colorBlind2.y, _206, (_colorBlind2.x * _205))))) * _237));
    } else {
      _318 = 0.0f;
      _319 = 0.0f;
      _320 = 0.0f;
