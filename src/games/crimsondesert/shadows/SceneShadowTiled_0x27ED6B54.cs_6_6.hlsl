...
void main(
  ...
  if ((_83 < 1e-07f) || _110) {
    ...
    if (_5146 > 0.0f) {
      ...
      _5280 = ((abs(_5171) * (select(_5152, 12.0f, 2.0f) - _5153)) + _5153) * select(_168, 0.01f, 0.1f);
      if (!_168) {
      ...
      if (_84 == 15) {
        _5478 = ((10.0f - (saturate(_119 * 0.001f) * 9.0f)) * _5469);
      } else {
        _5478 = _5469;
      }
      if (!_5304) {
      ...
      if (_119 < 8.0f) {
        ...
        while(true) {
          ...
          _5661 = __3__36__0__0__g_depthStencil.Load(int3(((int)(_bufferSizeAndInvSize.x * min(max(_5648, _5626), (1.0f - _5626)))), ((int)(_bufferSizeAndInvSize.y * _5647)), 0));
          ...
          if (!(_5727 == 0)) {
            ...
            // [sem: expr_sat]
            _5771 = saturate(((saturate(1.0f - ((_5756 * _5756) * _5751)) * (1.0f - _5641)) * saturate((-0.0f - _5676) / (_5645 * 0.0046548597f))) + _5641);
            _5772 = _5667;
          } else {
        ...
        while(true) {
          // [sem: _3__36__0__0__g_depthStencil_load]
          _5836 = __3__36__0__0__g_depthStencil.Load(int3(((int)(_bufferSizeAndInvSize.x * min(max(_5821, _5626), (1.0f - _5626)))), ((int)(_bufferSizeAndInvSize.y * _5820)), 0));
          ...
          if (!(_5902 == 0)) {
            ...
            // [sem: expr_sat]
            _5946 = saturate(((saturate(1.0f - ((_5931 * _5931) * _5926)) * (1.0f - _5816)) * saturate((-0.0f - _5851) / (_5822 * 0.0046548597f))) + _5816);
            _5947 = _5842;
          } else {
            _5946 = _5816;  // [sem: expr_sat]
            _5947 = _5818;
          }
          if ((_5842 != 0) && (_5946 > 0.95f)) {
            if (!_5843) {
