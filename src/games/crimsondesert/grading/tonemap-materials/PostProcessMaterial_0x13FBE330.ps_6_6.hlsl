...
float4 main(
  ...
  if (_752) {
    _758 = _exposure0.x * _userImageAdjust.z;
    _777 = exp2(_powerParams.x * log2(max(0.0f, (((_758 * max(0.0f, (((_732 * -0.62179f) - (_735 * 0.08326f)) + (_729 * 1.70505f)))) * _slopeParams.x) + _offsetParams.x))));
    _793 = exp2(log2(max(0.0f, (((_slopeParams.y * _758) * max(0.0f, (((_732 * 1.1408f) - (_735 * 0.01055f)) - (_729 * 0.13026f)))) + _offsetParams.y))) * _powerParams.y);
    _809 = exp2(log2(max(0.0f, (((_slopeParams.z * _758) * max(0.0f, (((_735 * 1.15297f) - (_732 * 0.12897f)) - (_729 * 0.024f)))) + _offsetParams.z))) * _powerParams.z);
    _810 = dot(float3(_777, _793, _809), float3(0.212671f, 0.71516f, 0.072169f));
    _814 = ((_777 - _810) * _powerParams.w) + _810;
    _817 = ((_793 - _810) * _powerParams.w) + _810;
    _820 = ((_809 - _810) * _powerParams.w) + _810;
    _827 = min(max(log2(mad(_820, 0.079223745f, mad(_817, 0.0784336f, (_814 * 0.84247905f)))), -12.47393f), 4.026069f) + 12.47393f;
    _834 = min(max(log2(mad(_820, 0.07916613f, mad(_817, 0.87846863f, (_814 * 0.042328242f)))), -12.47393f), 4.026069f) + 12.47393f;
    _841 = min(max(log2(mad(_820, 0.879143f, mad(_817, 0.0784336f, (_814 * 0.042375654f)))), -12.47393f), 4.026069f) + 12.47393f;
    _842 = _827 * 0.060606062f;
    _843 = _834 * 0.060606062f;
    _844 = _841 * 0.060606062f;
    _845 = _842 * _842;
    _846 = _843 * _843;
    _847 = _844 * _844;
    _863 = min(0.0f, (-0.0f - (((_827 * 0.0072181816f) + ((_845 * 0.4298f) + (((_845 * _845) * ((31.96f - (_827 * 2.4327273f)) + (_845 * 15.5f))) - ((_827 * 0.41624245f) * _845)))) + -0.00232f)));
    _879 = min(0.0f, (-0.0f - (((_834 * 0.0072181816f) + ((_846 * 0.4298f) + (((_846 * _846) * ((31.96f - (_834 * 2.4327273f)) + (_846 * 15.5f))) - ((_834 * 0.41624245f) * _846)))) + -0.00232f)));
    _895 = min(0.0f, (-0.0f - (((_841 * 0.0072181816f) + ((_847 * 0.4298f) + (((_847 * _847) * ((31.96f - (_841 * 2.4327273f)) + (_847 * 15.5f))) - ((_841 * 0.41624245f) * _847)))) + -0.00232f)));
    _896 = -0.0f - _863;
    _897 = -0.0f - _879;
    _898 = -0.0f - _895;
    _899 = dot(float3(_896, _897, _898), float3(0.2126f, 0.7152f, 0.0722f));
    if (_nightToneParm == 1) {
      _916 = exp2(exp2(log2(abs((_time.w * 0.11666667f) + -1.4f)) * 8.0f) * -1.442695f) + 1.0f;
      _917 = -0.79999995f / _916;
      _918 = -1.2f / _916;
      _919 = 0.20000005f / _916;
      _922 = saturate((_exposure2.x + -0.6f) * 0.10638298f);  // [sem: expr_sat]
      _925 = saturate((_exposure2.x + -0.1f) * 2.0f);  // [sem: expr_sat]
      _929 = (_917 + 1.4f) + (_925 * (-0.39999998f - _917));
      _933 = (_918 + 1.6f) + (_925 * (-0.6f - _918));
      _937 = (_919 + 0.9f) + (_925 * (0.5f - _919));
      _954 = (lerp(_937, 1.4f, _922));  // [sem: blended]
      _955 = (lerp(_929, 1.0f, _922));  // [sem: blended]
      _956 = (lerp(_933, 1.2f, _922));  // [sem: blended]
    } else {
      _954 = 1.4f;  // [sem: blended]
      _955 = 1.0f;  // [sem: blended]
      _956 = ((saturate((_exposure2.x + -3.0f) * 0.14285715f) * 0.20000005f) + 1.0f);  // [sem: blended]
    }
    _957 = 1.0f - _956;
    _969 = ((exp2(log2(((saturate((_863 * _863) * _896) * _957) + _956) * _896) * _955) - _899) * _954) + _899;
    _981 = ((exp2(log2(((saturate((_879 * _879) * _897) * _957) + _956) * _897) * _955) - _899) * _954) + _899;
    _993 = ((exp2(log2(((saturate((_895 * _895) * _898) * _957) + _956) * _898) * _955) - _899) * _954) + _899;
    _1000 = saturate(exp2(log2(mad(_993, -0.09902974f, mad(_981, -0.09802088f, (_969 * 1.196879f)))) * 2.2f));  // [sem: expr_sat]
    _1007 = saturate(exp2(log2(mad(_993, -0.098961174f, mad(_981, 1.1519032f, (_969 * -0.052896854f)))) * 2.2f));  // [sem: expr_sat]
    _1014 = saturate(exp2(log2(mad(_993, 1.1510737f, mad(_981, -0.09804345f, (_969 * -0.052971635f)))) * 2.2f));  // [sem: expr_sat]
  ...
  if (_etcParams.y > 1.0f) {
    ...
    _1121 = saturate(1.0f - (saturate(_etcParams.y + -1.0f) * dot(float2(_1112, _1115), float2(_1112, _1115))));  // [sem: expr_sat]
    _1126 = (_1121 * _1105);
    _1127 = (_1121 * _1106);
    _1128 = (_1121 * _1107);
  } else {
