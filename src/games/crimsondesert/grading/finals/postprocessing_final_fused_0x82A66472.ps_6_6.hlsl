...
float4 main(
  ...
  _479 = saturate(_etcParams.w);
  _480 = (_475 * saturate(_rndx_tonemapped_color.x)) + _479;
  _481 = (_475 * saturate(_rndx_tonemapped_color.y)) + _479;
  _482 = (_475 * saturate(_rndx_tonemapped_color.z)) + _479;
  ...
  _549 = 2.200000047683716f / ((min(max(_userImageAdjust.w, -1.0f), 1.0f) * 0.800000011920929f) + 2.200000047683716f);
  _560 = (TEXCOORD.x * 2.0f) + -1.0f;
  _561 = TEXCOORD.y * 2.0f;
  _562 = 1.0f - _561;
  _590 = mad((_projToPrevProj[2].w), 1.0000000116860974e-07f, mad((_projToPrevProj[1].w), _562, ((_projToPrevProj[0].w) * _560))) + (_projToPrevProj[3].w);
  _593 = ((mad((_projToPrevProj[2].x), 1.0000000116860974e-07f, mad((_projToPrevProj[1].x), _562, ((_projToPrevProj[0].x) * _560))) + (_projToPrevProj[3].x)) / _590) - _560;
  _594 = ((mad((_projToPrevProj[2].y), 1.0000000116860974e-07f, mad((_projToPrevProj[1].y), _562, ((_projToPrevProj[0].y) * _560))) + (_projToPrevProj[3].y)) / _590) - _562;
  ...
  _611 = abs(_560);
  _612 = abs(_561 + -1.0f);
  _616 = saturate(1.0f - ((_608 * _postProcessParams.x * CUSTOM_VIGNETTE) * dot(float2(_611, _612), float2(_611, _612))));  // [sem: expr_sat]
