...
void main(
  ...
  // [sem: _3__36__0__0__g_dynamicShadowColorArray_sampleLod]
    ...
    if (_1272 > 0.0f) {
      ...
      // Description: SceneShadowTiledCS 0x4412E34E uses this native contact ray direction on Lighting High with RT disabled; stable direction keeps Contact Micro Shadows from inheriting per-frame random cone wobble when the feature is enabled.
