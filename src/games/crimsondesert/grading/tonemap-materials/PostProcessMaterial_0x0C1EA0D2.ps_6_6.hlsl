...
float4 main(
  ...
  while(true) {
    ...
    _53 = -6;
    while(true) {
      _60 = (_global_0[min((uint)((_48 + 6)), 12u)]) * (_global_0[min((uint)((_53 + 6)), 12u)]);
  // [sem: _3__36__0__0__g_postProcessSizeColor_sample]
      ...
      _119 = select(_115, ((_78 * 56493.91015625f) + _19.x), _19.x);
      _120 = select(_115, ((_79 * 56493.91015625f) + _19.y), _19.y);
      _121 = select(_115, ((_80 * 56493.91015625f) + _19.z), _19.z);
