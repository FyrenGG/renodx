...
float4 main(
  ...
  if (_746) {
    ...
    float3 _rndx_tonemapped_color = TonemapReplacer(float3(_729, _728, _727));
    _994 = _rndx_tonemapped_color.x;
    _1001 = _rndx_tonemapped_color.y;
    _1008 = _rndx_tonemapped_color.z;
