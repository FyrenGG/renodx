...
float4 main(
  ...
  _64 = mad((_invViewProj[2].w), _28, mad((_invViewProj[1].w), _27, ((_invViewProj[0].w) * _25))) + (_invViewProj[3].w);
  ...
  _81 = _78 - ((mad((_invViewProj[2].x), _28, mad((_invViewProj[1].x), _27, ((_invViewProj[0].x) * _25))) + (_invViewProj[3].x)) / _64);
  _83 = _80 - ((mad((_invViewProj[2].z), _28, mad((_invViewProj[1].z), _27, ((_invViewProj[0].z) * _25))) + (_invViewProj[3].z)) / _64);
  _84 = (_79 - ((mad((_invViewProj[2].y), _28, mad((_invViewProj[1].y), _27, ((_invViewProj[0].y) * _25))) + (_invViewProj[3].y)) / _64)) + 1.600000023841858f;
  ...
  if (_163) {
    ...
    if (_etcParams.z == 0.0f) {
      ...
      _504 = 2.200000047683716f / ((min(max(_userImageAdjust.w, -1.0f), 1.0f) * 0.800000011920929f) + 2.200000047683716f);
