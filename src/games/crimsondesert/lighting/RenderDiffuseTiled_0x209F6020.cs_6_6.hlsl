...
void main(
  ...
  if (!(((_122 && _124) && _126) && _128)) {
    ...
    _2612 = (((_2594 * 0.61312f) + (_2595 * 0.33951f)) + (_2596 * 0.04737f)) * _2400;
    _2613 = (((_2594 * 0.0702f) + (_2595 * 0.91636f)) + (_2596 * 0.01345f)) * _2400;
    _2614 = (((_2594 * 0.02062f) + (_2595 * 0.10958f)) + (_2596 * 0.8698f)) * _2400;
