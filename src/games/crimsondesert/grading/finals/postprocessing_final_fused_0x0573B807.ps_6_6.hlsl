...
float4 main(
  ...
  _591 = saturate(_etcParams.w);
  _592 = (_587 * saturate(_rndx_tonemapped_color.x)) + _591;
  _593 = (_587 * saturate(_rndx_tonemapped_color.y)) + _591;
  _594 = (_587 * saturate(_rndx_tonemapped_color.z)) + _591;
  ...
  _661 = 2.200000047683716f / ((min(max(_userImageAdjust.w, -1.0f), 1.0f) * 0.800000011920929f) + 2.200000047683716f);
  _672 = (TEXCOORD.x * 2.0f) + -1.0f;
  _673 = TEXCOORD.y * 2.0f;
  _674 = 1.0f - _673;
  _702 = mad((_projToPrevProj[2].w), 1.0000000116860974e-07f, mad((_projToPrevProj[1].w), _674, ((_projToPrevProj[0].w) * _672))) + (_projToPrevProj[3].w);
  _705 = ((mad((_projToPrevProj[2].x), 1.0000000116860974e-07f, mad((_projToPrevProj[1].x), _674, ((_projToPrevProj[0].x) * _672))) + (_projToPrevProj[3].x)) / _702) - _672;
  _706 = ((mad((_projToPrevProj[2].y), 1.0000000116860974e-07f, mad((_projToPrevProj[1].y), _674, ((_projToPrevProj[0].y) * _672))) + (_projToPrevProj[3].y)) / _702) - _674;
  ...
  _723 = abs(_672);
  _724 = abs(_673 + -1.0f);
  _728 = saturate(1.0f - ((_720 * _postProcessParams.x * CUSTOM_VIGNETTE) * dot(float2(_723, _724), float2(_723, _724))));  // [sem: expr_sat]
