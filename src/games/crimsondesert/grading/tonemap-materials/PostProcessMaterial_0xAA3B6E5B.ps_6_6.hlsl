...
float4 main(
  ...
  if (_573) {
    _579 = _userImageAdjust.z * _exposure0.x;
    _628 = exp2(log2(max(0.0f, (((_579 * max(0.0f, (((_554 * 1.70505f) - (_555 * 0.62179f)) - (_556 * 0.08326f)))) * _slopeParams.x) + _offsetParams.x))) * _powerParams.x);
    _629 = exp2(log2(max(0.0f, (((max(0.0f, (((_555 * 1.1408f) - (_554 * 0.13026f)) - (_556 * 0.01055f))) * _579) * _slopeParams.y) + _offsetParams.y))) * _powerParams.y);
    _630 = exp2(log2(max(0.0f, (((max(0.0f, (((_554 * -0.024f) - (_555 * 0.12897f)) + (_556 * 1.15297f))) * _579) * _slopeParams.z) + _offsetParams.z))) * _powerParams.z);
    _632 = dot(float3(_628, _629, _630), float3(0.212671f, 0.71516f, 0.072169f));
    _639 = ((_628 - _632) * _powerParams.w) + _632;
    _640 = ((_629 - _632) * _powerParams.w) + _632;
    _641 = ((_630 - _632) * _powerParams.w) + _632;
    _660 = min(max(log2(mad(_641, 0.079223745f, mad(_640, 0.0784336f, (_639 * 0.84247905f)))), -12.47393f), 4.026069f) + 12.47393f;
    _661 = min(max(log2(mad(_641, 0.07916613f, mad(_640, 0.87846863f, (_639 * 0.042328242f)))), -12.47393f), 4.026069f) + 12.47393f;
    _662 = min(max(log2(mad(_641, 0.879143f, mad(_640, 0.0784336f, (_639 * 0.042375654f)))), -12.47393f), 4.026069f) + 12.47393f;
    _663 = _660 * 0.060606062f;
    _664 = _661 * 0.060606062f;
    _665 = _662 * 0.060606062f;
    _666 = _663 * _663;
    _667 = _664 * _664;
    _668 = _665 * _665;
    _714 = min(0.0f, (-0.0f - (((_660 * 0.0072181816f) + ((_666 * 0.4298f) + (((_666 * _666) * ((31.96f - (_660 * 2.4327273f)) + (_666 * 15.5f))) - ((_660 * 0.41624245f) * _666)))) + -0.00232f)));
    ...
    _718 = -0.0f - _715;
    _719 = -0.0f - _716;
    _720 = dot(float3(_717, _718, _719), float3(0.2126f, 0.7152f, 0.0722f));
    if (_nightToneParm == 1) {
    ...
    _787 = 1.0f - _775;
    _812 = ((exp2(log2(((saturate((_714 * _714) * _717) * _787) + _775) * _717) * _776) - _720) * _777) + _720;
    _813 = ((exp2(log2(((saturate((_715 * _715) * _718) * _787) + _775) * _718) * _776) - _720) * _777) + _720;
    _814 = ((exp2(log2(((saturate((_716 * _716) * _719) * _787) + _775) * _719) * _776) - _720) * _777) + _720;
    _833 = saturate(exp2(log2(mad(_814, -0.09902974f, mad(_813, -0.09802088f, (_812 * 1.196879f)))) * 2.2f));  // [sem: expr_sat]
    _834 = saturate(exp2(log2(mad(_814, -0.098961174f, mad(_813, 1.1519032f, (_812 * -0.052896854f)))) * 2.2f));  // [sem: expr_sat]
    _835 = saturate(exp2(log2(mad(_814, 1.1510737f, mad(_813, -0.09804345f, (_812 * -0.052971635f)))) * 2.2f));  // [sem: expr_sat]
