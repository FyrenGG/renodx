...
float4 main(
  ...
  _696 = saturate(_etcParams.w);
  _705 = (_695 * saturate(_rndx_tonemapped_color.x)) + _696;
  _702 = (_695 * saturate(_rndx_tonemapped_color.y)) + _696;
  _699 = (_695 * saturate(_rndx_tonemapped_color.z)) + _696;
  ...
  _808 = saturate(1.0f - ((_postProcessParams.x * CUSTOM_VIGNETTE * _798) * dot(float2(_799, _801), float2(_799, _801))));  // [sem: expr_sat]
