...
float4 main(
  ...
  _66 = WaveReadLaneFirst(BindlessParameters_PostProcessAimHighlight_CD[((int)((uint)(select(((uint)_58 < (uint)170000), _58, 0)) + 0u))].BindlessParameters_PostProcessAimHighlight_CD._radius);
  _67 = WaveReadLaneFirst(_materialIndex);
  _75 = WaveReadLaneFirst(BindlessParameters_PostProcessAimHighlight_CD[((int)((uint)(select(((uint)_67 < (uint)170000), _67, 0)) + 0u))].BindlessParameters_PostProcessAimHighlight_CD._aimHighlightProgress);
  _78 = saturate(1.0f - _75) * _66;
  if (!(!(_78 >= 0.0010000000474974513f))) {
    _108 = WaveReadLaneFirst(_materialIndex);
    _116 = WaveReadLaneFirst(BindlessParameters_PostProcessAimHighlight_CD[((int)((uint)(select(((uint)_108 < (uint)170000), _108, 0)) + 0u))].BindlessParameters_PostProcessAimHighlight_CD._squareSize);
  ...
  _243 = WaveReadLaneFirst(BindlessParameters_PostProcessAimHighlight_CD[((int)((uint)(select(((uint)_235 < (uint)170000), _235, 0)) + 0u))].BindlessParameters_PostProcessAimHighlight_CD._noiseTex);
  _253 = WaveReadLaneFirst(_materialIndex);
  _261 = WaveReadLaneFirst(BindlessParameters_PostProcessAimHighlight_CD[((int)((uint)(select(((uint)_253 < (uint)170000), _253, 0)) + 0u))].BindlessParameters_PostProcessAimHighlight_CD._aimHighlightProgress);
  ...
  _292 = (((float)((uint)((uint)((uint)((uint)(_283.x)) >> 20)))) * 0.0004884005174972117f) + -1.0f;  // [sem: _3__36__0__0__g_CustomRenderPassValue_load_derived]
  _293 = (((float)((uint)((uint)(((uint)((uint)(_283.x)) >> 8) & 4095)))) * 0.0004884005174972117f) + -1.0f;  // [sem: _3__36__0__0__g_CustomRenderPassValue_load_derived]
  _295 = 1.0f - abs(_292);
  _296 = abs(_293);
  _297 = _295 - _296;
  if (!(_297 >= 0.0f)) {
  ...
  _318 = _316 * _313;
  _319 = _316 * _314;
  _322 = (_262 * 0.0005000000237487257f) + TEXCOORD.x;
  _323 = (_262 * 0.004999999888241291f) + TEXCOORD.y;
  // [sem: expr_sat]
  _358 = saturate(ceil(((_nearFarProj.x / max(1.0000000116860974e-07f, (((float)((uint)((uint)((((uint)(__3__36__0__0__g_depthOpaque.Load(int3((int)(uint((_bufferSizeAndInvSize.x * _322) + -0.5f)), (int)(uint((_bufferSizeAndInvSize.y * _323) + -0.5f)), 0)))).x) & 16777215)))) * 5.960465188081798e-08f))) + 0.10000000149011612f) - (_nearFarProj.x / max(1.0000000116860974e-07f, (((float4)(__3__36__0__0__g_CustomRenderPassDepth.Load(int3(int(_customRenderPassSizeInvSize.x * _322), int(_customRenderPassSizeInvSize.y * _323), 0)))).x)))));
  _367 = uint((_bufferSizeAndInvSize.x * ((_262 * 0.0002500000118743628f) + TEXCOORD.x)) + -0.5f);
  _368 = uint((_bufferSizeAndInvSize.y * ((_262 * 0.0024999999441206455f) + TEXCOORD.y)) + -0.5f);
  ...
  _391 = (saturate(_373.x * 1.0009784698486328f) * 2.0f) + -1.0f;  // [sem: _3__36__0__0__g_gbufferNormal_load_derived]
  _392 = (saturate(_373.y * 1.0009784698486328f) * 2.0f) + -1.0f;  // [sem: _3__36__0__0__g_gbufferNormal_load_derived]
  _393 = (saturate(_373.z * 1.0009784698486328f) * 2.0f) + -1.0f;  // [sem: _3__36__0__0__g_gbufferNormal_load_derived]
  _395 = rsqrt(dot(float3(_391, _392, _393), float3(_391, _392, _393)));  // [sem: invLength]
  _396 = _395 * _391;
  _397 = _395 * _392;
  _398 = _393 * _395;
  _401 = (((float)((uint)((uint)(((uint)((uint)(_370.w)) >> 8) & 255)))) * 0.007843137718737125f) + -1.0f;  // [sem: _3__36__0__0__g_gbufferBaseColor_load_derived]
  _402 = (((float)((uint)((uint)(_370.w & 255)))) * 0.007843137718737125f) + -1.0f;  // [sem: _3__36__0__0__g_gbufferBaseColor_load_derived]
  _405 = (_401 + _402) * 0.5f;
  _406 = (_401 - _402) * 0.5f;
  ...
  _463 = WaveReadLaneFirst(BindlessParameters_PostProcessAimHighlight_CD[((int)((uint)(select(((uint)_455 < (uint)170000), _455, 0)) + 0u))].BindlessParameters_PostProcessAimHighlight_CD._aimHighlightProgress);
  ...
  _481 = select((!(_358 == 0.0f)), _477, ((_477 * 0.25f) + 0.009999999776482582f));
  ...
  if (_507) {
    ...
    if (_etcParams.z == 0.0f) {
      ...
      _849 = 2.200000047683716f / ((min(max(_userImageAdjust.w, -1.0f), 1.0f) * 0.800000011920929f) + 2.200000047683716f);
  ...
  if (_507 && (_etcParams.z > 0.0f)) {
    _910 = select((_878 <= 0.0031308000907301903f), (_878 * 12.920000076293945f), (((pow(_878, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f));
    _911 = select((_879 <= 0.0031308000907301903f), (_879 * 12.920000076293945f), (((pow(_879, 0.4166666567325592f)) * 1.0549999475479126f) + -0.054999999701976776f));
