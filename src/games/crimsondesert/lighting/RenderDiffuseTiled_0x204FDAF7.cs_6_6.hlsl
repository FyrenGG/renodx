...
void main(
  ...
  if (!(((_132 && _134) && _136) && _138)) {
    ...
    _5161 = _5155 * (((_4934 * 0.61312f) + (_4940 * 0.33951f)) + (_4946 * 0.04737f));
    _5167 = _5155 * (((_4934 * 0.0702f) + (_4940 * 0.91636f)) + (_4946 * 0.01345f));
    _5173 = _5155 * (((_4934 * 0.02062f) + (_4940 * 0.10958f)) + (_4946 * 0.8698f));
    _5174 = _5152 - _1031;
    _5175 = _5151 - _1032;
    _5176 = _5150 - _1033;
