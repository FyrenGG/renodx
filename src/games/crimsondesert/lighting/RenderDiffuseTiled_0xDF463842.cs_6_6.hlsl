...
void main(
  ...
  if (!(((_121 && _123) && _125) && _127)) {
    ...
    _3342 = (((_3241 * 0.61312f) + (_3242 * 0.33951f)) + (_3243 * 0.04737f)) * _3341;
    _3343 = (((_3241 * 0.0702f) + (_3242 * 0.91636f)) + (_3243 * 0.01345f)) * _3341;
    _3344 = (((_3241 * 0.02062f) + (_3242 * 0.10958f)) + (_3243 * 0.8698f)) * _3341;
    _3345 = _3338 - _1113;
    _3346 = _3339 - _1115;
    _3347 = _3340 - _1117;
