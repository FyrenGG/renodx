...
float4 main(
  ...
  _489 = saturate(_etcParams.w);
  _490 = (_485 * saturate(_rndx_tonemapped_color.x)) + _489;
  _491 = (_485 * saturate(_rndx_tonemapped_color.y)) + _489;
  _492 = (_485 * saturate(_rndx_tonemapped_color.z)) + _489;
  ...
  _559 = 2.200000047683716f / ((min(max(_userImageAdjust.w, -1.0f), 1.0f) * 0.800000011920929f) + 2.200000047683716f);
  _570 = (TEXCOORD.x * 2.0f) + -1.0f;
  _571 = TEXCOORD.y * 2.0f;
  _572 = 1.0f - _571;
  _600 = mad((_projToPrevProj[2].w), 1.0000000116860974e-07f, mad((_projToPrevProj[1].w), _572, ((_projToPrevProj[0].w) * _570))) + (_projToPrevProj[3].w);
  _603 = ((mad((_projToPrevProj[2].x), 1.0000000116860974e-07f, mad((_projToPrevProj[1].x), _572, ((_projToPrevProj[0].x) * _570))) + (_projToPrevProj[3].x)) / _600) - _570;
  _604 = ((mad((_projToPrevProj[2].y), 1.0000000116860974e-07f, mad((_projToPrevProj[1].y), _572, ((_projToPrevProj[0].y) * _570))) + (_projToPrevProj[3].y)) / _600) - _572;
  ...
  _620 = abs(_570);
  _621 = abs(_571 + -1.0f);
  _625 = saturate(1.0f - ((_617 * _postProcessParams.x * CUSTOM_VIGNETTE) * dot(float2(_620, _621), float2(_620, _621))));  // [sem: expr_sat]
