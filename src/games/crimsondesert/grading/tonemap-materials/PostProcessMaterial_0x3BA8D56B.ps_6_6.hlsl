...
float4 main(
  ...
  _28 = max(1.0000000116860974e-07f, _26.x);  // [sem: _3__36__0__0__g_depth_sample_derived]
  _64 = mad((_invViewProjRelative[2].w), _28, mad((_invViewProjRelative[1].w), _23, ((_invViewProjRelative[0].w) * _21))) + (_invViewProjRelative[3].w);
  _68 = -0.0f - ((mad((_invViewProjRelative[2].x), _28, mad((_invViewProjRelative[1].x), _23, ((_invViewProjRelative[0].x) * _21))) + (_invViewProjRelative[3].x)) / _64);
  _69 = -0.0f - ((mad((_invViewProjRelative[2].y), _28, mad((_invViewProjRelative[1].y), _23, ((_invViewProjRelative[0].y) * _21))) + (_invViewProjRelative[3].y)) / _64);
  _70 = -0.0f - ((mad((_invViewProjRelative[2].z), _28, mad((_invViewProjRelative[1].z), _23, ((_invViewProjRelative[0].z) * _21))) + (_invViewProjRelative[3].z)) / _64);
  ...
  _113 = __0__7__0__0__g_bindlessTextures[((int)((uint)(select(((uint)_106 < (uint)65000), _106, 0)) + 0u))].Sample(__0__4__0__0__g_staticBilinearWrap, float2(_75, ((_time.x * 0.05000000074505806f) + _74)));
  ...
  _137 = __0__7__0__0__g_bindlessTextures[((int)((uint)(select(((uint)_130 < (uint)65000), _130, 0)) + 0u))].Sample(__0__4__0__0__g_staticBilinearWrap, float2((_75 * 2.0f), ((_74 - (_time.x * 0.10000000149011612f)) * 2.0f)));
  _140 = _137.x + _113.x;
  _141 = _137.y + _113.y;
  ...
  _161 = __0__7__0__0__g_bindlessTextures[((int)((uint)(select(((uint)_154 < (uint)65000), _154, 0)) + 0u))].Sample(__0__4__0__0__g_staticBilinearWrap, float2(((_time.x * 0.12999999523162842f) + _74), _73));
  ...
  _185 = __0__7__0__0__g_bindlessTextures[((int)((uint)(select(((uint)_178 < (uint)65000), _178, 0)) + 0u))].Sample(__0__4__0__0__g_staticBilinearWrap, float2((((_time.x * 0.10000000149011612f) + _74) * 2.0f), (_73 * 2.0f)));
  ...
  _229 = __0__7__0__0__g_bindlessTextures[((int)((uint)(select(((uint)_222 < (uint)65000), _222, 0)) + 0u))].Sample(__0__4__0__0__g_staticBilinearWrap, float2((TEXCOORD.x - (_time.x * 0.009999999776482582f)), ((_time.x * 0.10000000149011612f) + TEXCOORD.y)));
  ...
  _253 = (pow(_246.y, 0.012683313339948654f));  // [sem: _3__36__0__0__g_sceneColor_sample_derived]
  _254 = (pow(_246.z, 0.012683313339948654f));  // [sem: _3__36__0__0__g_sceneColor_sample_derived]
  ...
  _322 = mad((_projToPrevProj[2].w), _293.x, mad((_projToPrevProj[1].w), _23, ((_projToPrevProj[0].w) * _21))) + (_projToPrevProj[3].w);
  ...
  // [sem: _3__36__0__0__g_postProcessSizeColor_sample]
    _369 = __3__36__0__0__g_postProcessSizeColor.Sample(__0__4__0__0__g_staticBilinearClamp, float2((TEXCOORD.x - ((_354 * (((((((mad((_projToPrevProj[2].x), _293.x, mad((_projToPrevProj[1].x), _23, ((_projToPrevProj[0].x) * _21))) + (_projToPrevProj[3].x)) / _322) - _21) * 2.5f) + -0.5f) + frac(frac(dot(float2(_283, _284), float2(0.0671105608344078f, 0.005837149918079376f))) * 52.98291778564453f)) - (_341 * 8.742277657347586e-08f))) * _360)), (TEXCOORD.y - ((_355 * (((((((mad((_projToPrevProj[2].y), _293.x, mad((_projToPrevProj[1].y), _23, ((_projToPrevProj[0].y) * _21))) + (_projToPrevProj[3].y)) / _322) - _23) * 2.5f) + -0.5f) + frac(frac(dot(float2((_283 + 32.665000915527344f), (_284 + 11.8149995803833f)), float2(0.0671105608344078f, 0.005837149918079376f))) * 52.98291778564453f)) - _341)) * _360))));
    ...
    _391 = (pow(_246.x, 0.012683313339948654f));  // [sem: _3__36__0__0__g_sceneColor_sample_derived]
    _403 = dot(float3((exp2(log2(max(0.0f, (_391 + -0.8359375f)) / (18.8515625f - (_391 * 18.6875f))) * 6.277394771575928f) * 10000.0f), (exp2(log2(max(0.0f, (_253 + -0.8359375f)) / (18.8515625f - (_253 * 18.6875f))) * 6.277394771575928f) * 10000.0f), (exp2(log2(max(0.0f, (_254 + -0.8359375f)) / (18.8515625f - (_254 * 18.6875f))) * 6.277394771575928f) * 10000.0f)), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f)) * 0.30000001192092896f;
    _410 = ((_403 - _376) * 0.20000000298023224f) + _376;
    _411 = ((_403 - _377) * 0.20000000298023224f) + _377;
    _412 = ((_403 - _378) * 0.20000000298023224f) + _378;
    ...
    if (_429) {
      ...
      if (_etcParams.z == 0.0f) {
        ...
        _771 = 2.200000047683716f / ((min(max(_userImageAdjust.w, -1.0f), 1.0f) * 0.800000011920929f) + 2.200000047683716f);
    ...
    _860 = exp2(log2(_848 * 9.999999747378752e-05f) * 0.1593017578125f);
    _861 = exp2(log2(_849 * 9.999999747378752e-05f) * 0.1593017578125f);
    _862 = exp2(log2(_850 * 9.999999747378752e-05f) * 0.1593017578125f);
