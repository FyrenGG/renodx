...
float4 main(
  ...
  _777 = 1.0f - _776;
  _805 = mad((_projToPrevProj[2].w), 1.0000000116860974e-07f, mad((_projToPrevProj[1].w), _777, ((_projToPrevProj[0].w) * _775))) + (_projToPrevProj[3].w);
  _808 = ((mad((_projToPrevProj[2].x), 1.0000000116860974e-07f, mad((_projToPrevProj[1].x), _777, ((_projToPrevProj[0].x) * _775))) + (_projToPrevProj[3].x)) / _805) - _775;
  _809 = ((mad((_projToPrevProj[2].y), 1.0000000116860974e-07f, mad((_projToPrevProj[1].y), _777, ((_projToPrevProj[0].y) * _775))) + (_projToPrevProj[3].y)) / _805) - _777;
