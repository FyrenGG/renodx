...
float4 main(
  ...
  if (_979) {
    ...
    float3 _rndx_tonemapped_color = TonemapReplacer(float3(_956, _959, _962));
    _1225 = _rndx_tonemapped_color.x;
    _1232 = _rndx_tonemapped_color.y;
    _1239 = _rndx_tonemapped_color.z;
