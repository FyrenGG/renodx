...
float4 main(
  ...
  if (_653) {
    ...
    float3 _rndx_tonemapped_color = TonemapReplacer(float3(_614, _625, _636));
    _901 = _rndx_tonemapped_color.x;
    _908 = _rndx_tonemapped_color.y;
    _915 = _rndx_tonemapped_color.z;
