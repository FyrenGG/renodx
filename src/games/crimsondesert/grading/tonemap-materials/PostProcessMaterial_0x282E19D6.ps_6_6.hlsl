...
float4 main(
  ...
  if (_57) {
    ...
    float3 _rndx_tonemapped_color = TonemapReplacer(float3(_33.x, _33.y, _33.z));
    _305 = _rndx_tonemapped_color.x;
    _312 = _rndx_tonemapped_color.y;
  ...
  if (_etcParams.y > 1.0f) {
    ...
    _426 = saturate(1.0f - (dot(float2(_417, _420), float2(_417, _420)) * _rndx_vignette_strength));  // [sem: expr_sat]
