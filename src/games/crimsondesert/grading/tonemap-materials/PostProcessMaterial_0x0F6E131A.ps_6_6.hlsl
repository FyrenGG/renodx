...
float4 main(
  ...
  // [sem: _3__36__0__0__g_CustomRenderPassDepth_load]
      ...
      _276 = max(1.0000000116860974e-07f, _274.x);
      _312 = mad((_invViewProj[2].w), _276, mad((_invViewProj[1].w), _71, ((_invViewProj[0].w) * _69))) + (_invViewProj[3].w);
      _342 = _265;
      _343 = ((mad((_invViewProj[2].x), _276, mad((_invViewProj[1].x), _71, ((_invViewProj[0].x) * _69))) + (_invViewProj[3].x)) / _312);
      _344 = ((mad((_invViewProj[2].y), _276, mad((_invViewProj[1].y), _71, ((_invViewProj[0].y) * _69))) + (_invViewProj[3].y)) / _312);
      _345 = ((mad((_invViewProj[2].z), _276, mad((_invViewProj[1].z), _71, ((_invViewProj[0].z) * _69))) + (_invViewProj[3].z)) / _312);
      _346 = _274.x;
      _347 = (((float)((uint)((uint)((((uint)(__3__36__0__0__g_depthOpaque.Load(int3((int)(uint((_bufferSizeAndInvSize.x * _144) + -0.5f)), (int)(uint((_bufferSizeAndInvSize.y * _145) + -0.5f)), 0)))).x) & 16777215)))) * 5.960465188081798e-08f);
  ...
  // [sem: _3__36__0__0__g_CustomRenderPassDepth_load]
    ...
    if (!(_196 == _342)) {
      ...
      _359 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)(select(((uint)_351 < (uint)170000), _351, 0)) + 0u))].BindlessParameters_PostProcessUber_CD._itemRatio);
      if (!(_359 > 0.0010000000474974513f)) {
        __branch_chain_341 = true;
      } else {
  ...
  // [sem: _3__36__0__0__g_sceneColor_sample]
                    ...
                    _1029 = (((1.0f - saturate((sqrt(((_1011 * _1011) + (_1012 * _1012)) + (_1013 * _1013)) - _1003) / _1002)) * (1.0f - saturate(ceil(((_nearFarProj.x / max(1.0000000116860974e-07f, _347)) + 0.5f) - (_nearFarProj.x / max(1.0000000116860974e-07f, _346)))))) * max(_highLightForVisionRemoteCatch, _characterHighlight));
                    _1030 = (_999 * 1.5f);
                    _1031 = (_1000 * 1.5f);
                    _1032 = (_1001 * 1.5f);
                  } else {
  ...
  // [sem: _3__36__0__0__g_sceneColor_sample]
          ...
          _820 = (saturate(_802.x * 1.0009784698486328f) * 2.0f) + -1.0f;  // [sem: _3__36__0__0__g_gbufferNormal_load_derived]
          _821 = (saturate(_802.y * 1.0009784698486328f) * 2.0f) + -1.0f;  // [sem: _3__36__0__0__g_gbufferNormal_load_derived]
          _822 = (saturate(_802.z * 1.0009784698486328f) * 2.0f) + -1.0f;  // [sem: _3__36__0__0__g_gbufferNormal_load_derived]
          _824 = rsqrt(dot(float3(_820, _821, _822), float3(_820, _821, _822)));  // [sem: invLength]
          _825 = _824 * _820;
          _826 = _824 * _821;
          _827 = _822 * _824;
          _830 = (((float)((uint)((uint)(((uint)((uint)(_799.w)) >> 8) & 255)))) * 0.007843137718737125f) + -1.0f;  // [sem: _3__36__0__0__g_gbufferBaseColor_load_derived]
          _831 = (((float)((uint)((uint)(_799.w & 255)))) * 0.007843137718737125f) + -1.0f;  // [sem: _3__36__0__0__g_gbufferBaseColor_load_derived]
          _834 = (_830 + _831) * 0.5f;
          _835 = (_830 - _831) * 0.5f;
          ...
          _886 = 1.0f - dot(float3(((_871 * _861) + -0.10000000149011612f), ((_871 * _865) + -0.10000000149011612f), ((_871 * _869) + -0.10000000149011612f)), float3((-0.0f - _viewDir.x), (-0.0f - _viewDir.y), (-0.0f - _viewDir.z)));
          _891 = frac((_time.x * 2.0f) + _886);
          _892 = _891 * _891;
          _896 = _886 * 10.0f;
          _903 = __0__7__0__0__g_bindlessTextures[((int)((uint)(select(((uint)_167 < (uint)65000), _167, 0)) + 0u))].Sample(__0__4__0__0__g_staticBilinearWrap, float2(_896, _896));
          _905 = _903.x * _903.x;
          _924 = 6.0f / max(0.0010000000474974513f, _exposure0.x);
          _1029 = ((saturate((_905 * _905) * 4.0f) * saturate((_892 * _892) * 5.0f)) * saturate(ceil(((_nearFarProj.x / max(1.0000000116860974e-07f, _347)) + 0.05000000074505806f) - (_nearFarProj.x / max(1.0000000116860974e-07f, _346)))));
          _1030 = ((_highLightForVision * (_924 - _234.x)) + _234.x);
          _1031 = ((_highLightForVision * ((_924 * 0.6444798111915588f) - _234.y)) + _234.y);
        ...
        _482 = (1.0f - saturate(sqrt(((_470 * _470) + (_471 * _471)) + (_472 * _472)) * 0.125f)) * 0.20000000298023224f;
        ...
        _523 = __0__7__0__0__g_bindlessTextures[((int)((uint)(select(((uint)_167 < (uint)65000), _167, 0)) + 0u))].Sample(__0__4__0__0__g_staticBilinearWrap, float2(((_time.x * 0.10000000149011612f) + (_506 * 2.0f)), ((_511 * 0.10000000149011612f) + (_505 * 2.0f))));
        _535 = __0__7__0__0__g_bindlessTextures[((int)((uint)(select(((uint)_167 < (uint)65000), _167, 0)) + 0u))].Sample(__0__4__0__0__g_staticBilinearWrap, float2(((_506 - (_time.x * 0.06000000238418579f)) - (_523.x * 0.05000000074505806f)), ((_505 - (_511 * 0.06000000238418579f)) - (_523.w * 0.05000000074505806f))));
        _555 = uint((((((_523.w + -1.0f) + _535.y) * 0.019999999552965164f) + _144) * _bufferSizeAndInvSize.x) + -0.5f);
        _556 = uint((((((_523.y + -1.0f) + _535.w) * 0.019999999552965164f) + _145) * _bufferSizeAndInvSize.y) + -0.5f);
        ...
        _680 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)(select(((uint)_672 < (uint)170000), _672, 0)) + 0u))].BindlessParameters_PostProcessUber_CD._objectiveMaskColor);
        _683 = (float)((uint)((uint)(((uint)(_680) >> 16) & 255)));
        _686 = (float)((uint)((uint)(((uint)(_680) >> 8) & 255)));
        _688 = (float)((uint)((uint)(_680 & 255)));
        _721 = (_535.y * _535.w) * (1.0f / max(0.0010000000474974513f, _exposure0.x));
  // [sem: invLength]
        ...
        _1029 = (((_773 * _773) * ((1.0f - saturate(sqrt(((_752 * _752) + (_753 * _753)) + (_754 * _754)) / max(0.0010000000474974513f, (tan(_detectModeAngle * 0.01745329238474369f) * _746)))) * (((_645 - _668) * saturate(ceil(((_nearFarProj.x / max(1.0000000116860974e-07f, _347)) + 0.05000000074505806f) - (_nearFarProj.x / max(1.0000000116860974e-07f, _346))))) + _668))) * _highLightForVision);
        _1030 = (_721 * select(((_683 * 0.011764707043766975f) < 0.040449999272823334f), (_683 * 0.0009105810313485563f), exp2(log2((_683 * 0.011151381768286228f) + 0.052132703363895416f) * 2.4000000953674316f)));
        _1031 = (_721 * select(((_686 * 0.011764707043766975f) < 0.040449999272823334f), (_686 * 0.0009105810313485563f), exp2(log2((_686 * 0.011151381768286228f) + 0.052132703363895416f) * 2.4000000953674316f)));
        _1032 = (_721 * select(((_688 * 0.011764707043766975f) < 0.040449999272823334f), (_688 * 0.0009105810313485563f), exp2(log2((_688 * 0.011151381768286228f) + 0.052132703363895416f) * 2.4000000953674316f)));
      }
    } else {
  ...
  // [sem: invLength]
      ...
      _417 = _408 - (_405 * _410);
      _418 = _409 - (_406 * _410);
      _1029 = ((((1.0f - saturate((sqrt(((_373 * _373) + (_374 * _374)) + (_375 * _375)) + -30.0f) * 0.05000000074505806f)) * saturate((_348 * _348) * 4.0f)) * (1.0f - saturate(sqrt(((_416 * _416) + (_417 * _417)) + (_418 * _418)) / max(0.0010000000474974513f, (tan(_detectModeAngle * 0.01745329238474369f) * _410))))) * exp2(log2(1.0f - saturate(sqrt(((_407 * _407) + (_408 * _408)) + (_409 * _409)) / _detectModeRadius)) * 10.0f));
      _1030 = _234.x;
      _1031 = _234.y;
      _1032 = _234.z;
    }
  ...
  _1036 = abs(_temperatureWarning * 0.009999999776482582f);
  if (_51) {
    if (_temperatureWarning > 0.0f) {
      _1043 = _67 * TEXCOORD.x;
      _1056 = __0__7__0__0__g_bindlessTextures[((int)((uint)(select(((uint)_167 < (uint)65000), _167, 0)) + 0u))].Sample(__0__4__0__0__g_staticBilinearWrap, float2((_1043 * 4.25f), ((TEXCOORD.y * 3.0f) - (_time.x * 0.15000000596046448f))));
      _1068 = __0__7__0__0__g_bindlessTextures[((int)((uint)(select(((uint)_167 < (uint)65000), _167, 0)) + 0u))].Sample(__0__4__0__0__g_staticBilinearWrap, float2((_1043 * 2.299999952316284f), (((TEXCOORD.y * 2.0999999046325684f) - (_1056.x * 0.10000000149011612f)) + (_time.x * 0.20000000298023224f))));
      _1074 = TEXCOORD.x + -0.5f;
      _1107 = abs((_1074 + ((_1056.y + -0.5f) * 0.009999999776482582f)) + ((_1068.z + -0.5f) * 0.029999999329447746f));
      _1108 = abs(((TEXCOORD.y + -0.5f) + ((_1056.x + -0.5f) * 0.019999999552965164f)) + ((_1068.y + -0.5f) * 0.029999999329447746f));
      _1111 = max((_1107 + -0.5f), 0.0f);
      _1112 = max((_1108 + -0.5f), 0.0f);
      _1119 = 0.5f - min(max((((1.0f - (saturate(abs(_1074) * 2.0f) * 0.3999999761581421f)) * ((_1036 * 0.05000000447034836f) + 0.10000000149011612f)) * (((((_1056.z * 0.30000001192092896f) + -0.5f) + (_1068.x * 0.699999988079071f)) * 1.100000023841858f) + 1.0f)), ((_1036 * 0.017500001937150955f) + 0.03500000014901161f)), ((_1036 * 0.11000001430511475f) + 0.2200000137090683f));
      _1122 = max((_1107 - _1119), 0.0f);
      _1123 = max((_1108 - _1119), 0.0f);
      _1134 = saturate((TEXCOORD.y + -0.15000000596046448f) * 1.2500001192092896f);  // [sem: expr_sat]
      _1150 = saturate(_1068.x * _1056.x);  // [sem: expr_sat]
      _1151 = _1036 * 0.20000000298023224f;
      _1159 = ((saturate(_1036 * 2.0f) * saturate(saturate(sqrt((_1123 * _1123) + (_1122 * _1122)) * 10.0f) - saturate(sqrt((_1112 * _1112) + (_1111 * _1111)) * 10.0f))) * ((_1150 * (1.0f - _1151)) + _1151)) * ((((_1134 * _1134) * (3.0f - (_1134 * 2.0f))) * ((saturate((((_1056.x * 0.25f) + -0.3499999940395355f) + (_1068.y * 0.75f)) * 1.600000023841858f) * 0.5f) + -0.3500000238418579f)) + 1.0f);
      _1163 = _1159 * (_1036 * 0.10000000149011612f);
  // [sem: _3__36__0__0__g_sceneColor_sample]
      ...
      _1185 = max(0.0010000000474974513f, _exposure0.x);
      _1195 = (((1.0f / _1185) - _1171.x) * _1182) + _1171.x;
      _1196 = (((0.6000000238418579f / _1185) - _1171.y) * _1182) + _1171.y;
      _1197 = (((0.30000001192092896f / _1185) - _1171.z) * _1182) + _1171.z;
      ...
      if (_temperatureWarning < 0.0f) {
        ...
        _1238 = __0__7__0__0__g_bindlessTextures[((int)((uint)(select(((uint)_167 < (uint)65000), _167, 0)) + 0u))].Sample(__0__4__0__0__g_staticBilinearWrap, float2((_1229 * 1.5f), (TEXCOORD.y * 1.5f)));
        _1243 = WaveReadLaneFirst(_materialIndex);
        _1251 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)(select(((uint)_1243 < (uint)170000), _1243, 0)) + 0u))].BindlessParameters_PostProcessUber_CD._temperatureWarningTex);
        _1258 = __0__7__0__0__g_bindlessTextures[((int)((uint)(select(((uint)_1251 < (uint)65000), _1251, 0)) + 0u))].Sample(__0__4__0__0__g_staticBilinearWrap, float2((_1229 * 2.0f), _70));
        _1266 = (select(((TEXCOORD.y / (1.0f - TEXCOORD.x)) < 1.0f), (1.0f - _1258.y), _1258.y) + -0.5f) * 0.30000001192092896f;
        _1268 = (_1238.x + -0.4000000059604645f) * 0.20000000298023224f;
        _1276 = max(0.0010000000474974513f, _exposure0.x);
        _1289 = 0.5f - (_1036 * 0.25f);
        _1292 = max((abs(((TEXCOORD.x + -0.5f) + _1268) + _1266) - _1289), 0.0f);
        _1293 = max((abs(((_1266 + _1268) + -0.4749999940395355f) + (TEXCOORD.y * 0.8999999761581421f)) - _1289), 0.0f);
        _1315 = (_1036 * (1.0f - TEXCOORD.y)) * saturate((((_1258.y * 4.0f) * saturate(1.0f - ((1.0f - saturate(sqrt((_1293 * _1293) + (_1292 * _1292)) * 6.666666507720947f)) * 2.0f))) * saturate((_1258.y * _1258.y) * 2.0f)) * saturate(_1238.z * _1238.w));
        _1327 = (_1315 + _1029);
        _1328 = ((_1315 * ((((_1238.w * 1.8809775114059448f) + 0.11902248114347458f) / _1276) - _1030)) + _1030);
        _1329 = ((_1315 * ((((_1238.w * 1.3989123106002808f) + 0.6010876893997192f) / _1276) - _1031)) + _1031);
  ...
  if (!(_electrocutionWarning == 0.0f)) {
    ...
    _1344 = __0__7__0__0__g_bindlessTextures[((int)((uint)(select(((uint)_167 < (uint)65000), _167, 0)) + 0u))].Sample(__0__4__0__0__g_staticBilinearWrap, float2((_1335 * 1.5f), (TEXCOORD.y * 1.5f)));
    _1357 = WaveReadLaneFirst(_materialIndex);
    _1365 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)(select(((uint)_1357 < (uint)170000), _1357, 0)) + 0u))].BindlessParameters_PostProcessUber_CD._electrocutionTex);
    _1376 = max(0.0010000000474974513f, _exposure0.x);
    _1385 = 0.5f - (_electrocutionWarning * 0.07000000029802322f);
    ...
    _1407 = (_1404 * _1404) * (saturate(sqrt((_1389 * _1389) + (_1388 * _1388)) / _1344.z) * (((float4)(__0__7__0__0__g_bindlessTextures[((int)((uint)(select(((uint)_1365 < (uint)65000), _1365, 0)) + 0u))].Sample(__0__4__0__0__g_staticBilinearWrap, float2(((_1344.x * 0.05000000074505806f) + (_1335 * 2.0f)), (((_1344.y * 0.05000000074505806f) + _70) + (_time.x * 0.10000000149011612f)))))).x));
    _1410 = (pow(_1407, 1.600000023841858f));
    _1422 = (_1407 + _1327);
  ...
  if (_1443) {
    ...
    float3 _rndx_tonemapped_color = TonemapReplacer(float3(_1423, _1424, _1425));
    _1703 = _rndx_tonemapped_color.x;
    _1704 = _rndx_tonemapped_color.y;
    _1705 = _rndx_tonemapped_color.z;
