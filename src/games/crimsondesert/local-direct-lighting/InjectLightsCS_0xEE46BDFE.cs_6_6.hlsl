...
StructuredBuffer<LightDataEncoded> __3__37__0__0__g_globalLightDataBuffer : register(t7, space37);
...
cbuffer __3__35__0__0__LightProfileConstantBuffer : register(b4, space35) {
  struct {
...
void main(
  ...
  float _9[4];
  int _15[11];
  _15[0] = ((int)((uint)((uint)(_srcStartIndex.z)) + (uint)((uint)(_srcStartIndex.y))));
  ...
  if ((uint)(int)(SV_DispatchThreadID.x) < (uint)_srcStartIndex.x) {
    ...
    if (_46) {
      ...
      _68 = (uint)(SV_DispatchThreadID.x) - (uint)((uint)(_srcStartIndex.z));
    ...
    if (((_95 < 0.0f) || (_96 < 0.0f)) || (_97 < 0.0f)) {
      ...
      _127 = dot(float3((_view[0].x), (_view[0].y), (_view[0].z)), float3(_112, _113, _114));
      _128 = dot(float3((_view[1].x), (_view[1].y), (_view[1].z)), float3(_112, _113, _114));
    } else {
      _127 = _99;
      _128 = _100;
    }
    _130 = (int)(_90) >> 1;
    _132 = __3__35__0__0__LightProfileConstantBuffer_raw[((int)((uint)((uint)(_89)) >> 2))];
    _9[0] = _132.x;
    _9[1] = _132.y;
    _9[2] = _132.z;
    _9[3] = _132.w;
    if (!(_89 == -1)) {
      _148 = min(3.1415927f, (_9[(_89 & 3)]));
    } else {
      _148 = 3.1415927f;
    }
    _152 = 1.0f / max(0.0001f, _exposure0.x);
    if (_130 == 1) {
      _165 = min(((saturate(_152 * 0.01f) * 9.9f) + 0.1f), max(0.01f, _152));
    } else {
      _165 = min(max(_152, 0.05f), 150.0f);
    }
    _166 = select(_46, 1e+06f, _98);
    _171 = saturate((float)((uint)((uint)(_130))));  // [sem: expr_sat]
