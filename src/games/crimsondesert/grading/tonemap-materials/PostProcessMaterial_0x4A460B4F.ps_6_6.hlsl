...
float4 main(
  ...
  _298 = mad((_projToPrevProj[2].w), _269.x, mad((_projToPrevProj[1].w), _23, ((_projToPrevProj[0].w) * _21))) + (_projToPrevProj[3].w);
  ...
  // [sem: _3__36__0__0__g_postProcessSizeColor_sample]
    _345 = __3__36__0__0__g_postProcessSizeColor.Sample(__0__4__0__0__g_staticBilinearClamp, float2((TEXCOORD.x - ((_330 * (((((((mad((_projToPrevProj[2].x), _269.x, mad((_projToPrevProj[1].x), _23, ((_projToPrevProj[0].x) * _21))) + (_projToPrevProj[3].x)) / _298) - _21) * 2.5f) + -0.5f) + frac(frac(dot(float2(_259, _260), float2(0.0671105608344078f, 0.005837149918079376f))) * 52.98291778564453f)) - (_317 * 8.742277657347586e-08f))) * _336)), (TEXCOORD.y - ((_331 * (((((((mad((_projToPrevProj[2].y), _269.x, mad((_projToPrevProj[1].y), _23, ((_projToPrevProj[0].y) * _21))) + (_projToPrevProj[3].y)) / _298) - _23) * 2.5f) + -0.5f) + frac(frac(dot(float2((_259 + 32.665000915527344f), (_260 + 11.8149995803833f)), float2(0.0671105608344078f, 0.005837149918079376f))) * 52.98291778564453f)) - _317)) * _336))));
    ...
    _367 = dot(float3(_246.x, _246.y, _246.z), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f)) * 0.30000001192092896f;
    _374 = ((_367 - _352) * 0.20000000298023224f) + _352;
    _375 = ((_367 - _353) * 0.20000000298023224f) + _353;
    _376 = ((_367 - _354) * 0.20000000298023224f) + _354;
    ...
    if (_393) {
      ...
      float3 _rndx_tonemapped_color = TonemapReplacer(float3(_374, _375, _376));
      _653 = _rndx_tonemapped_color.x;
      _654 = _rndx_tonemapped_color.y;
      _655 = _rndx_tonemapped_color.z;
      ...
      if (_etcParams.z == 0.0f) {
        ...
        _735 = 2.200000047683716f / ((min(max(_userImageAdjust.w, -1.0f), 1.0f) * 0.800000011920929f) + 2.200000047683716f);
    ...
    if (_etcParams.y > 1.0f) {
      ...
      _759 = saturate(1.0f - (dot(float2(_754, _755), float2(_754, _755)) * _rndx_vignette_strength));  // [sem: expr_sat]
    ...
    if (CUSTOM_BASIC_POSTPROCESS_FINAL == 1.f && !(_etcParams.z > 0.0f)) {
      float3 _rndx_final_color = FinalizeSDR(float3(_812, _813, _814), _sunDirection.y, _moonDirection.y);
      _812 = _rndx_final_color.x;
      _813 = _rndx_final_color.y;
      _814 = _rndx_final_color.z;
    }
