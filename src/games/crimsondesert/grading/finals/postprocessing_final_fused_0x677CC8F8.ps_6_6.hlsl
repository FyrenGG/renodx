...
float4 main(
  ...
  _176 = (_157 * saturate(_rndx_tonemapped_color.x)) + _158;
  _170 = (_157 * saturate(_rndx_tonemapped_color.y)) + _158;
  _164 = (_157 * saturate(_rndx_tonemapped_color.z)) + _158;
  ...
  _277 = saturate(1.0f - ((_268 * _postProcessParams.x * CUSTOM_VIGNETTE) * dot(float2(_269, _271), float2(_269, _271))));  // [sem: expr_sat]
