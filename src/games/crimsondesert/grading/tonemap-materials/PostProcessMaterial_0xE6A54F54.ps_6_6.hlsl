  ...
  while(true) {
    ...
    if (__branch_chain_179) {
      ...
      if ((int)_326 < (int)5) {
        ...
        _2409 = _297;
        _2410 = _298;
        _2411 = ((_316 * _145) + _188);
        _2412 = ((_310 * _144) + _189);
        _2413 = ((_304 * _143) + _190);
        _2414 = (_316 + _191);
        _2415 = (_310 + _192);
        _2416 = (_304 + _193);
        _180 = _2403;
    ...
    _1876 = 1.0f - (saturate(_367 * 7.0f) * 0.995f);
    _1877 = _1876 * _1869.x;
    _1878 = _1876 * _1869.y;
    _1879 = _1876 * _1869.z;
    _1880 = (_1867 == 0);
    if (_1880) {
      _1884 = saturate(_1132);  // [sem: _1132_sat]
    } else {
      _1884 = 0.0f;  // [sem: _1132_sat]
    }
    _1895 = ((_1780 * 0.049657132f) + (_1508 * 0.0100228265f)) + _1793;
    _1908 = ((max(0.0f, ((((saturate(_1331) * _1344) + ((_331 * 0.5f) * _342)) + (exp2(log2(((((((_1734 * 0.16689524f) + 0.033104755f) * _1734) + (_1544 * 0.033104755f)) + (_1795 * 0.07323897f)) + _1895) * 2.0f)) * _1817)) * _1821)) - _1877) * _1884) + _1877;
    _1931 = ((max(0.0f, ((((saturate(_1332) * _1344) + ((_330 * 0.7f) * _342)) + (exp2(log2((((((0.07323897f - (_1734 * 0.023238968f)) * _1734) + (_1806 * 0.033104755f)) + (_1795 * 0.21404113f)) + _1895) * 2.0f)) * _1817)) * _1821)) - _1878) * _1884) + _1878;
    _1960 = ((max(0.0f, ((((saturate(_1333) * _1344) + ((_329 * 0.9f) * _342)) + (exp2(log2((((((((_1806 * 0.07323897f) + (_1508 * 0.033104755f)) + ((0.13286835f - (_1734 * 0.08286835f)) * _1734)) + (_1785 * 0.06370936f)) + (_1780 * 0.10985845f)) + (_1789 * 0.6038274f)) + _1793) * 2.0f)) * _1817)) * _1821)) - _1879) * _1884) + _1879;
    if (_1880) {
      _1964 = saturate(_1132);  // [sem: _1132_sat]
    } else {
      _1964 = 1.0f;  // [sem: _1132_sat]
    }
    _1965 = (uint)(SV_Position.y);
    if (_etcParams.y == 1.0f) {
      _1978 = (((float)((uint)((uint)((((uint2)(__3__36__0__0__g_stencil.Load(int3(((int)((uint)(SV_Position.x))), _1965, 0)))).x) & 127)))) + 0.5f);
    } else {
      _1978 = _1964;
    }
    _1981 = (_localToneMappingParams.w > 0.0f);
    if (_1981) {
      _1985 = _userImageAdjust.z * _exposure0.x;
      _2004 = exp2(_powerParams.x * log2(max(0.0f, (((_1985 * max(0.0f, (((_1908 * 1.70505f) - (_1931 * 0.62179f)) - (_1960 * 0.08326f)))) * _slopeParams.x) + _offsetParams.x))));
      _2020 = exp2(log2(max(0.0f, (((_slopeParams.y * _1985) * max(0.0f, (((_1931 * 1.1408f) - (_1908 * 0.13026f)) - (_1960 * 0.01055f)))) + _offsetParams.y))) * _powerParams.y);
      _2036 = exp2(log2(max(0.0f, (((_slopeParams.z * _1985) * max(0.0f, (((_1908 * -0.024f) - (_1931 * 0.12897f)) + (_1960 * 1.15297f)))) + _offsetParams.z))) * _powerParams.z);
      _2037 = dot(float3(_2004, _2020, _2036), float3(0.212671f, 0.71516f, 0.072169f));
      _2041 = ((_2004 - _2037) * _powerParams.w) + _2037;
      _2044 = ((_2020 - _2037) * _powerParams.w) + _2037;
      _2047 = ((_2036 - _2037) * _powerParams.w) + _2037;
      _2054 = min(max(log2(mad(_2047, 0.079223745f, mad(_2044, 0.0784336f, (_2041 * 0.84247905f)))), -12.47393f), 4.026069f) + 12.47393f;
      _2061 = min(max(log2(mad(_2047, 0.07916613f, mad(_2044, 0.87846863f, (_2041 * 0.042328242f)))), -12.47393f), 4.026069f) + 12.47393f;
      _2068 = min(max(log2(mad(_2047, 0.879143f, mad(_2044, 0.0784336f, (_2041 * 0.042375654f)))), -12.47393f), 4.026069f) + 12.47393f;
      _2069 = _2054 * 0.060606062f;
      _2070 = _2061 * 0.060606062f;
      _2071 = _2068 * 0.060606062f;
      _2072 = _2069 * _2069;
      _2073 = _2070 * _2070;
      _2074 = _2071 * _2071;
      _2090 = min(0.0f, (-0.0f - (((_2054 * 0.0072181816f) + ((_2072 * 0.4298f) + (((_2072 * _2072) * ((31.96f - (_2054 * 2.4327273f)) + (_2072 * 15.5f))) - ((_2054 * 0.41624245f) * _2072)))) + -0.00232f)));
      _2106 = min(0.0f, (-0.0f - (((_2061 * 0.0072181816f) + ((_2073 * 0.4298f) + (((_2073 * _2073) * ((31.96f - (_2061 * 2.4327273f)) + (_2073 * 15.5f))) - ((_2061 * 0.41624245f) * _2073)))) + -0.00232f)));
      _2122 = min(0.0f, (-0.0f - (((_2068 * 0.0072181816f) + ((_2074 * 0.4298f) + (((_2074 * _2074) * ((31.96f - (_2068 * 2.4327273f)) + (_2074 * 15.5f))) - ((_2068 * 0.41624245f) * _2074)))) + -0.00232f)));
      _2123 = -0.0f - _2090;
      _2124 = -0.0f - _2106;
      _2125 = -0.0f - _2122;
      _2126 = dot(float3(_2123, _2124, _2125), float3(0.2126f, 0.7152f, 0.0722f));
      if (_nightToneParm == 1) {
        _2143 = exp2(exp2(log2(abs((_time.w * 0.11666667f) + -1.4f)) * 8.0f) * -1.442695f) + 1.0f;
        _2144 = -0.79999995f / _2143;
        _2145 = -1.2f / _2143;
        _2146 = 0.20000005f / _2143;
        _2149 = saturate((_exposure2.x + -0.6f) * 0.10638298f);  // [sem: expr_sat]
        _2152 = saturate((_exposure2.x + -0.1f) * 2.0f);  // [sem: expr_sat]
        _2156 = (_2144 + 1.4f) + (_2152 * (-0.39999998f - _2144));
        _2160 = (_2145 + 1.6f) + (_2152 * (-0.6f - _2145));
        _2164 = (_2146 + 0.9f) + (_2152 * (0.5f - _2146));
        _2181 = (lerp(_2160, 1.2f, _2149));  // [sem: blended]
        _2182 = (lerp(_2156, 1.0f, _2149));  // [sem: blended]
        _2183 = (lerp(_2164, 1.4f, _2149));  // [sem: blended]
      } else {
        _2181 = ((saturate((_exposure2.x + -3.0f) * 0.14285715f) * 0.20000005f) + 1.0f);  // [sem: blended]
        _2182 = 1.0f;  // [sem: blended]
        _2183 = 1.4f;  // [sem: blended]
      }
      _2184 = 1.0f - _2181;
      _2196 = ((exp2(log2(((saturate((_2090 * _2090) * _2123) * _2184) + _2181) * _2123) * _2182) - _2126) * _2183) + _2126;
      _2208 = ((exp2(log2(((saturate((_2106 * _2106) * _2124) * _2184) + _2181) * _2124) * _2182) - _2126) * _2183) + _2126;
      _2220 = ((exp2(log2(((saturate((_2122 * _2122) * _2125) * _2184) + _2181) * _2125) * _2182) - _2126) * _2183) + _2126;
      _2227 = saturate(exp2(log2(mad(_2220, -0.09902974f, mad(_2208, -0.09802088f, (_2196 * 1.196879f)))) * 2.2f));  // [sem: expr_sat]
      _2234 = saturate(exp2(log2(mad(_2220, -0.098961174f, mad(_2208, 1.1519032f, (_2196 * -0.052896854f)))) * 2.2f));  // [sem: expr_sat]
      _2241 = saturate(exp2(log2(mad(_2220, 1.1510737f, mad(_2208, -0.09804345f, (_2196 * -0.052971635f)))) * 2.2f));  // [sem: expr_sat]
      if (_etcParams.z == 0.0f) {
        _2247 = 1.0f - abs(_etcParams.w);
        _2248 = saturate(_etcParams.w);  // [sem: expr_sat]
        _2250 = (_2247 * _2227) + _2248;
        _2252 = (_2247 * _2234) + _2248;
        _2254 = (_2247 * _2241) + _2248;
        if (_colorGradingParams.w > 0.0f) {
          _2259 = saturate(_colorGradingParams.w);  // [sem: expr_sat]
          _2276 = (((max(0.0f, (1.0f - _2250)) - _2250) * _2259) + _2250);
          _2277 = (((max(0.0f, (1.0f - _2252)) - _2252) * _2259) + _2252);
          _2278 = (((max(0.0f, (1.0f - _2254)) - _2254) * _2259) + _2254);
        } else {
          _2276 = _2250;
          _2277 = _2252;
          _2278 = _2254;
        }
        _2280 = _userImageAdjust.y + 1.0f;
        _2282 = _userImageAdjust.x + 0.5f;
        _2285 = ((_2276 + -0.5f) * _2280) + _2282;
        _2288 = ((_2277 + -0.5f) * _2280) + _2282;
        _2291 = ((_2278 + -0.5f) * _2280) + _2282;
        _2297 = 2.2f / ((min(max(_userImageAdjust.w, -1.0f), 1.0f) * 0.8f) + 2.2f);
        _2332 = exp2(log2(saturate(mad(_colorBlind0.z, _2291, mad(_colorBlind0.y, _2288, (_colorBlind0.x * _2285))))) * _2297);
        _2333 = exp2(log2(saturate(mad(_colorBlind1.z, _2291, mad(_colorBlind1.y, _2288, (_colorBlind1.x * _2285))))) * _2297);
        _2334 = exp2(log2(saturate(mad(_colorBlind2.z, _2291, mad(_colorBlind2.y, _2288, (_colorBlind2.x * _2285))))) * _2297);
      } else {
        _2332 = _2227;
        _2333 = _2234;
        _2334 = _2241;
    ...
    if (_etcParams.y > 1.0f) {
      _2337 = abs(_77);
      _2340 = abs((TEXCOORD.y * 2.0f) + -1.0f);
      _2346 = saturate(1.0f - (saturate(_etcParams.y + -1.0f) * dot(float2(_2337, _2340), float2(_2337, _2340))));  // [sem: expr_sat]
      _2351 = (_2346 * _2332);
      _2352 = (_2346 * _2333);
      _2353 = (_2346 * _2334);
    } else {
    ...
    if (_1981 && (_etcParams.z > 0.0f)) {
      _2383 = select((_2351 <= 0.0031308f), (_2351 * 12.92f), (((pow(_2351, 0.41666666f)) * 1.055f) + -0.055f));
      _2384 = select((_2352 <= 0.0031308f), (_2352 * 12.92f), (((pow(_2352, 0.41666666f)) * 1.055f) + -0.055f));
      _2385 = select((_2353 <= 0.0031308f), (_2353 * 12.92f), (((pow(_2353, 0.41666666f)) * 1.055f) + -0.055f));
    } else {
      _2383 = _2351;
      _2384 = _2352;
      _2385 = _2353;
    ...
    if (!(!(_etcParams.y >= 1.0f))) {
      _2388 = (float)((uint)((uint)(_1965)));
      if (!(_2388 < _viewDir.w)) {
        if (!(!(_2388 >= (_screenSizeAndInvSize.y - _viewDir.w)))) {
          _2399 = 0.0f;
          _2400 = 0.0f;
          _2401 = 0.0f;
        } else {
