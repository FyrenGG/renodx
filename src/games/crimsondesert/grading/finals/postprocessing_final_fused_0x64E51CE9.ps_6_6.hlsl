...
float4 main(
  ...
  _496 = saturate(_etcParams.w);
  _497 = (_492 * saturate(_rndx_tonemapped_color.x)) + _496;
  _498 = (_492 * saturate(_rndx_tonemapped_color.y)) + _496;
  _499 = (_492 * saturate(_rndx_tonemapped_color.z)) + _496;
  ...
  _566 = 2.200000047683716f / ((min(max(_userImageAdjust.w, -1.0f), 1.0f) * 0.800000011920929f) + 2.200000047683716f);
  _577 = (TEXCOORD.x * 2.0f) + -1.0f;
  _578 = TEXCOORD.y * 2.0f;
  _579 = 1.0f - _578;
  _607 = mad((_projToPrevProj[2].w), 1.0000000116860974e-07f, mad((_projToPrevProj[1].w), _579, ((_projToPrevProj[0].w) * _577))) + (_projToPrevProj[3].w);
  _610 = ((mad((_projToPrevProj[2].x), 1.0000000116860974e-07f, mad((_projToPrevProj[1].x), _579, ((_projToPrevProj[0].x) * _577))) + (_projToPrevProj[3].x)) / _607) - _577;
  _611 = ((mad((_projToPrevProj[2].y), 1.0000000116860974e-07f, mad((_projToPrevProj[1].y), _579, ((_projToPrevProj[0].y) * _577))) + (_projToPrevProj[3].y)) / _607) - _579;
  ...
  _627 = abs(_577);
  _628 = abs(_578 + -1.0f);
  _632 = saturate(1.0f - ((_624 * _postProcessParams.x * CUSTOM_VIGNETTE) * dot(float2(_627, _628), float2(_627, _628))));  // [sem: expr_sat]
