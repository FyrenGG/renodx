...
float4 main(
  ...
  _26 = WaveReadLaneFirst(BindlessParameters_PostProcessFlashback[((int)((uint)(select(((uint)_18 < (uint)170000), _18, 0)) + 0u))].BindlessParameters_PostProcessFlashback._blendingRatio);
  _27 = saturate(_26);  // [sem: _26_sat]
  _28 = WaveReadLaneFirst(_materialIndex);
  _36 = WaveReadLaneFirst(BindlessParameters_PostProcessFlashback[((int)((uint)(select(((uint)_28 < (uint)170000), _28, 0)) + 0u))].BindlessParameters_PostProcessFlashback._flickeringIntensity);
  _37 = saturate(_36);  // [sem: _36_sat]
  _38 = WaveReadLaneFirst(_materialIndex);
  _46 = WaveReadLaneFirst(BindlessParameters_PostProcessFlashback[((int)((uint)(select(((uint)_38 < (uint)170000), _38, 0)) + 0u))].BindlessParameters_PostProcessFlashback._vignetteRatio);
  _47 = saturate(_46);  // [sem: _46_sat]
  _48 = WaveReadLaneFirst(_materialIndex);
  _56 = WaveReadLaneFirst(BindlessParameters_PostProcessFlashback[((int)((uint)(select(((uint)_48 < (uint)170000), _48, 0)) + 0u))].BindlessParameters_PostProcessFlashback._lensDirtIntensity);
  ...
  if (!((((_27 < 9.999999747378752e-05f) && (_37 < 9.999999747378752e-05f)) && (_47 < 9.999999747378752e-05f)) && (_57 < 9.999999747378752e-05f))) {
    ...
    if (!(!(_37 >= 0.0010000000474974513f))) {
      _77 = (frac(sin(dot(float2(floor(_time.x * 0.3700000047683716f), 41.0f), float2(127.0999984741211f, 311.70001220703125f))) * 437.5450134277344f) + 3.0f) * _time.x;
      _78 = floor(_77);
      _80 = frac(_77);
      _88 = frac(sin(dot(float2(53.0f, _78), float2(127.0999984741211f, 311.70001220703125f))) * 437.5450134277344f);
      _97 = (((((_80 * _80) * (3.0f - (_80 * 2.0f))) * (frac(sin(dot(float2(53.0f, (_78 + 1.0f)), float2(127.0999984741211f, 311.70001220703125f))) * 437.5450134277344f) - _88)) + _88) * 3.1700000762939453f) + _77;
      _98 = floor(_97);
      _100 = frac(_97);
      _108 = frac(sin(dot(float2(97.0f, _98), float2(127.0999984741211f, 311.70001220703125f))) * 437.5450134277344f);
      _119 = TEXCOORD.x + -0.5f;
      _120 = TEXCOORD.y + -0.5f;
      _127 = saturate((sqrt((_120 * _120) + (_119 * _119)) + -0.07500000298023224f) * 2.0f);  // [sem: expr_sat]
    ...
    if (!(!(_47 >= 0.0010000000474974513f))) {
      ...
      _145 = WaveReadLaneFirst(BindlessParameters_PostProcessFlashback[((int)((uint)(select(((uint)_137 < (uint)170000), _137, 0)) + 0u))].BindlessParameters_PostProcessFlashback._vignetteShape);
      _147 = WaveReadLaneFirst(_materialIndex);
      _155 = WaveReadLaneFirst(BindlessParameters_PostProcessFlashback[((int)((uint)(select(((uint)_147 < (uint)170000), _147, 0)) + 0u))].BindlessParameters_PostProcessFlashback._vignetteWidth);
      _165 = (5.0f - ((_155 + 4.0f) * _27)) * 0.5f;
      _168 = max((abs(TEXCOORD.x + -0.5f) - _165), 0.0f);
      _169 = max((abs((TEXCOORD.y + -0.5f) / max(9.999999747378752e-05f, (_145 * 3.1415927410125732f))) - _165), 0.0f);
    ...
    if (!(!(_57 >= 9.999999747378752e-05f))) {
      _187 = saturate(1.0f / max(0.0010000000474974513f, abs(_exposure0.x)));  // [sem: expr_sat]
      _194 = -0.25f - (_187 * 0.25f);
      _197 = max((abs(TEXCOORD.x + -0.5f) - _194), 0.0f);
      _198 = max((abs((TEXCOORD.y + -0.5f) * 1.5303359031677246f) - _194), 0.0f);
      _204 = saturate(sqrt((_198 * _198) + (_197 * _197)) / ((_187 * 0.7000000476837158f) + 1.2999999523162842f));  // [sem: expr_sat]
      _207 = _134;
      _208 = _177;
      _209 = (_204 * _204);
    } else {
  ...
  if (_226) {
    ...
    if (_etcParams.z == 0.0f) {
      ...
      _568 = 2.200000047683716f / ((min(max(_userImageAdjust.w, -1.0f), 1.0f) * 0.800000011920929f) + 2.200000047683716f);
  ...
  if (_etcParams.y > 1.0f) {
    ...
    _595 = saturate(1.0f - (dot(float2(_590, _591), float2(_590, _591)) * _rndx_vignette_strength));  // [sem: expr_sat]
  ...
  if (CUSTOM_BASIC_POSTPROCESS_FINAL == 1.f && !(_etcParams.z > 0.0f)) {
    float3 _rndx_final_color = FinalizeSDR(float3(_648, _649, _650), _sunDirection.y, _moonDirection.y);
    _648 = _rndx_final_color.x;
    _649 = _rndx_final_color.y;
    _650 = _rndx_final_color.z;
  }
