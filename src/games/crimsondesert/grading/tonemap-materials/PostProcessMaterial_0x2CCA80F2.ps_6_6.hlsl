...
float4 main(
  ...
  while(true) {
    ...
    if (_209) {
        ...
        float3 _rndx_tonemapped_color = TonemapReplacer(float3(_184, _188, _192));
        _457 = _rndx_tonemapped_color.x;
        _464 = _rndx_tonemapped_color.y;
        _471 = _rndx_tonemapped_color.z;
