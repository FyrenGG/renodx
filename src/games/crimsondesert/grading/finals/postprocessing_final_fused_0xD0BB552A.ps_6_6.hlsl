...
float4 main(
  ...
  _214 = saturate(_etcParams.w);
  _215 = (_210 * saturate(_rndx_tonemapped_color.x)) + _214;
  _216 = (_210 * saturate(_rndx_tonemapped_color.y)) + _214;
  _217 = (_210 * saturate(_rndx_tonemapped_color.z)) + _214;
  ...
  _284 = 2.200000047683716f / ((min(max(_userImageAdjust.w, -1.0f), 1.0f) * 0.800000011920929f) + 2.200000047683716f);
  _295 = (TEXCOORD.x * 2.0f) + -1.0f;
  _296 = TEXCOORD.y * 2.0f;
  _297 = 1.0f - _296;
  _325 = mad((_projToPrevProj[2].w), 1.0000000116860974e-07f, mad((_projToPrevProj[1].w), _297, ((_projToPrevProj[0].w) * _295))) + (_projToPrevProj[3].w);
  _328 = ((mad((_projToPrevProj[2].x), 1.0000000116860974e-07f, mad((_projToPrevProj[1].x), _297, ((_projToPrevProj[0].x) * _295))) + (_projToPrevProj[3].x)) / _325) - _295;
  _329 = ((mad((_projToPrevProj[2].y), 1.0000000116860974e-07f, mad((_projToPrevProj[1].y), _297, ((_projToPrevProj[0].y) * _295))) + (_projToPrevProj[3].y)) / _325) - _297;
  ...
  _346 = abs(_295);
  _347 = abs(_296 + -1.0f);
  _351 = saturate(1.0f - ((_343 * _postProcessParams.x * CUSTOM_VIGNETTE) * dot(float2(_346, _347), float2(_346, _347))));  // [sem: expr_sat]
