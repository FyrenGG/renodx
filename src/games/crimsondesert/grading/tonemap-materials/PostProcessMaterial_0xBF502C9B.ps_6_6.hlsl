        ...
        while(true) {
          ...
          while(true) {
            ...
            if (_227) {
              ...
              float3 _rndx_tonemapped_color = TonemapReplacer(float3(_205, _206, _207));
            ...
            if (_etcParams.y > 1.0f) {
              ...
              _596 = saturate(1.0f - (dot(float2(_591, _592), float2(_591, _592)) * _rndx_vignette_strength));  // [sem: expr_sat]
