...
float4 main(
  ...
  _86 = mad((_invViewProj[2].w), _50, mad((_invViewProj[1].w), _49, ((_invViewProj[0].w) * _47))) + (_invViewProj[3].w);
  ...
  _103 = _100 - ((mad((_invViewProj[2].x), _50, mad((_invViewProj[1].x), _49, ((_invViewProj[0].x) * _47))) + (_invViewProj[3].x)) / _86);
  _105 = _102 - ((mad((_invViewProj[2].z), _50, mad((_invViewProj[1].z), _49, ((_invViewProj[0].z) * _47))) + (_invViewProj[3].z)) / _86);
  _106 = (_101 - ((mad((_invViewProj[2].y), _50, mad((_invViewProj[1].y), _49, ((_invViewProj[0].y) * _47))) + (_invViewProj[3].y)) / _86)) + 1.600000023841858f;
  ...
  _165 = (pow(_19.x, 0.012683313339948654f));  // [sem: _3__36__0__0__g_sceneColor_sample_derived]
  ...
  _178 = _177 * exp2(log2(max(0.0f, (_165 + -0.8359375f)) / (18.8515625f - (_165 * 18.6875f))) * 6.277394771575928f);
  _179 = _177 * exp2(log2(max(0.0f, (_26 + -0.8359375f)) / (18.8515625f - (_26 * 18.6875f))) * 6.277394771575928f);
  _180 = _177 * exp2(log2(max(0.0f, (_27 + -0.8359375f)) / (18.8515625f - (_27 * 18.6875f))) * 6.277394771575928f);
  ...
  if (_197) {
    ...
    if (_etcParams.z == 0.0f) {
      ...
      _538 = 2.200000047683716f / ((min(max(_userImageAdjust.w, -1.0f), 1.0f) * 0.800000011920929f) + 2.200000047683716f);
  ...
  _627 = exp2(log2(_615 * 9.999999747378752e-05f) * 0.1593017578125f);
  _628 = exp2(log2(_616 * 9.999999747378752e-05f) * 0.1593017578125f);
