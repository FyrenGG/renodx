...
float4 main(
  ...
  _674 = saturate(_etcParams.w);
  _675 = (_670 * saturate(_rndx_tonemapped_color.x)) + _674;
  _676 = (_670 * saturate(_rndx_tonemapped_color.y)) + _674;
  _677 = (_670 * saturate(_rndx_tonemapped_color.z)) + _674;
  ...
  _708 = (pow(_699, 0.012683313339948654f));
  _709 = (pow(_700, 0.012683313339948654f));
  _710 = (pow(_701, 0.012683313339948654f));
  _736 = (TEXCOORD.x * 2.0f) + -1.0f;
  _737 = TEXCOORD.y * 2.0f;
  _738 = 1.0f - _737;
  _766 = mad((_projToPrevProj[2].w), 1.0000000116860974e-07f, mad((_projToPrevProj[1].w), _738, ((_projToPrevProj[0].w) * _736))) + (_projToPrevProj[3].w);
  _769 = ((mad((_projToPrevProj[2].x), 1.0000000116860974e-07f, mad((_projToPrevProj[1].x), _738, ((_projToPrevProj[0].x) * _736))) + (_projToPrevProj[3].x)) / _766) - _736;
  _770 = ((mad((_projToPrevProj[2].y), 1.0000000116860974e-07f, mad((_projToPrevProj[1].y), _738, ((_projToPrevProj[0].y) * _736))) + (_projToPrevProj[3].y)) / _766) - _738;
  ...
  _786 = abs(_736);
  _787 = abs(_737 + -1.0f);
  _791 = saturate(1.0f - ((_783 * _postProcessParams.x * CUSTOM_VIGNETTE) * dot(float2(_786, _787), float2(_786, _787))));  // [sem: expr_sat]
  _801 = exp2(log2(_791 * exp2(log2(max(0.0f, (_708 + -0.8359375f)) / (18.8515625f - (_708 * 18.6875f))) * 6.277394771575928f)) * 0.1593017578125f);
  _802 = exp2(log2(_791 * exp2(log2(max(0.0f, (_709 + -0.8359375f)) / (18.8515625f - (_709 * 18.6875f))) * 6.277394771575928f)) * 0.1593017578125f);
  _803 = exp2(log2(_791 * exp2(log2(max(0.0f, (_710 + -0.8359375f)) / (18.8515625f - (_710 * 18.6875f))) * 6.277394771575928f)) * 0.1593017578125f);
  if (!(SV_Position.y < _viewDir.w)) {
    if (!(SV_Position.y >= (_screenSizeAndInvSize.y - _viewDir.w))) {
      _841 = exp2(log2((1.0f / ((_801 * 18.6875f) + 1.0f)) * ((_801 * 18.8515625f) + 0.8359375f)) * 78.84375f);
      _842 = exp2(log2((1.0f / ((_802 * 18.6875f) + 1.0f)) * ((_802 * 18.8515625f) + 0.8359375f)) * 78.84375f);
      _843 = exp2(log2((1.0f / ((_803 * 18.6875f) + 1.0f)) * ((_803 * 18.8515625f) + 0.8359375f)) * 78.84375f);
    } else {
      _841 = 0.0f;
      _842 = 0.0f;
      _843 = 0.0f;
