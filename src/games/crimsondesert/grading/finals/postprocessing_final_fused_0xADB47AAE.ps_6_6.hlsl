...
float4 main(
  ...
  _889 = saturate(_etcParams.w);
  _890 = (_885 * saturate(_rndx_tonemapped_color.x)) + _889;
  _891 = (_885 * saturate(_rndx_tonemapped_color.y)) + _889;
  _892 = (_885 * saturate(_rndx_tonemapped_color.z)) + _889;
  ...
  _960 = 2.200000047683716f / ((min(max(_userImageAdjust.w, -1.0f), 1.0f) * 0.800000011920929f) + 2.200000047683716f);
  _971 = (TEXCOORD.x * 2.0f) + -1.0f;
  _972 = TEXCOORD.y * 2.0f;
  _973 = 1.0f - _972;
  _1001 = mad((_projToPrevProj[2].w), 1.0000000116860974e-07f, mad((_projToPrevProj[1].w), _973, ((_projToPrevProj[0].w) * _971))) + (_projToPrevProj[3].w);
  _1004 = ((mad((_projToPrevProj[2].x), 1.0000000116860974e-07f, mad((_projToPrevProj[1].x), _973, ((_projToPrevProj[0].x) * _971))) + (_projToPrevProj[3].x)) / _1001) - _971;
  _1005 = ((mad((_projToPrevProj[2].y), 1.0000000116860974e-07f, mad((_projToPrevProj[1].y), _973, ((_projToPrevProj[0].y) * _971))) + (_projToPrevProj[3].y)) / _1001) - _973;
  ...
  _1023 = abs(_971);
  _1024 = abs(_972 + -1.0f);
  _1028 = saturate(1.0f - ((_1020 * _postProcessParams.x * CUSTOM_VIGNETTE) * dot(float2(_1023, _1024), float2(_1023, _1024))));  // [sem: expr_sat]
