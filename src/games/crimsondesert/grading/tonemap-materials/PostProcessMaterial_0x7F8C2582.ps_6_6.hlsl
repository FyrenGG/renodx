...
float4 main(
  ...
  if (_457) {
    ...
    float3 _rndx_tonemapped_color = TonemapReplacer(float3(_440, _439, _438));
    _705 = _rndx_tonemapped_color.x;
    _712 = _rndx_tonemapped_color.y;
    _719 = _rndx_tonemapped_color.z;
