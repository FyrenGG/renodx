...
float4 main(
  ...
  if (_1289) {
    _1295 = _exposure0.x * _userImageAdjust.z;
    _1314 = exp2(_powerParams.x * log2(max(0.0f, (((_1295 * max(0.0f, (((_1271 * -0.62179f) - (_1270 * 0.08326f)) + (_1272 * 1.70505f)))) * _slopeParams.x) + _offsetParams.x))));
    _1330 = exp2(log2(max(0.0f, (((_slopeParams.y * _1295) * max(0.0f, (((_1271 * 1.1408f) - (_1270 * 0.01055f)) - (_1272 * 0.13026f)))) + _offsetParams.y))) * _powerParams.y);
    _1346 = exp2(log2(max(0.0f, (((_slopeParams.z * _1295) * max(0.0f, (((_1270 * 1.15297f) - (_1271 * 0.12897f)) - (_1272 * 0.024f)))) + _offsetParams.z))) * _powerParams.z);
    _1347 = dot(float3(_1314, _1330, _1346), float3(0.212671f, 0.71516f, 0.072169f));
    _1351 = ((_1314 - _1347) * _powerParams.w) + _1347;
    _1354 = ((_1330 - _1347) * _powerParams.w) + _1347;
    _1357 = ((_1346 - _1347) * _powerParams.w) + _1347;
    _1364 = min(max(log2(mad(_1357, 0.079223745f, mad(_1354, 0.0784336f, (_1351 * 0.84247905f)))), -12.47393f), 4.026069f) + 12.47393f;
    _1371 = min(max(log2(mad(_1357, 0.07916613f, mad(_1354, 0.87846863f, (_1351 * 0.042328242f)))), -12.47393f), 4.026069f) + 12.47393f;
    _1378 = min(max(log2(mad(_1357, 0.879143f, mad(_1354, 0.0784336f, (_1351 * 0.042375654f)))), -12.47393f), 4.026069f) + 12.47393f;
    _1379 = _1364 * 0.060606062f;
    _1380 = _1371 * 0.060606062f;
    _1381 = _1378 * 0.060606062f;
    _1382 = _1379 * _1379;
    _1383 = _1380 * _1380;
    _1384 = _1381 * _1381;
    _1400 = min(0.0f, (-0.0f - (((_1364 * 0.0072181816f) + ((_1382 * 0.4298f) + (((_1382 * _1382) * ((31.96f - (_1364 * 2.4327273f)) + (_1382 * 15.5f))) - ((_1364 * 0.41624245f) * _1382)))) + -0.00232f)));
    _1416 = min(0.0f, (-0.0f - (((_1371 * 0.0072181816f) + ((_1383 * 0.4298f) + (((_1383 * _1383) * ((31.96f - (_1371 * 2.4327273f)) + (_1383 * 15.5f))) - ((_1371 * 0.41624245f) * _1383)))) + -0.00232f)));
    _1432 = min(0.0f, (-0.0f - (((_1378 * 0.0072181816f) + ((_1384 * 0.4298f) + (((_1384 * _1384) * ((31.96f - (_1378 * 2.4327273f)) + (_1384 * 15.5f))) - ((_1378 * 0.41624245f) * _1384)))) + -0.00232f)));
    _1433 = -0.0f - _1400;
    _1434 = -0.0f - _1416;
    _1435 = -0.0f - _1432;
    _1436 = dot(float3(_1433, _1434, _1435), float3(0.2126f, 0.7152f, 0.0722f));
    if (_nightToneParm == 1) {
      _1453 = exp2(exp2(log2(abs((_time.w * 0.11666667f) + -1.4f)) * 8.0f) * -1.442695f) + 1.0f;
      _1454 = -0.79999995f / _1453;
      _1455 = -1.2f / _1453;
      _1456 = 0.20000005f / _1453;
      _1459 = saturate((_exposure2.x + -0.6f) * 0.10638298f);  // [sem: expr_sat]
      _1462 = saturate((_exposure2.x + -0.1f) * 2.0f);  // [sem: expr_sat]
      _1466 = (_1454 + 1.4f) + (_1462 * (-0.39999998f - _1454));
      _1470 = (_1455 + 1.6f) + (_1462 * (-0.6f - _1455));
      _1474 = (_1456 + 0.9f) + (_1462 * (0.5f - _1456));
      _1491 = (lerp(_1474, 1.4f, _1459));  // [sem: blended]
      _1492 = (lerp(_1466, 1.0f, _1459));  // [sem: blended]
      _1493 = (lerp(_1470, 1.2f, _1459));  // [sem: blended]
    } else {
      _1491 = 1.4f;  // [sem: blended]
      _1492 = 1.0f;  // [sem: blended]
      _1493 = ((saturate((_exposure2.x + -3.0f) * 0.14285715f) * 0.20000005f) + 1.0f);  // [sem: blended]
    }
    _1494 = 1.0f - _1493;
    _1506 = ((exp2(log2(((saturate((_1400 * _1400) * _1433) * _1494) + _1493) * _1433) * _1492) - _1436) * _1491) + _1436;
    _1518 = ((exp2(log2(((saturate((_1416 * _1416) * _1434) * _1494) + _1493) * _1434) * _1492) - _1436) * _1491) + _1436;
    _1530 = ((exp2(log2(((saturate((_1432 * _1432) * _1435) * _1494) + _1493) * _1435) * _1492) - _1436) * _1491) + _1436;
    _1537 = saturate(exp2(log2(mad(_1530, -0.09902974f, mad(_1518, -0.09802088f, (_1506 * 1.196879f)))) * 2.2f));  // [sem: expr_sat]
    _1544 = saturate(exp2(log2(mad(_1530, -0.098961174f, mad(_1518, 1.1519032f, (_1506 * -0.052896854f)))) * 2.2f));  // [sem: expr_sat]
    _1551 = saturate(exp2(log2(mad(_1530, 1.1510737f, mad(_1518, -0.09804345f, (_1506 * -0.052971635f)))) * 2.2f));  // [sem: expr_sat]
  ...
  if (_etcParams.y > 1.0f) {
    ...
    _1658 = saturate(1.0f - (saturate(_etcParams.y + -1.0f) * dot(float2(_1649, _1652), float2(_1649, _1652))));  // [sem: expr_sat]
    _1663 = (_1658 * _1642);
    _1664 = (_1658 * _1643);
    _1665 = (_1658 * _1644);
  } else {
