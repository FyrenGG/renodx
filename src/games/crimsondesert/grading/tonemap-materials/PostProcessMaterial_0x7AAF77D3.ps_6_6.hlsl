...
float4 main(
  ...
  while(true) {
    ...
    if (_429) {
      _435 = _userImageAdjust.z * _exposure0.x;
      _484 = exp2(log2(max(0.0f, (((_435 * max(0.0f, (((_410 * 1.70505f) - (_411 * 0.62179f)) - (_412 * 0.08326f)))) * _slopeParams.x) + _offsetParams.x))) * _powerParams.x);
      _485 = exp2(log2(max(0.0f, (((max(0.0f, (((_411 * 1.1408f) - (_410 * 0.13026f)) - (_412 * 0.01055f))) * _435) * _slopeParams.y) + _offsetParams.y))) * _powerParams.y);
      _486 = exp2(log2(max(0.0f, (((max(0.0f, (((_410 * -0.024f) - (_411 * 0.12897f)) + (_412 * 1.15297f))) * _435) * _slopeParams.z) + _offsetParams.z))) * _powerParams.z);
      _488 = dot(float3(_484, _485, _486), float3(0.212671f, 0.71516f, 0.072169f));
      _495 = ((_484 - _488) * _powerParams.w) + _488;
      _496 = ((_485 - _488) * _powerParams.w) + _488;
      _497 = ((_486 - _488) * _powerParams.w) + _488;
      _516 = min(max(log2(mad(_497, 0.079223745f, mad(_496, 0.0784336f, (_495 * 0.84247905f)))), -12.47393f), 4.026069f) + 12.47393f;
      _517 = min(max(log2(mad(_497, 0.07916613f, mad(_496, 0.87846863f, (_495 * 0.042328242f)))), -12.47393f), 4.026069f) + 12.47393f;
      _518 = min(max(log2(mad(_497, 0.879143f, mad(_496, 0.0784336f, (_495 * 0.042375654f)))), -12.47393f), 4.026069f) + 12.47393f;
      _519 = _516 * 0.060606062f;
      _520 = _517 * 0.060606062f;
      _521 = _518 * 0.060606062f;
      _522 = _519 * _519;
      _523 = _520 * _520;
      _524 = _521 * _521;
      _570 = min(0.0f, (-0.0f - (((_516 * 0.0072181816f) + ((_522 * 0.4298f) + (((_522 * _522) * ((31.96f - (_516 * 2.4327273f)) + (_522 * 15.5f))) - ((_516 * 0.41624245f) * _522)))) + -0.00232f)));
      ...
      _572 = min(0.0f, (-0.0f - (((_518 * 0.0072181816f) + ((_524 * 0.4298f) + (((_524 * _524) * ((31.96f - (_518 * 2.4327273f)) + (_524 * 15.5f))) - ((_518 * 0.41624245f) * _524)))) + -0.00232f)));
      _573 = -0.0f - _570;
      _574 = -0.0f - _571;
      _575 = -0.0f - _572;
      _576 = dot(float3(_573, _574, _575), float3(0.2126f, 0.7152f, 0.0722f));
      if (_nightToneParm == 1) {
        _593 = exp2(exp2(log2(abs((_time.w * 0.11666667f) + -1.4f)) * 8.0f) * -1.442695f) + 1.0f;
        _594 = -0.79999995f / _593;
        _595 = -1.2f / _593;
        _596 = 0.20000005f / _593;
        _602 = saturate((_exposure2.x + -0.6f) * 0.10638298f);  // [sem: expr_sat]
        _605 = saturate((_exposure2.x + -0.1f) * 2.0f);  // [sem: expr_sat]
        _612 = (_594 + 1.4f) + (_605 * (-0.39999998f - _594));
        _613 = (_595 + 1.6f) + (_605 * (-0.6f - _595));
        _614 = (_596 + 0.9f) + (_605 * (0.5f - _596));
        _631 = (lerp(_613, 1.2f, _602));  // [sem: blended]
        _632 = (lerp(_612, 1.0f, _602));  // [sem: blended]
        _633 = (lerp(_614, 1.4f, _602));  // [sem: blended]
      } else {
        _631 = ((saturate((_exposure2.x + -3.0f) * 0.14285715f) * 0.20000005f) + 1.0f);  // [sem: blended]
        _632 = 1.0f;  // [sem: blended]
        _633 = 1.4f;  // [sem: blended]
      }
      _643 = 1.0f - _631;
      _668 = ((exp2(log2(((saturate((_570 * _570) * _573) * _643) + _631) * _573) * _632) - _576) * _633) + _576;
      _669 = ((exp2(log2(((saturate((_571 * _571) * _574) * _643) + _631) * _574) * _632) - _576) * _633) + _576;
      _670 = ((exp2(log2(((saturate((_572 * _572) * _575) * _643) + _631) * _575) * _632) - _576) * _633) + _576;
      _689 = saturate(exp2(log2(mad(_670, -0.09902974f, mad(_669, -0.09802088f, (_668 * 1.196879f)))) * 2.2f));  // [sem: expr_sat]
      _690 = saturate(exp2(log2(mad(_670, -0.098961174f, mad(_669, 1.1519032f, (_668 * -0.052896854f)))) * 2.2f));  // [sem: expr_sat]
      _691 = saturate(exp2(log2(mad(_670, 1.1510737f, mad(_669, -0.09804345f, (_668 * -0.052971635f)))) * 2.2f));  // [sem: expr_sat]
