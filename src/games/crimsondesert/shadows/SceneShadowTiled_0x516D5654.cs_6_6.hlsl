...
void main(
  ...
  if ((_79 < 1.0000000116860974e-07f) || _107) {
    ...
    if (_2284 > 0.0f) {
      ...
      // Description: SceneShadowTiledCS 0x54654561 uses this native contact ray direction on Lighting High/Ultra with Sun/Moon RT enabled; stable direction keeps Contact Micro Shadows from inheriting per-frame random cone wobble when the feature is enabled.
