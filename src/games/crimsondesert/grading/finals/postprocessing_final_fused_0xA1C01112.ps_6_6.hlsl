...
float4 main(
  ...
  _271 = saturate(_etcParams.w);
  _272 = (_267 * saturate(_rndx_tonemapped_color.x)) + _271;
  _273 = (_267 * saturate(_rndx_tonemapped_color.y)) + _271;
  _274 = (_267 * saturate(_rndx_tonemapped_color.z)) + _271;
  ...
  _341 = 2.200000047683716f / ((min(max(_userImageAdjust.w, -1.0f), 1.0f) * 0.800000011920929f) + 2.200000047683716f);
  _352 = (TEXCOORD.x * 2.0f) + -1.0f;
  _353 = TEXCOORD.y * 2.0f;
  _354 = 1.0f - _353;
  _382 = mad((_projToPrevProj[2].w), 1.0000000116860974e-07f, mad((_projToPrevProj[1].w), _354, ((_projToPrevProj[0].w) * _352))) + (_projToPrevProj[3].w);
  _385 = ((mad((_projToPrevProj[2].x), 1.0000000116860974e-07f, mad((_projToPrevProj[1].x), _354, ((_projToPrevProj[0].x) * _352))) + (_projToPrevProj[3].x)) / _382) - _352;
  _386 = ((mad((_projToPrevProj[2].y), 1.0000000116860974e-07f, mad((_projToPrevProj[1].y), _354, ((_projToPrevProj[0].y) * _352))) + (_projToPrevProj[3].y)) / _382) - _354;
  ...
  _403 = abs(_352);
  _404 = abs(_353 + -1.0f);
  _408 = saturate(1.0f - ((_400 * _postProcessParams.x * CUSTOM_VIGNETTE) * dot(float2(_403, _404), float2(_403, _404))));  // [sem: expr_sat]
