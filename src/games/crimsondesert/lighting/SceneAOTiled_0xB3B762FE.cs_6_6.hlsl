    ...
    while(true) {
      ...
      while(true) {
        ...
        if (!(_713 == 0)) {
          ...
          // [sem: expr_sat]
          _756 = saturate((saturate(1.0f - exp2(log2(select((_terrainNormalParams.z > 0.0f), 0.2f, 0.6f)) * max(_734, (((_674 * 20.0f) * (1.0f - saturate(max((_673 + -100.0f), 0.0f) * 0.05f))) / ((_673 * 0.2f) + 1.0f))))) * (1.0f - _654)) + _654);
        } else {
          _755 = _653;
