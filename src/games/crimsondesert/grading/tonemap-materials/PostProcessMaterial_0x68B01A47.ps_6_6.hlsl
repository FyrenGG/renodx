...
float4 main(
  ...
  while(true) {
    ...
    if (_2297) {
      ...
      float3 _rndx_tonemapped_color = TonemapReplacer(float3(_2256, _2268, _2280));
      _2545 = _rndx_tonemapped_color.x;
      _2552 = _rndx_tonemapped_color.y;
      _2559 = _rndx_tonemapped_color.z;
