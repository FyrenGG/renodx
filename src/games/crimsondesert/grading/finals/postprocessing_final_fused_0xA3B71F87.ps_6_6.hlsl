...
float4 main(
  ...
  _201 = saturate(_etcParams.w);
  _202 = (_197 * saturate(_rndx_tonemapped_color.x)) + _201;
  _203 = (_197 * saturate(_rndx_tonemapped_color.y)) + _201;
  _204 = (_197 * saturate(_rndx_tonemapped_color.z)) + _201;
  ...
  _271 = 2.200000047683716f / ((min(max(_userImageAdjust.w, -1.0f), 1.0f) * 0.800000011920929f) + 2.200000047683716f);
  _282 = (TEXCOORD.x * 2.0f) + -1.0f;
  _283 = TEXCOORD.y * 2.0f;
  _284 = 1.0f - _283;
  _312 = mad((_projToPrevProj[2].w), 1.0000000116860974e-07f, mad((_projToPrevProj[1].w), _284, ((_projToPrevProj[0].w) * _282))) + (_projToPrevProj[3].w);
  _315 = ((mad((_projToPrevProj[2].x), 1.0000000116860974e-07f, mad((_projToPrevProj[1].x), _284, ((_projToPrevProj[0].x) * _282))) + (_projToPrevProj[3].x)) / _312) - _282;
  _316 = ((mad((_projToPrevProj[2].y), 1.0000000116860974e-07f, mad((_projToPrevProj[1].y), _284, ((_projToPrevProj[0].y) * _282))) + (_projToPrevProj[3].y)) / _312) - _284;
  ...
  _333 = abs(_282);
  _334 = abs(_283 + -1.0f);
  _338 = saturate(1.0f - ((_330 * _postProcessParams.x * CUSTOM_VIGNETTE) * dot(float2(_333, _334), float2(_333, _334))));  // [sem: expr_sat]
