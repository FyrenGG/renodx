...
float4 main(
  ...
  _90 = _exposure0.x * 0.6499999761581421f;
  ...
  _747 = saturate(_etcParams.w);
  _748 = (_743 * saturate(_rndx_tonemapped_color.x)) + _747;
  _749 = (_743 * saturate(_rndx_tonemapped_color.y)) + _747;
  _750 = (_743 * saturate(_rndx_tonemapped_color.z)) + _747;
  ...
  _830 = 1.0f - _829;
  _858 = mad((_projToPrevProj[2].w), 1.0000000116860974e-07f, mad((_projToPrevProj[1].w), _830, ((_projToPrevProj[0].w) * _828))) + (_projToPrevProj[3].w);
  _861 = ((mad((_projToPrevProj[2].x), 1.0000000116860974e-07f, mad((_projToPrevProj[1].x), _830, ((_projToPrevProj[0].x) * _828))) + (_projToPrevProj[3].x)) / _858) - _828;
  _862 = ((mad((_projToPrevProj[2].y), 1.0000000116860974e-07f, mad((_projToPrevProj[1].y), _830, ((_projToPrevProj[0].y) * _828))) + (_projToPrevProj[3].y)) / _858) - _830;
  ...
  _879 = abs(_828);
  _880 = abs(_829 + -1.0f);
  _884 = saturate(1.0f - ((_876 * _postProcessParams.x * CUSTOM_VIGNETTE) * dot(float2(_879, _880), float2(_879, _880))));  // [sem: expr_sat]
