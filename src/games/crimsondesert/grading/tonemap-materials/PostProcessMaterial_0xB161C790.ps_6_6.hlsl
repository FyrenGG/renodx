...
float4 main(
  ...
  if (_551) {
    ...
    float3 _rndx_tonemapped_color = TonemapReplacer(float3(_528, _531, _534));
    _799 = _rndx_tonemapped_color.x;
    _806 = _rndx_tonemapped_color.y;
    _813 = _rndx_tonemapped_color.z;
