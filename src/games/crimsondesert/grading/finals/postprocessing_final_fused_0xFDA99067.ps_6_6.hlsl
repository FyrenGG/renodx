...
float4 main(
  ...
  _148 = saturate(_etcParams.w);
  _170 = (_147 * saturate(_rndx_tonemapped_color.x)) + _148;
  _163 = (_147 * saturate(_rndx_tonemapped_color.y)) + _148;
  _156 = (_147 * saturate(_rndx_tonemapped_color.z)) + _148;
  ...
  _271 = saturate(1.0f - ((_262 * _postProcessParams.x * CUSTOM_VIGNETTE) * dot(float2(_263, _265), float2(_263, _265))));  // [sem: expr_sat]
