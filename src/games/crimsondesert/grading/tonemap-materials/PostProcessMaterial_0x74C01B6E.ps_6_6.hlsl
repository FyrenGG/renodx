...
float4 main(
  ...
  while(true) {
    ...
    if (_1981) {
      ...
      float3 _rndx_tonemapped_color = TonemapReplacer(float3(_1908, _1931, _1960));
      _2227 = _rndx_tonemapped_color.x;
      _2234 = _rndx_tonemapped_color.y;
      _2241 = _rndx_tonemapped_color.z;
    ...
    if (_etcParams.y > 1.0f) {
      ...
      _2346 = saturate(1.0f - (dot(float2(_2337, _2340), float2(_2337, _2340)) * _rndx_vignette_strength));  // [sem: expr_sat]
    ...
    if (CUSTOM_BASIC_POSTPROCESS_FINAL == 1.f && !(_etcParams.z > 0.0f)) {
      float3 _rndx_final_color = FinalizeSDR(float3(_2399, _2400, _2401), _sunDirection.y, _moonDirection.y);
      _2399 = _rndx_final_color.x;
      _2400 = _rndx_final_color.y;
      _2401 = _rndx_final_color.z;
    }
