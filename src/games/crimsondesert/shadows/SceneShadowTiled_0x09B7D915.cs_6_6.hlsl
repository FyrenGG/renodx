...
void main(
  ...
  if ((_77 < 1e-07f) || _105) {
    ...
    if (_1285 > 0.0f) {
      ...
      _1421 = ((abs(_1316) * (select(_1298, 12.0f, 2.0f) - _1299)) + _1299) * select(_168, 0.01f, 0.1f);
      if (!_168) {
      ...
      if ((_78 == 15) && (!(_1297 || ((_78 != 15) && ((uint)((int)(_78) + (int)(-12)) < (uint)7))))) {
        _1484 = ((10.0f - (saturate(_113 * 0.001f) * 9.0f)) * _1472);
      } else {
        _1484 = _1472;
      }
      if (!_1442) {
      ...
      while(true) {
        ...
        if (!(_1721 == 0)) {
          ...
          _1764 = _1664;
          // [sem: expr_sat]
          _1765 = saturate(((saturate(1.0f - ((_1749 * _1749) * _1744)) * (1.0f - _1649)) * saturate((-0.0f - _1673) / (_1644 * 0.0046548597f))) + _1649);
        } else {
          _1764 = _1647;
