...
float4 main(
  ...
  _223 = saturate(_etcParams.w);
  _224 = (_219 * saturate(_rndx_tonemapped_color.x)) + _223;
  _225 = (_219 * saturate(_rndx_tonemapped_color.y)) + _223;
  _226 = (_219 * saturate(_rndx_tonemapped_color.z)) + _223;
  ...
  _293 = 2.200000047683716f / ((min(max(_userImageAdjust.w, -1.0f), 1.0f) * 0.800000011920929f) + 2.200000047683716f);
  _304 = (TEXCOORD.x * 2.0f) + -1.0f;
  _305 = TEXCOORD.y * 2.0f;
  _306 = 1.0f - _305;
  _334 = mad((_projToPrevProj[2].w), 1.0000000116860974e-07f, mad((_projToPrevProj[1].w), _306, ((_projToPrevProj[0].w) * _304))) + (_projToPrevProj[3].w);
  _337 = ((mad((_projToPrevProj[2].x), 1.0000000116860974e-07f, mad((_projToPrevProj[1].x), _306, ((_projToPrevProj[0].x) * _304))) + (_projToPrevProj[3].x)) / _334) - _304;
  _338 = ((mad((_projToPrevProj[2].y), 1.0000000116860974e-07f, mad((_projToPrevProj[1].y), _306, ((_projToPrevProj[0].y) * _304))) + (_projToPrevProj[3].y)) / _334) - _306;
  ...
  _355 = abs(_304);
  _356 = abs(_305 + -1.0f);
  _360 = saturate(1.0f - ((_352 * _postProcessParams.x * CUSTOM_VIGNETTE) * dot(float2(_355, _356), float2(_355, _356))));  // [sem: expr_sat]
