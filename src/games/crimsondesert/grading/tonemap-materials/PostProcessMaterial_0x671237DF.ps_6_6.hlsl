...
float4 main(
  ...
  if (((_highLightForVisionRemoteCatch > 0.0f) || (_highLightForVision > 0.0f)) || (_characterHighlight > 0.0f)) {
    ...
    _244 = (pow(_234.x, 0.012683313f));  // [sem: _3__36__0__0__g_sceneColor_sample_derived]
    _245 = (pow(_234.y, 0.012683313f));  // [sem: _3__36__0__0__g_sceneColor_sample_derived]
    _246 = (pow(_234.z, 0.012683313f));  // [sem: _3__36__0__0__g_sceneColor_sample_derived]
    _271 = exp2(log2(max(0.0f, (_244 + -0.8359375f)) / (18.851562f - (_244 * 18.6875f))) * 6.277395f) * 10000.0f;
    _272 = exp2(log2(max(0.0f, (_245 + -0.8359375f)) / (18.851562f - (_245 * 18.6875f))) * 6.277395f) * 10000.0f;
    _273 = exp2(log2(max(0.0f, (_246 + -0.8359375f)) / (18.851562f - (_246 * 18.6875f))) * 6.277395f) * 10000.0f;
    if (_196 == _renderPassDetectObjective) {
      ...
      _312 = max(1e-07f, _310.x);
      _348 = mad((_invViewProj[3].z), _312, mad((_invViewProj[3].y), _71, ((_invViewProj[3].x) * _69))) + (_invViewProj[3].w);
      _378 = _301;
      _379 = ((mad((_invViewProj[0].z), _312, mad((_invViewProj[0].y), _71, ((_invViewProj[0].x) * _69))) + (_invViewProj[0].w)) / _348);
      _380 = ((mad((_invViewProj[1].z), _312, mad((_invViewProj[1].y), _71, ((_invViewProj[1].x) * _69))) + (_invViewProj[1].w)) / _348);
      _381 = ((mad((_invViewProj[2].z), _312, mad((_invViewProj[2].y), _71, ((_invViewProj[2].x) * _69))) + (_invViewProj[2].w)) / _348);
      _382 = _310.x;
      _383 = (((float)((uint)((uint)((((uint)(__3__36__0__0__g_depthOpaque.Load(int3(((int)((uint)((_bufferSizeAndInvSize.x * _144) + -0.5f))), ((int)((uint)((_bufferSizeAndInvSize.y * _145) + -0.5f))), 0)))).x) & 16777215)))) * 5.960465e-08f);
    ...
    if (!(_196 == _378)) {
      ...
      _395 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)((uint)(select(((uint)_387 < (uint)170000), _387, 0))) + (uint)(0)))].BindlessParameters_PostProcessUber_CD._itemRatio);
      if (!(_395 > 0.001f)) {
        __branch_chain_377 = true;
      } else {
    ...
    if (__branch_chain_377) {
      if (!(_196 == _renderPassDetectObjective) || ((_196 == _renderPassDetectObjective) && ((!(_highLightForVision >= 0.001f)) && (!(_highLightForVisionRemoteCatch >= 0.001f))))) {
        if (!(_196 == _renderPassKnowledgeNPC) || ((_196 == _renderPassKnowledgeNPC) && (!(_highLightForVision >= 0.001f)))) {
              ...
              if ((uint)_158 > (uint)10) {
                if ((uint)_158 < (uint)20) {
                  if (_158 == 11) {
                    ...
                    _1028 = (pow(_1018.x, 0.012683313f));
                    _1029 = (pow(_1018.y, 0.012683313f));
                    _1030 = (pow(_1018.z, 0.012683313f));
                    _1052 = exp2(log2(max(0.0f, (_1028 + -0.8359375f)) / (18.851562f - (_1028 * 18.6875f))) * 6.277395f);
                    _1053 = exp2(log2(max(0.0f, (_1029 + -0.8359375f)) / (18.851562f - (_1029 * 18.6875f))) * 6.277395f);
                    _1054 = exp2(log2(max(0.0f, (_1030 + -0.8359375f)) / (18.851562f - (_1030 * 18.6875f))) * 6.277395f);
                    ...
                    _1101 = (((1.0f - saturate((sqrt(((_1083 * _1083) + (_1084 * _1084)) + (_1085 * _1085)) - _1075) / _1074)) * (1.0f - saturate(ceil(((_nearFarProj.x / max(1e-07f, _383)) + 0.5f) - (_nearFarProj.x / max(1e-07f, _382)))))) * max(_highLightForVisionRemoteCatch, _characterHighlight));
                    _1102 = (_1071 * 1.5f);
                    _1103 = (_1072 * 1.5f);
                    _1104 = (_1073 * 1.5f);
                  } else {
          ...
          _856 = (saturate(_838.x * 1.0009785f) * 2.0f) + -1.0f;  // [sem: _3__36__0__0__g_gbufferNormal_load_derived]
          _857 = (saturate(_838.y * 1.0009785f) * 2.0f) + -1.0f;  // [sem: _3__36__0__0__g_gbufferNormal_load_derived]
          _858 = (saturate(_838.z * 1.0009785f) * 2.0f) + -1.0f;  // [sem: _3__36__0__0__g_gbufferNormal_load_derived]
          _860 = rsqrt(dot(float3(_856, _857, _858), float3(_856, _857, _858)));  // [sem: invLength]
          _861 = _860 * _856;
          _862 = _860 * _857;
          _863 = _858 * _860;
          _866 = (((float)((uint)((uint)(((uint)((uint)(_835.w)) >> 8) & 255)))) * 0.007843138f) + -1.0f;  // [sem: _3__36__0__0__g_gbufferBaseColor_load_derived]
          _867 = (((float)((uint)((uint)(_835.w & 255)))) * 0.007843138f) + -1.0f;  // [sem: _3__36__0__0__g_gbufferBaseColor_load_derived]
          _870 = (_866 + _867) * 0.5f;
          _871 = (_866 - _867) * 0.5f;
          ...
          _922 = 1.0f - dot(float3(((_907 * _897) + -0.1f), ((_907 * _901) + -0.1f), ((_907 * _905) + -0.1f)), float3((-0.0f - _viewDir.x), (-0.0f - _viewDir.y), (-0.0f - _viewDir.z)));
          _927 = frac((_time.x * 2.0f) + _922);
          _928 = _927 * _927;
          _932 = _922 * 10.0f;
          _939 = __0__7__0__0__g_bindlessTextures[((int)((uint)((uint)(select(((uint)_167 < (uint)65000), _167, 0))) + (uint)(0)))].Sample(__0__4__0__0__g_staticBilinearWrap, float2(_932, _932));
          _941 = _939.x * _939.x;
          _960 = 6.0f / max(0.001f, _exposure0.x);
          _1101 = ((saturate((_941 * _941) * 4.0f) * saturate((_928 * _928) * 5.0f)) * saturate(ceil(((_nearFarProj.x / max(1e-07f, _383)) + 0.05f) - (_nearFarProj.x / max(1e-07f, _382)))));
          _1102 = ((_highLightForVision * (_960 - _271)) + _271);
          _1103 = ((_highLightForVision * ((_960 * 0.6444798f) - _272)) + _272);
        ...
        _518 = (1.0f - saturate(sqrt(((_506 * _506) + (_507 * _507)) + (_508 * _508)) * 0.125f)) * 0.2f;
        ...
        _559 = __0__7__0__0__g_bindlessTextures[((int)((uint)((uint)(select(((uint)_167 < (uint)65000), _167, 0))) + (uint)(0)))].Sample(__0__4__0__0__g_staticBilinearWrap, float2(((_time.x * 0.1f) + (_542 * 2.0f)), ((_547 * 0.1f) + (_541 * 2.0f))));
        _571 = __0__7__0__0__g_bindlessTextures[((int)((uint)((uint)(select(((uint)_167 < (uint)65000), _167, 0))) + (uint)(0)))].Sample(__0__4__0__0__g_staticBilinearWrap, float2(((_542 - (_time.x * 0.060000002f)) - (_559.x * 0.05f)), ((_541 - (_547 * 0.060000002f)) - (_559.w * 0.05f))));
        _591 = (uint)((((((_559.w + -1.0f) + _571.y) * 0.02f) + _144) * _bufferSizeAndInvSize.x) + -0.5f);
        _592 = (uint)((((((_559.y + -1.0f) + _571.w) * 0.02f) + _145) * _bufferSizeAndInvSize.y) + -0.5f);
        ...
        _615 = (saturate(_597.x * 1.0009785f) * 2.0f) + -1.0f;  // [sem: _3__36__0__0__g_gbufferNormal_load_derived]
        _616 = (saturate(_597.y * 1.0009785f) * 2.0f) + -1.0f;  // [sem: _3__36__0__0__g_gbufferNormal_load_derived]
        _617 = (saturate(_597.z * 1.0009785f) * 2.0f) + -1.0f;  // [sem: _3__36__0__0__g_gbufferNormal_load_derived]
        _619 = rsqrt(dot(float3(_615, _616, _617), float3(_615, _616, _617)));  // [sem: invLength]
        _620 = _619 * _615;
        _621 = _619 * _616;
        _622 = _617 * _619;
        _625 = (((float)((uint)((uint)(((uint)((uint)(_594.w)) >> 8) & 255)))) * 0.007843138f) + -1.0f;  // [sem: _3__36__0__0__g_gbufferBaseColor_load_derived]
        _626 = (((float)((uint)((uint)(_594.w & 255)))) * 0.007843138f) + -1.0f;  // [sem: _3__36__0__0__g_gbufferBaseColor_load_derived]
        _629 = (_625 + _626) * 0.5f;
        _630 = (_625 - _626) * 0.5f;
        ...
        _716 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)((uint)(select(((uint)_708 < (uint)170000), _708, 0))) + (uint)(0)))].BindlessParameters_PostProcessUber_CD._objectiveMaskColor);
        _719 = (float)((uint)((uint)(((uint)((uint)(_716)) >> 16) & 255)));
        _722 = (float)((uint)((uint)(((uint)((uint)(_716)) >> 8) & 255)));
        _724 = (float)((uint)((uint)(_716 & 255)));
        _757 = (_571.y * _571.w) * (1.0f / max(0.001f, _exposure0.x));
        // [sem: invLength]
        ...
        _1101 = (((_809 * _809) * ((1.0f - saturate(sqrt(((_788 * _788) + (_789 * _789)) + (_790 * _790)) / max(0.001f, (tan(_detectModeAngle * 0.017453292f) * _782)))) * (((_681 - _704) * saturate(ceil(((_nearFarProj.x / max(1e-07f, _383)) + 0.05f) - (_nearFarProj.x / max(1e-07f, _382))))) + _704))) * _highLightForVision);
        _1102 = (_757 * select(((_719 * 0.011764707f) < 0.04045f), (_719 * 0.00091058103f), exp2(log2((_719 * 0.011151382f) + 0.052132703f) * 2.4f)));
        _1103 = (_757 * select(((_722 * 0.011764707f) < 0.04045f), (_722 * 0.00091058103f), exp2(log2((_722 * 0.011151382f) + 0.052132703f) * 2.4f)));
        _1104 = (_757 * select(((_724 * 0.011764707f) < 0.04045f), (_724 * 0.00091058103f), exp2(log2((_724 * 0.011151382f) + 0.052132703f) * 2.4f)));
      }
    } else {
      ...
      _453 = _444 - (_441 * _446);
      _454 = _445 - (_442 * _446);
      _1101 = ((((1.0f - saturate((sqrt(((_409 * _409) + (_410 * _410)) + (_411 * _411)) + -30.0f) * 0.05f)) * saturate((_384 * _384) * 4.0f)) * (1.0f - saturate(sqrt(((_452 * _452) + (_453 * _453)) + (_454 * _454)) / max(0.001f, (tan(_detectModeAngle * 0.017453292f) * _446))))) * exp2(log2(1.0f - saturate(sqrt(((_443 * _443) + (_444 * _444)) + (_445 * _445)) / _detectModeRadius)) * 10.0f));
      _1102 = _271;
      _1103 = _272;
      _1104 = _273;
    }
  ...
  _1108 = abs(_temperatureWarning * 0.01f);
  if (_51) {
    if (_temperatureWarning > 0.0f) {
      _1115 = _67 * TEXCOORD.x;
      _1128 = __0__7__0__0__g_bindlessTextures[((int)((uint)((uint)(select(((uint)_167 < (uint)65000), _167, 0))) + (uint)(0)))].Sample(__0__4__0__0__g_staticBilinearWrap, float2((_1115 * 4.25f), ((TEXCOORD.y * 3.0f) - (_time.x * 0.15f))));
      _1140 = __0__7__0__0__g_bindlessTextures[((int)((uint)((uint)(select(((uint)_167 < (uint)65000), _167, 0))) + (uint)(0)))].Sample(__0__4__0__0__g_staticBilinearWrap, float2((_1115 * 2.3f), (((TEXCOORD.y * 2.1f) - (_1128.x * 0.1f)) + (_time.x * 0.2f))));
      _1146 = TEXCOORD.x + -0.5f;
      _1179 = abs((_1146 + ((_1128.y + -0.5f) * 0.01f)) + ((_1140.z + -0.5f) * 0.03f));
      _1180 = abs(((TEXCOORD.y + -0.5f) + ((_1128.x + -0.5f) * 0.02f)) + ((_1140.y + -0.5f) * 0.03f));
      _1183 = max((_1179 + -0.5f), 0.0f);
      _1184 = max((_1180 + -0.5f), 0.0f);
      _1191 = 0.5f - min(max((((1.0f - (saturate(abs(_1146) * 2.0f) * 0.39999998f)) * ((_1108 * 0.050000004f) + 0.1f)) * (((((_1128.z * 0.3f) + -0.5f) + (_1140.x * 0.7f)) * 1.1f) + 1.0f)), ((_1108 * 0.017500002f) + 0.035f)), ((_1108 * 0.110000014f) + 0.22000001f));
      _1194 = max((_1179 - _1191), 0.0f);
      _1195 = max((_1180 - _1191), 0.0f);
      _1206 = saturate((TEXCOORD.y + -0.15f) * 1.2500001f);  // [sem: expr_sat]
      _1222 = saturate(_1140.x * _1128.x);  // [sem: expr_sat]
      _1223 = _1108 * 0.2f;
      _1231 = ((saturate(_1108 * 2.0f) * saturate(saturate(sqrt((_1195 * _1195) + (_1194 * _1194)) * 10.0f) - saturate(sqrt((_1184 * _1184) + (_1183 * _1183)) * 10.0f))) * ((_1222 * (1.0f - _1223)) + _1223)) * ((((_1206 * _1206) * (3.0f - (_1206 * 2.0f))) * ((saturate((((_1128.x * 0.25f) + -0.35f) + (_1140.y * 0.75f)) * 1.6f) * 0.5f) + -0.35000002f)) + 1.0f);
      _1235 = _1231 * (_1108 * 0.1f);
      // [sem: _3__36__0__0__g_sceneColor_sample]
      ...
      _1253 = (pow(_1243.x, 0.012683313f));  // [sem: _3__36__0__0__g_sceneColor_sample_derived]
      _1254 = (pow(_1243.y, 0.012683313f));  // [sem: _3__36__0__0__g_sceneColor_sample_derived]
      _1255 = (pow(_1243.z, 0.012683313f));  // [sem: _3__36__0__0__g_sceneColor_sample_derived]
      _1280 = exp2(log2(max(0.0f, (_1253 + -0.8359375f)) / (18.851562f - (_1253 * 18.6875f))) * 6.277395f) * 10000.0f;
      _1281 = exp2(log2(max(0.0f, (_1254 + -0.8359375f)) / (18.851562f - (_1254 * 18.6875f))) * 6.277395f) * 10000.0f;
      _1282 = exp2(log2(max(0.0f, (_1255 + -0.8359375f)) / (18.851562f - (_1255 * 18.6875f))) * 6.277395f) * 10000.0f;
      _1283 = 1.0f - _1231;
      _1290 = ((_1283 * _1283) * _1283) * saturate(((_1222 * _1222) * 2.0f) * _1222);
      _1293 = max(0.001f, _exposure0.x);
      _1303 = (((1.0f / _1293) - _1280) * _1290) + _1280;
      _1304 = (((0.6f / _1293) - _1281) * _1290) + _1281;
      _1305 = (((0.3f / _1293) - _1282) * _1290) + _1282;
      ...
      if (_temperatureWarning < 0.0f) {
        ...
        _1346 = __0__7__0__0__g_bindlessTextures[((int)((uint)((uint)(select(((uint)_167 < (uint)65000), _167, 0))) + (uint)(0)))].Sample(__0__4__0__0__g_staticBilinearWrap, float2((_1337 * 1.5f), (TEXCOORD.y * 1.5f)));
        _1351 = WaveReadLaneFirst(_materialIndex);
        _1359 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)((uint)(select(((uint)_1351 < (uint)170000), _1351, 0))) + (uint)(0)))].BindlessParameters_PostProcessUber_CD._temperatureWarningTex);
        _1366 = __0__7__0__0__g_bindlessTextures[((int)((uint)((uint)(select(((uint)_1359 < (uint)65000), _1359, 0))) + (uint)(0)))].Sample(__0__4__0__0__g_staticBilinearWrap, float2((_1337 * 2.0f), _70));
        _1374 = (select(((TEXCOORD.y / (1.0f - TEXCOORD.x)) < 1.0f), (1.0f - _1366.y), _1366.y) + -0.5f) * 0.3f;
        _1376 = (_1346.x + -0.4f) * 0.2f;
        _1384 = max(0.001f, _exposure0.x);
        _1397 = 0.5f - (_1108 * 0.25f);
        _1400 = max((abs(((TEXCOORD.x + -0.5f) + _1376) + _1374) - _1397), 0.0f);
        _1401 = max((abs(((_1374 + _1376) + -0.475f) + (TEXCOORD.y * 0.9f)) - _1397), 0.0f);
        _1423 = (_1108 * (1.0f - TEXCOORD.y)) * saturate((((_1366.y * 4.0f) * saturate(1.0f - ((1.0f - saturate(sqrt((_1401 * _1401) + (_1400 * _1400)) * 6.6666665f)) * 2.0f))) * saturate((_1366.y * _1366.y) * 2.0f)) * saturate(_1346.z * _1346.w));
        _1435 = (_1423 + _1101);
        _1436 = ((_1423 * ((((_1346.w * 1.8809775f) + 0.11902248f) / _1384) - _1102)) + _1102);
        _1437 = ((_1423 * ((((_1346.w * 1.3989123f) + 0.6010877f) / _1384) - _1103)) + _1103);
  ...
  if (!(_electrocutionWarning == 0.0f)) {
    ...
    _1452 = __0__7__0__0__g_bindlessTextures[((int)((uint)((uint)(select(((uint)_167 < (uint)65000), _167, 0))) + (uint)(0)))].Sample(__0__4__0__0__g_staticBilinearWrap, float2((_1443 * 1.5f), (TEXCOORD.y * 1.5f)));
    _1465 = WaveReadLaneFirst(_materialIndex);
    _1473 = WaveReadLaneFirst(BindlessParameters_PostProcessUber_CD[((int)((uint)((uint)(select(((uint)_1465 < (uint)170000), _1465, 0))) + (uint)(0)))].BindlessParameters_PostProcessUber_CD._electrocutionTex);
    _1484 = max(0.001f, _exposure0.x);
    _1493 = 0.5f - (_electrocutionWarning * 0.07f);
    ...
    _1515 = (_1512 * _1512) * (saturate(sqrt((_1497 * _1497) + (_1496 * _1496)) / _1452.z) * (((float4)(__0__7__0__0__g_bindlessTextures[((int)((uint)((uint)(select(((uint)_1473 < (uint)65000), _1473, 0))) + (uint)(0)))].Sample(__0__4__0__0__g_staticBilinearWrap, float2(((_1452.x * 0.05f) + (_1443 * 2.0f)), (((_1452.y * 0.05f) + _70) + (_time.x * 0.1f)))))).x));
    _1518 = (pow(_1515, 1.6f));
    _1530 = (_1515 + _1435);
  ...
  if (_1551) {
    _1557 = _userImageAdjust.z * _exposure0.x;
    _1606 = exp2(log2(max(0.0f, (((_1557 * max(0.0f, (((_1531 * 1.70505f) - (_1532 * 0.62179f)) - (_1533 * 0.08326f)))) * _slopeParams.x) + _offsetParams.x))) * _powerParams.x);
    _1607 = exp2(log2(max(0.0f, (((max(0.0f, (((_1532 * 1.1408f) - (_1531 * 0.13026f)) - (_1533 * 0.01055f))) * _1557) * _slopeParams.y) + _offsetParams.y))) * _powerParams.y);
    _1608 = exp2(log2(max(0.0f, (((max(0.0f, (((_1531 * -0.024f) - (_1532 * 0.12897f)) + (_1533 * 1.15297f))) * _1557) * _slopeParams.z) + _offsetParams.z))) * _powerParams.z);
    _1610 = dot(float3(_1606, _1607, _1608), float3(0.212671f, 0.71516f, 0.072169f));
    _1617 = ((_1606 - _1610) * _powerParams.w) + _1610;
    _1618 = ((_1607 - _1610) * _powerParams.w) + _1610;
    _1619 = ((_1608 - _1610) * _powerParams.w) + _1610;
    _1638 = min(max(log2(mad(_1619, 0.079223745f, mad(_1618, 0.0784336f, (_1617 * 0.84247905f)))), -12.47393f), 4.026069f) + 12.47393f;
    _1639 = min(max(log2(mad(_1619, 0.07916613f, mad(_1618, 0.87846863f, (_1617 * 0.042328242f)))), -12.47393f), 4.026069f) + 12.47393f;
    _1640 = min(max(log2(mad(_1619, 0.879143f, mad(_1618, 0.0784336f, (_1617 * 0.042375654f)))), -12.47393f), 4.026069f) + 12.47393f;
    _1641 = _1638 * 0.060606062f;
    _1642 = _1639 * 0.060606062f;
    _1643 = _1640 * 0.060606062f;
    _1644 = _1641 * _1641;
    _1645 = _1642 * _1642;
    _1646 = _1643 * _1643;
    _1692 = min(0.0f, (-0.0f - (((_1638 * 0.0072181816f) + ((_1644 * 0.4298f) + (((_1644 * _1644) * ((31.96f - (_1638 * 2.4327273f)) + (_1644 * 15.5f))) - ((_1638 * 0.41624245f) * _1644)))) + -0.00232f)));
    _1693 = min(0.0f, (-0.0f - (((_1639 * 0.0072181816f) + ((_1645 * 0.4298f) + (((_1645 * _1645) * ((31.96f - (_1639 * 2.4327273f)) + (_1645 * 15.5f))) - ((_1639 * 0.41624245f) * _1645)))) + -0.00232f)));
    _1694 = min(0.0f, (-0.0f - (((_1640 * 0.0072181816f) + ((_1646 * 0.4298f) + (((_1646 * _1646) * ((31.96f - (_1640 * 2.4327273f)) + (_1646 * 15.5f))) - ((_1640 * 0.41624245f) * _1646)))) + -0.00232f)));
    _1695 = -0.0f - _1692;
    _1696 = -0.0f - _1693;
    _1697 = -0.0f - _1694;
    _1698 = dot(float3(_1695, _1696, _1697), float3(0.2126f, 0.7152f, 0.0722f));
    if (_nightToneParm == 1) {
      _1715 = exp2(exp2(log2(abs((_time.w * 0.11666667f) + -1.4f)) * 8.0f) * -1.442695f) + 1.0f;
      _1716 = -0.79999995f / _1715;
      _1717 = -1.2f / _1715;
      _1718 = 0.20000005f / _1715;
      _1724 = saturate((_exposure2.x + -0.6f) * 0.10638298f);  // [sem: expr_sat]
      _1727 = saturate((_exposure2.x + -0.1f) * 2.0f);  // [sem: expr_sat]
      _1734 = (_1716 + 1.4f) + (_1727 * (-0.39999998f - _1716));
      _1735 = (_1717 + 1.6f) + (_1727 * (-0.6f - _1717));
      _1736 = (_1718 + 0.9f) + (_1727 * (0.5f - _1718));
      _1753 = (lerp(_1735, 1.2f, _1724));  // [sem: blended]
      _1754 = (lerp(_1734, 1.0f, _1724));  // [sem: blended]
      _1755 = (lerp(_1736, 1.4f, _1724));  // [sem: blended]
    } else {
      _1753 = ((saturate((_exposure2.x + -3.0f) * 0.14285715f) * 0.20000005f) + 1.0f);  // [sem: blended]
      _1754 = 1.0f;  // [sem: blended]
      _1755 = 1.4f;  // [sem: blended]
    }
    _1765 = 1.0f - _1753;
    _1790 = ((exp2(log2(((saturate((_1692 * _1692) * _1695) * _1765) + _1753) * _1695) * _1754) - _1698) * _1755) + _1698;
    _1791 = ((exp2(log2(((saturate((_1693 * _1693) * _1696) * _1765) + _1753) * _1696) * _1754) - _1698) * _1755) + _1698;
    _1792 = ((exp2(log2(((saturate((_1694 * _1694) * _1697) * _1765) + _1753) * _1697) * _1754) - _1698) * _1755) + _1698;
    _1811 = saturate(exp2(log2(mad(_1792, -0.09902974f, mad(_1791, -0.09802088f, (_1790 * 1.196879f)))) * 2.2f));  // [sem: expr_sat]
    _1812 = saturate(exp2(log2(mad(_1792, -0.098961174f, mad(_1791, 1.1519032f, (_1790 * -0.052896854f)))) * 2.2f));  // [sem: expr_sat]
    _1813 = saturate(exp2(log2(mad(_1792, 1.1510737f, mad(_1791, -0.09804345f, (_1790 * -0.052971635f)))) * 2.2f));  // [sem: expr_sat]
    if (_etcParams.z == 0.0f) {
      ...
      _1893 = 2.2f / ((min(max(_userImageAdjust.w, -1.0f), 1.0f) * 0.8f) + 2.2f);
  ...
  if (_1551 && (_etcParams.z > 0.0f)) {
    ...
    _1955 = select((_1923 <= 0.0031308f), (_1923 * 12.92f), (((pow(_1923, 0.41666666f)) * 1.055f) + -0.055f));
    _1956 = select((_1924 <= 0.0031308f), (_1924 * 12.92f), (((pow(_1924, 0.41666666f)) * 1.055f) + -0.055f));
  } else {
    _1954 = _1922;
    _1955 = _1923;
    _1956 = _1924;
  ...
  _1982 = exp2(log2(_1970 * 0.0001f) * 0.15930176f);
  _1983 = exp2(log2(_1971 * 0.0001f) * 0.15930176f);
  _1984 = exp2(log2(_1972 * 0.0001f) * 0.15930176f);
  SV_Target.x = exp2(log2((1.0f / ((_1982 * 18.6875f) + 1.0f)) * ((_1982 * 18.851562f) + 0.8359375f)) * 78.84375f);
  SV_Target.y = exp2(log2((1.0f / ((_1983 * 18.6875f) + 1.0f)) * ((_1983 * 18.851562f) + 0.8359375f)) * 78.84375f);
  SV_Target.z = exp2(log2((1.0f / ((_1984 * 18.6875f) + 1.0f)) * ((_1984 * 18.851562f) + 0.8359375f)) * 78.84375f);
  SV_Target.w = _1548;
  return SV_Target;
}
