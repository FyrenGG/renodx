...
float4 main(
  ...
  // [sem: expr_sat]
    _81 = saturate(ceil((0.10000000149011612f - (_nearFarProj.x / max(1.0000000116860974e-07f, (((float4)(__3__36__0__0__g_CustomRenderPassDepth.Load(int3(int(_37 * _customRenderPassSizeInvSize.x), int(_38 * _customRenderPassSizeInvSize.y), 0)))).x)))) + (_nearFarProj.x / max(1.0000000116860974e-07f, ((__3__36__0__0__g_depth.Sample(__0__4__0__0__g_staticBilinearClamp, float2(TEXCOORD.x, TEXCOORD.y))).x)))));
    _83 = _81;
    _84 = _81;
    _85 = _81;
  } else {
  ...
  if (_102) {
    ...
    if (_etcParams.z == 0.0f) {
      ...
      _444 = 2.200000047683716f / ((min(max(_userImageAdjust.w, -1.0f), 1.0f) * 0.800000011920929f) + 2.200000047683716f);
