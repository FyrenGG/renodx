...
float4 main(
  ...
  _39 = WaveReadLaneFirst(BindlessParameters_PostProcessVHSNoise[((int)((uint)(select(((uint)_31 < (uint)170000), _31, 0)) + 0u))].BindlessParameters_PostProcessVHSNoise._VHSNoiseProgress);
  [branch]
  ...
  // [sem: _3__36__0__0__g_postProcessSizeColor_sample]
    ...
    _65 = TEXCOORD.x - ((_62 * _62) * 0.009999999776482582f);
    ...
    _79 = WaveReadLaneFirst(BindlessParameters_PostProcessVHSNoise[((int)((uint)(select(((uint)_71 < (uint)170000), _71, 0)) + 0u))].BindlessParameters_PostProcessVHSNoise._chromaticAberrationRatio);
    ...
    if (!(!(_80 >= 0.0010000000474974513f))) {
      ...
      if (!(_enableChromaticAberration == 0)) {
        ...
        _88 = TEXCOORD.y + -0.5f;
  // [sem: invLength]
        _96 = rsqrt(dot(float2(_87, _88), float2(_87, _88))) * (sqrt((_87 * _87) + (_88 * _88)) * 0.009999999776482582f);
        _97 = _96 * _87;
        _99 = _96 * _88;
    ...
    _136 = WaveReadLaneFirst(BindlessParameters_PostProcessVHSNoise[((int)((uint)(select(((uint)_128 < (uint)170000), _128, 0)) + 0u))].BindlessParameters_PostProcessVHSNoise._noiseTexture);
    _148 = _time.x * 0.019999999552965164f;
    _155 = ((sin(_148) * (sin(_148 + 7.130000114440918f) + 0.5f)) + TEXCOORD.y) * _srcTargetSizeAndInv.y;
    _169 = WaveReadLaneFirst(_materialIndex);
    _177 = WaveReadLaneFirst(BindlessParameters_PostProcessVHSNoise[((int)((uint)(select(((uint)_169 < (uint)170000), _169, 0)) + 0u))].BindlessParameters_PostProcessVHSNoise._scanlineDarkness);
    _178 = ((((float4)(__0__7__0__0__g_bindlessTextures[((int)((uint)(select(((uint)_136 < (uint)65000), _136, 0)) + 0u))].Sample(__0__4__0__0__g_staticBilinearWrap, float2(TEXCOORD.x, (TEXCOORD.y - (_time.x * 0.02500000037252903f)))))).x) * 0.5f) * _177;
    _179 = WaveReadLaneFirst(_materialIndex);
    _187 = WaveReadLaneFirst(BindlessParameters_PostProcessVHSNoise[((int)((uint)(select(((uint)_179 < (uint)170000), _179, 0)) + 0u))].BindlessParameters_PostProcessVHSNoise._largeNoiseDarkness);
    _194 = 1.0f - (((saturate(_56.x * _56.w) * (_187 - _178)) + _178) * (1.0f - abs(sin((_155 * 3.1415927410125732f) * ((frac(sin(dot(float2(floor(_155 * 0.05999999865889549f), 17.0f), float2(127.0999984741211f, 311.70001220703125f))) * 437.5450134277344f) * 0.07199999690055847f) + 0.04800000041723251f)))));
    ...
    _217 = WaveReadLaneFirst(BindlessParameters_PostProcessVHSNoise[((int)((uint)(select(((uint)_207 < (uint)170000), _207, 0)) + 0u))].BindlessParameters_PostProcessVHSNoise._slopeRGB.x);
    _218 = WaveReadLaneFirst(BindlessParameters_PostProcessVHSNoise[((int)((uint)(select(((uint)_207 < (uint)170000), _207, 0)) + 0u))].BindlessParameters_PostProcessVHSNoise._slopeRGB.y);
    _219 = WaveReadLaneFirst(BindlessParameters_PostProcessVHSNoise[((int)((uint)(select(((uint)_207 < (uint)170000), _207, 0)) + 0u))].BindlessParameters_PostProcessVHSNoise._slopeRGB.z);
    ...
    _240 = WaveReadLaneFirst(BindlessParameters_PostProcessVHSNoise[((int)((uint)(select(((uint)_232 < (uint)170000), _232, 0)) + 0u))].BindlessParameters_PostProcessVHSNoise._saturationRatio);
    _241 = dot(float3(_229, _230, _231), float3(0.2125999927520752f, 0.7152000069618225f, 0.0722000002861023f));
    ...
    _274 = WaveReadLaneFirst(BindlessParameters_PostProcessVHSNoise[((int)((uint)(select(((uint)_266 < (uint)170000), _266, 0)) + 0u))].BindlessParameters_PostProcessVHSNoise._noiseTexture);
    _282 = WaveReadLaneFirst(_materialIndex);
    _290 = WaveReadLaneFirst(BindlessParameters_PostProcessVHSNoise[((int)((uint)(select(((uint)_282 < (uint)170000), _282, 0)) + 0u))].BindlessParameters_PostProcessVHSNoise._vignetteRatio);
    _292 = saturate(_290 * _39);  // [sem: expr_sat]
    _293 = WaveReadLaneFirst(_materialIndex);
    _301 = WaveReadLaneFirst(BindlessParameters_PostProcessVHSNoise[((int)((uint)(select(((uint)_293 < (uint)170000), _293, 0)) + 0u))].BindlessParameters_PostProcessVHSNoise._vignetteWidth);
    [branch]
    if (!(!(_292 >= 0.0010000000474974513f))) {
      _310 = (1.0f - _301) * 0.5f;
      _313 = max((abs(TEXCOORD.x + -0.5f) - _310), 0.0f);
      _314 = max((abs(TEXCOORD.y + -0.5f) - _310), 0.0f);
      _326 = saturate(saturate(saturate(sqrt((_314 * _314) + (_313 * _313)) * 1.25f) * 2.0f) - ((((float4)(__0__7__0__0__g_bindlessTextures[((int)((uint)(select(((uint)_274 < (uint)65000), _274, 0)) + 0u))].Sample(__0__4__0__0__g_staticBilinearWrap, float2((TEXCOORD.x * 4.0f), ((_time.x * 0.019999999552965164f) + (TEXCOORD.y * 4.0f)))))).x) * 0.10000000149011612f)) * _292;
      _334 = (_257 - (_326 * _257));
      _335 = (_258 - (_326 * _258));
      _336 = (_259 - (_326 * _259));
    } else {
  ...
  if (_353) {
    ...
    if (_etcParams.z == 0.0f) {
      ...
      _695 = 2.200000047683716f / ((min(max(_userImageAdjust.w, -1.0f), 1.0f) * 0.800000011920929f) + 2.200000047683716f);
