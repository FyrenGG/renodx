...
float4 main(
  ...
  _461 = saturate(_etcParams.w);
  _470 = (_460 * saturate(_rndx_tonemapped_color.x)) + _461;
  _467 = (_460 * saturate(_rndx_tonemapped_color.y)) + _461;
  _464 = (_460 * saturate(_rndx_tonemapped_color.z)) + _461;
  ...
  _573 = saturate(1.0f - ((_postProcessParams.x * CUSTOM_VIGNETTE * _563) * dot(float2(_564, _566), float2(_564, _566))));  // [sem: expr_sat]
