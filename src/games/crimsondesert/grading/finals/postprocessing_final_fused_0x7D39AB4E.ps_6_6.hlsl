...
float4 main(
  ...
  _604 = saturate(_etcParams.w);
  _607 = (_603 * saturate(_rndx_tonemapped_color.x)) + _604;
  _610 = (_603 * saturate(_rndx_tonemapped_color.y)) + _604;
  _613 = (_603 * saturate(_rndx_tonemapped_color.z)) + _604;
  ...
  _716 = saturate(1.0f - ((_postProcessParams.x * CUSTOM_VIGNETTE * _706) * dot(float2(_707, _709), float2(_707, _709))));  // [sem: expr_sat]
