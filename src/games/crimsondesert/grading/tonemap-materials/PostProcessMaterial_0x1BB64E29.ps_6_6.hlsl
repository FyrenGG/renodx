...
float4 main(
  ...
  if (_601) {
    _607 = _exposure0.x * _userImageAdjust.z;
    _626 = exp2(_powerParams.x * log2(max(0.0f, (((_607 * max(0.0f, (((_578 * 1.70505f) - (_581 * 0.62179f)) - (_584 * 0.08326f)))) * _slopeParams.x) + _offsetParams.x))));
    _642 = exp2(log2(max(0.0f, (((_slopeParams.y * _607) * max(0.0f, (((_581 * 1.1408f) - (_578 * 0.13026f)) - (_584 * 0.01055f)))) + _offsetParams.y))) * _powerParams.y);
    _658 = exp2(log2(max(0.0f, (((_slopeParams.z * _607) * max(0.0f, (((_578 * -0.024f) - (_581 * 0.12897f)) + (_584 * 1.15297f)))) + _offsetParams.z))) * _powerParams.z);
    _659 = dot(float3(_626, _642, _658), float3(0.212671f, 0.71516f, 0.072169f));
    _663 = ((_626 - _659) * _powerParams.w) + _659;
    _666 = ((_642 - _659) * _powerParams.w) + _659;
    _669 = ((_658 - _659) * _powerParams.w) + _659;
    _676 = min(max(log2(mad(_669, 0.079223745f, mad(_666, 0.0784336f, (_663 * 0.84247905f)))), -12.47393f), 4.026069f) + 12.47393f;
    _683 = min(max(log2(mad(_669, 0.07916613f, mad(_666, 0.87846863f, (_663 * 0.042328242f)))), -12.47393f), 4.026069f) + 12.47393f;
    _690 = min(max(log2(mad(_669, 0.879143f, mad(_666, 0.0784336f, (_663 * 0.042375654f)))), -12.47393f), 4.026069f) + 12.47393f;
    _691 = _676 * 0.060606062f;
    _692 = _683 * 0.060606062f;
    _693 = _690 * 0.060606062f;
    _694 = _691 * _691;
    _695 = _692 * _692;
    _696 = _693 * _693;
    _712 = min(0.0f, (-0.0f - (((_676 * 0.0072181816f) + ((_694 * 0.4298f) + (((_694 * _694) * ((31.96f - (_676 * 2.4327273f)) + (_694 * 15.5f))) - ((_676 * 0.41624245f) * _694)))) + -0.00232f)));
    _728 = min(0.0f, (-0.0f - (((_683 * 0.0072181816f) + ((_695 * 0.4298f) + (((_695 * _695) * ((31.96f - (_683 * 2.4327273f)) + (_695 * 15.5f))) - ((_683 * 0.41624245f) * _695)))) + -0.00232f)));
    ...
    _746 = -0.0f - _728;
    _747 = -0.0f - _744;
    _748 = dot(float3(_745, _746, _747), float3(0.2126f, 0.7152f, 0.0722f));
    if (_nightToneParm == 1) {
      _765 = exp2(exp2(log2(abs((_time.w * 0.11666667f) + -1.4f)) * 8.0f) * -1.442695f) + 1.0f;
      _766 = -0.79999995f / _765;
      _767 = -1.2f / _765;
      _768 = 0.20000005f / _765;
      _771 = saturate((_exposure2.x + -0.6f) * 0.10638298f);  // [sem: expr_sat]
      _774 = saturate((_exposure2.x + -0.1f) * 2.0f);  // [sem: expr_sat]
      _778 = (_766 + 1.4f) + (_774 * (-0.39999998f - _766));
      _782 = (_767 + 1.6f) + (_774 * (-0.6f - _767));
      _786 = (_768 + 0.9f) + (_774 * (0.5f - _768));
      _803 = (lerp(_782, 1.2f, _771));  // [sem: blended]
      _804 = (lerp(_778, 1.0f, _771));  // [sem: blended]
      _805 = (lerp(_786, 1.4f, _771));  // [sem: blended]
    } else {
      _803 = ((saturate((_exposure2.x + -3.0f) * 0.14285715f) * 0.20000005f) + 1.0f);  // [sem: blended]
      _804 = 1.0f;  // [sem: blended]
      _805 = 1.4f;  // [sem: blended]
    }
    _806 = 1.0f - _803;
    _818 = ((exp2(log2(((saturate((_712 * _712) * _745) * _806) + _803) * _745) * _804) - _748) * _805) + _748;
    _830 = ((exp2(log2(((saturate((_728 * _728) * _746) * _806) + _803) * _746) * _804) - _748) * _805) + _748;
    _842 = ((exp2(log2(((saturate((_744 * _744) * _747) * _806) + _803) * _747) * _804) - _748) * _805) + _748;
    _849 = saturate(exp2(log2(mad(_842, -0.09902974f, mad(_830, -0.09802088f, (_818 * 1.196879f)))) * 2.2f));  // [sem: expr_sat]
    _856 = saturate(exp2(log2(mad(_842, -0.098961174f, mad(_830, 1.1519032f, (_818 * -0.052896854f)))) * 2.2f));  // [sem: expr_sat]
    _863 = saturate(exp2(log2(mad(_842, 1.1510737f, mad(_830, -0.09804345f, (_818 * -0.052971635f)))) * 2.2f));  // [sem: expr_sat]
  ...
  if (_etcParams.y > 1.0f) {
    _960 = abs(_35 + -1.0f);
    _962 = abs(_36 + -1.0f);
    _968 = saturate(1.0f - (saturate(_etcParams.y + -1.0f) * dot(float2(_960, _962), float2(_960, _962))));  // [sem: expr_sat]
    _973 = (_968 * _954);
    _974 = (_968 * _955);
    _975 = (_968 * _956);
  } else {
