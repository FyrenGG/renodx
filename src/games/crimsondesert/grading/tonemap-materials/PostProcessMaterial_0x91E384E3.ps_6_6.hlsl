...
float4 main(
  ...
  if (_1013) {
    _1019 = _userImageAdjust.z * _exposure0.x;
    _1068 = exp2(log2(max(0.0f, (((_1019 * max(0.0f, (((_994 * 1.70505f) - (_995 * 0.62179f)) - (_996 * 0.08326f)))) * _slopeParams.x) + _offsetParams.x))) * _powerParams.x);
    _1069 = exp2(log2(max(0.0f, (((max(0.0f, (((_995 * 1.1408f) - (_994 * 0.13026f)) - (_996 * 0.01055f))) * _1019) * _slopeParams.y) + _offsetParams.y))) * _powerParams.y);
    _1070 = exp2(log2(max(0.0f, (((max(0.0f, (((_994 * -0.024f) - (_995 * 0.12897f)) + (_996 * 1.15297f))) * _1019) * _slopeParams.z) + _offsetParams.z))) * _powerParams.z);
    _1072 = dot(float3(_1068, _1069, _1070), float3(0.212671f, 0.71516f, 0.072169f));
    _1079 = ((_1068 - _1072) * _powerParams.w) + _1072;
    _1080 = ((_1069 - _1072) * _powerParams.w) + _1072;
    _1081 = ((_1070 - _1072) * _powerParams.w) + _1072;
    _1100 = min(max(log2(mad(_1081, 0.079223745f, mad(_1080, 0.0784336f, (_1079 * 0.84247905f)))), -12.47393f), 4.026069f) + 12.47393f;
    _1101 = min(max(log2(mad(_1081, 0.07916613f, mad(_1080, 0.87846863f, (_1079 * 0.042328242f)))), -12.47393f), 4.026069f) + 12.47393f;
    _1102 = min(max(log2(mad(_1081, 0.879143f, mad(_1080, 0.0784336f, (_1079 * 0.042375654f)))), -12.47393f), 4.026069f) + 12.47393f;
    _1103 = _1100 * 0.060606062f;
    _1104 = _1101 * 0.060606062f;
    _1105 = _1102 * 0.060606062f;
    _1106 = _1103 * _1103;
    _1107 = _1104 * _1104;
    _1108 = _1105 * _1105;
    _1154 = min(0.0f, (-0.0f - (((_1100 * 0.0072181816f) + ((_1106 * 0.4298f) + (((_1106 * _1106) * ((31.96f - (_1100 * 2.4327273f)) + (_1106 * 15.5f))) - ((_1100 * 0.41624245f) * _1106)))) + -0.00232f)));
    _1155 = min(0.0f, (-0.0f - (((_1101 * 0.0072181816f) + ((_1107 * 0.4298f) + (((_1107 * _1107) * ((31.96f - (_1101 * 2.4327273f)) + (_1107 * 15.5f))) - ((_1101 * 0.41624245f) * _1107)))) + -0.00232f)));
    _1156 = min(0.0f, (-0.0f - (((_1102 * 0.0072181816f) + ((_1108 * 0.4298f) + (((_1108 * _1108) * ((31.96f - (_1102 * 2.4327273f)) + (_1108 * 15.5f))) - ((_1102 * 0.41624245f) * _1108)))) + -0.00232f)));
    _1157 = -0.0f - _1154;
    _1158 = -0.0f - _1155;
    _1159 = -0.0f - _1156;
    _1160 = dot(float3(_1157, _1158, _1159), float3(0.2126f, 0.7152f, 0.0722f));
    if (_nightToneParm == 1) {
      _1177 = exp2(exp2(log2(abs((_time.w * 0.11666667f) + -1.4f)) * 8.0f) * -1.442695f) + 1.0f;
      _1178 = -0.79999995f / _1177;
      _1179 = -1.2f / _1177;
      _1180 = 0.20000005f / _1177;
      _1186 = saturate((_exposure2.x + -0.6f) * 0.10638298f);  // [sem: expr_sat]
      _1189 = saturate((_exposure2.x + -0.1f) * 2.0f);  // [sem: expr_sat]
      _1196 = (_1178 + 1.4f) + (_1189 * (-0.39999998f - _1178));
      _1197 = (_1179 + 1.6f) + (_1189 * (-0.6f - _1179));
      _1198 = (_1180 + 0.9f) + (_1189 * (0.5f - _1180));
      _1215 = (lerp(_1197, 1.2f, _1186));  // [sem: blended]
      _1216 = (lerp(_1196, 1.0f, _1186));  // [sem: blended]
      _1217 = (lerp(_1198, 1.4f, _1186));  // [sem: blended]
    } else {
      _1215 = ((saturate((_exposure2.x + -3.0f) * 0.14285715f) * 0.20000005f) + 1.0f);  // [sem: blended]
      _1216 = 1.0f;  // [sem: blended]
      _1217 = 1.4f;  // [sem: blended]
    }
    _1227 = 1.0f - _1215;
    _1252 = ((exp2(log2(((saturate((_1154 * _1154) * _1157) * _1227) + _1215) * _1157) * _1216) - _1160) * _1217) + _1160;
    _1253 = ((exp2(log2(((saturate((_1155 * _1155) * _1158) * _1227) + _1215) * _1158) * _1216) - _1160) * _1217) + _1160;
    _1254 = ((exp2(log2(((saturate((_1156 * _1156) * _1159) * _1227) + _1215) * _1159) * _1216) - _1160) * _1217) + _1160;
    _1273 = saturate(exp2(log2(mad(_1254, -0.09902974f, mad(_1253, -0.09802088f, (_1252 * 1.196879f)))) * 2.2f));  // [sem: expr_sat]
    _1274 = saturate(exp2(log2(mad(_1254, -0.098961174f, mad(_1253, 1.1519032f, (_1252 * -0.052896854f)))) * 2.2f));  // [sem: expr_sat]
    _1275 = saturate(exp2(log2(mad(_1254, 1.1510737f, mad(_1253, -0.09804345f, (_1252 * -0.052971635f)))) * 2.2f));  // [sem: expr_sat]
