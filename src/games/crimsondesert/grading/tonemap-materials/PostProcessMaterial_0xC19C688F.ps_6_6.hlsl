...
float4 main(
  ...
  _36 = TEXCOORD.y * 2.0f;
  _37 = 1.0f - _36;
  _38 = max(1.0000000116860974e-07f, ((__3__36__0__0__g_depth.Sample(__0__4__0__0__g_staticBilinearClamp, float2(TEXCOORD.x, TEXCOORD.y))).x));
  _66 = mad((_invViewProj[2].w), _38, mad((_invViewProj[1].w), _37, ((_invViewProj[0].w) * _35))) + (_invViewProj[3].w);
  _67 = (mad((_invViewProj[2].x), _38, mad((_invViewProj[1].x), _37, ((_invViewProj[0].x) * _35))) + (_invViewProj[3].x)) / _66;
  _68 = (mad((_invViewProj[2].z), _38, mad((_invViewProj[1].z), _37, ((_invViewProj[0].z) * _35))) + (_invViewProj[3].z)) / _66;
  _69 = abs(_67);
  _71 = frac(abs(_69));
  _72 = abs(_68);
  _74 = frac(abs(_72));
  _75 = WaveReadLaneFirst(_materialIndex);
  _85 = WaveReadLaneFirst(BindlessParameters_PostProcessHousing[((int)((uint)(select(((uint)_75 < (uint)170000), _75, 0)) + 0u))].BindlessParameters_PostProcessHousing._pivotPosition.x);
  _87 = WaveReadLaneFirst(BindlessParameters_PostProcessHousing[((int)((uint)(select(((uint)_75 < (uint)170000), _75, 0)) + 0u))].BindlessParameters_PostProcessHousing._pivotPosition.z);
  _88 = WaveReadLaneFirst(_materialIndex);
  _99 = WaveReadLaneFirst(BindlessParameters_PostProcessHousing[((int)((uint)(select(((uint)_88 < (uint)170000), _88, 0)) + 0u))].BindlessParameters_PostProcessHousing._rectMinMax.x);
  _100 = WaveReadLaneFirst(BindlessParameters_PostProcessHousing[((int)((uint)(select(((uint)_88 < (uint)170000), _88, 0)) + 0u))].BindlessParameters_PostProcessHousing._rectMinMax.y);
  _101 = WaveReadLaneFirst(BindlessParameters_PostProcessHousing[((int)((uint)(select(((uint)_88 < (uint)170000), _88, 0)) + 0u))].BindlessParameters_PostProcessHousing._rectMinMax.z);
  _102 = WaveReadLaneFirst(BindlessParameters_PostProcessHousing[((int)((uint)(select(((uint)_88 < (uint)170000), _88, 0)) + 0u))].BindlessParameters_PostProcessHousing._rectMinMax.w);
  ...
  if (_153) {
    ...
    if (_etcParams.z == 0.0f) {
      ...
      _495 = 2.200000047683716f / ((min(max(_userImageAdjust.w, -1.0f), 1.0f) * 0.800000011920929f) + 2.200000047683716f);
